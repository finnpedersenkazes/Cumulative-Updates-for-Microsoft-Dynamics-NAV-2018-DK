OBJECT Codeunit 99000830 Create Reserv. Entry
{
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Du kan ikke reservere denne post, da det ikke er en ‘gte eftersp›rgsel eller et ‘gte udbud.;ENU=You cannot reserve this entry because it is not a true demand or supply.';
      ...
      Text001@1006 : TextConst 'DAN=Varesporing stemmer ikke overens.;ENU=Cannot match item tracking.';
