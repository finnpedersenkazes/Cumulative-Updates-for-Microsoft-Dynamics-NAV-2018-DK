OBJECT Codeunit 99000815 Reservation-Check Date Confl.
{
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=’ndringen medf›rer en datokonflikt med eksisterende reservationer.\;ENU=The change leads to a date conflict with existing reservations.\';
      Text001@1001 : TextConst 'DAN=Reserveret antal (basis): %1, dato %2\;ENU=Reserved quantity (Base): %1, Date %2\';
      Text002@1002 : TextConst 'DAN=Annuller eller ret reservationer, og pr›v igen.;ENU=Cancel or change reservations and try again.';
      ...
      DateConflictMsg@1019 : TextConst '@@@=%1: Field(Reserved Quantity (Base)), %2: Field(Due Date);DAN=’ndringen skaber en konflikt med en eksisterende reservation p† %2 for %1 enheder.\ \Reservationerne er blevet annulleret. Produktionsordren skal planl‘gges igen.;ENU=The change causes a date conflict with an existing reservation on %2 for %1 units.\ \The reservations have been canceled. The production order must be replanned.';
