OBJECT Codeunit 7320 Whse. Undo Quantity
{
  ...
  CODE
  {
    VAR
      ...
      Text000@1000 : TextConst 'DAN=Programfejl, %1.;ENU=Assertion failed, %1.';
      Text001@1002 : TextConst 'DAN=Der er ikke plads til at inds‘tte rettelseslinjer.;ENU=There is not enough space to insert correction lines.';
