OBJECT Codeunit 7313 Create Put-away
{
  ...
  {
    VAR
      CrossDockBinContent@1005 : Record 7302;
      ...
      Text001@1029 : TextConst 'DAN=Der er ikke oprettet %1.;ENU=There are no %1 created.';
      Text002@1030 : TextConst 'DAN=Der er ikke nok placeringskapacitet for varer.;ENU=There is not enough bin capacity for items.';
      NewCrossDockBinContent@1034 : Boolean;
      CrossDock@1032 : Boolean;
      CrossDockInfo@1031 : Option;
      Text003@1038 : TextConst 'DAN=Der findes ingen standardplacering for en eller flere varer.;ENU=There is no default bin for one or more item.';
    ...
    [Integration]
    LOCAL PROCEDURE OnAfterWhseActivLineInsert@25(VAR WarehouseActivityLine@1000 : Record 5767);
    BEGIN
    END;
