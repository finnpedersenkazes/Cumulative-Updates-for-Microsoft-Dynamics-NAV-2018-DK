OBJECT Codeunit 7324 Whse.-Activity-Post
{
  ...
  CODE
  {
    VAR
      ...
      Text002@1005 : TextConst 'DAN=Linjerne bogf›res     #3###### @4@@@@@@@@@@@@@;ENU=Posting lines         #3###### @4@@@@@@@@@@@@@';
      ...
      Text003@1003 : TextConst 'DAN=Der er intet at bogf›re.;ENU=There is nothing to post.';
      Text005@1025 : TextConst 'DAN=Kildedokumentet %1 %2 er ikke frigivet.;ENU=The source document %1 %2 is not released.';
    ...
    [Integration]
    LOCAL PROCEDURE OnAfterSalesLineModify@1001(VAR SalesLine@1000 : Record 37);
    BEGIN
    END;

    [Integration]
    LOCAL PROCEDURE OnAfterPurchLineModify@1002(VAR PurchaseLine@1000 : Record 39);
    BEGIN
    END;
