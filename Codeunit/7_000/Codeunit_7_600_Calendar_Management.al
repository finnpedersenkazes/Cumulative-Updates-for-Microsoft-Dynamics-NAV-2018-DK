OBJECT Codeunit 7600 Calendar Management
{
  ...
  CODE
  {
    VAR
      ...
      Text001@1015 : TextConst 'DAN=Ja;ENU=Yes';
      Text002@1016 : TextConst 'DAN=Nej;ENU=No';
      Text003@1017 : TextConst 'DAN=Udtrykket %1 kan ikke v‘re en negativ v‘rdi.;ENU=The expression %1 cannot be negative.';
    ...
    PROCEDURE DeleteCustomizedBaseCalendarData@15(SourceType@1004 : Option;SourceCode@1003 : Code[20]);
    VAR
      CustomizedCalendarChange@1002 : Record 7602;
      CustomizedCalendarEntry@1001 : Record 7603;
      WhereUsedBaseCalendar@1000 : Record 7604;
    BEGIN
    ...
    PROCEDURE RenameCustomizedBaseCalendarData@16(SourceType@1004 : Option;SourceCode@1003 : Code[20];xSourceCode@1005 : Code[20]);
    VAR
      CustomizedCalendarChange@1002 : Record 7602;
      TempCustomizedCalendarChange@1006 : TEMPORARY Record 7602;
      CustomizedCalendarEntry@1001 : Record 7603;
      TempCustomizedCalendarEntry@1007 : TEMPORARY Record 7603;
      WhereUsedBaseCalendar@1000 : Record 7604;
      TempWhereUsedBaseCalendar@1008 : TEMPORARY Record 7604;
    BEGIN
      CustomizedCalendarChange.SETRANGE("Source Type",SourceType);
