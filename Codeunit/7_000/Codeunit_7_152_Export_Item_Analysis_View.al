OBJECT Codeunit 7152 Export Item Analysis View
{
  ...
  CODE
  {
    VAR
      ...
      FileName@1013 : Text;
      Text000@1012 : TextConst 'DAN=Du kan kun udlëse faktiske belõb og budgetterede belõb.\Skift indstilling i feltet Vis.;ENU=You can only export Actual amounts and Budgeted amounts.\Please change the option in the Show field.';
      Text002@1023 : TextConst 'DAN=Generelle opl._;ENU=General Info._';
      Text003@1020 : TextConst 'DAN=Ingen;ENU=None';
      Text004@1033 : TextConst 'DAN=Dag;ENU=Day';
      Text005@1024 : TextConst 'DAN=Uge;ENU=Week';
      Text006@1014 : TextConst 'DAN=MÜned;ENU=Month';
      Text007@1025 : TextConst 'DAN=Kvartal;ENU=Quarter';
      Text008@1026 : TextConst 'DAN=èr;ENU=Year';
      Text009@1027 : TextConst 'DAN=Regnskabsperiode;ENU=Accounting Period';
      Text011@1029 : TextConst 'DAN="Dimensionsanalyse ";ENU="Analysis by Dimension "';
      Text012@1030 : TextConst 'DAN=Belõbstype;ENU=Amount Type';
      Text015@1018 : TextConst 'DAN=Datofilter;ENU=Date Filter';
      Text016@1022 : TextConst 'DAN=Budgetfilter;ENU=Budget Filter';
      Text017@1034 : TextConst 'DAN=Pivottabel_;ENU=Pivot Table_';
      Text018@1017 : TextConst 'DAN=Vare;ENU=Item';
      Text019@1035 : TextConst 'DAN=Periode;ENU=Period';
      Text020@1021 : TextConst 'DAN=Budg. salgsbelõb;ENU=Budg. Sales Amount';
      Text022@1043 : TextConst 'DAN=Niveau;ENU=Level';
      Text023@1040 : TextConst 'DAN=Navn pÜ analysevisning;ENU=Analysis View Name';
      Text028@1048 : TextConst 'DAN=Vis modsat fortegn;ENU=Show Opposite Sign';
      Text029@1004 : TextConst 'DAN=Ja;ENU=Yes';
      Text030@1003 : TextConst 'DAN=Nej;ENU=No';
      Text031@1051 : TextConst 'DAN=Data_;ENU=Data_';
      Text032@1000 : TextConst 'DAN=Salgsbelõb;ENU=Sales Amount';
      Text033@1053 : TextConst 'DAN=Kostbelõb;ENU=Cost Amount';
      Text035@1055 : TextConst 'DAN=Budg. kostbelõb;ENU=Budg Cost Amount';
      Text036@1056 : TextConst 'DAN=Budg. antal;ENU=Budg. Quantity';
      Text037@1041 : TextConst 'DAN=Der er mere end %1 rëkker i filtrene. Excel tillader kun op til %1 rëkker.\Du kan enten begrënse filtrene eller vëlge en hõjere %2-vërdi pÜ %3.;ENU=There are more than %1 rows within the filters. Excel only allows up to %1 rows.\You can either narrow the filters or choose a higher %2 value on the %3.';
      Text038@1032 : TextConst 'DAN=Det udlëste dataresultat overskrider en systemgrënse.\Begrëns det valgte ved at rydde feltet Vis kolonnenavn.;ENU=The exported data result exceeds a system limit.\Limit the selection by clearing the Show Column Name field.';
      Text039@1036 : TextConst 'DAN=Lokation;ENU=Location';
    ...
    VAR
      ...
      j@1016 : Integer;
    BEGIN
      // Windows encoding here as ASCII or UTF8/UTF16 are not read as expected by Excel later in the process.
      TextFile.CREATETEMPFILE(TEXTENCODING::Windows);
      FileName := TextFile.NAME + '.txt';
      TextFile.CLOSE;

      TextFile.TEXTMODE(TRUE);
      TextFile.CREATE(FileName,TEXTENCODING::Windows);
