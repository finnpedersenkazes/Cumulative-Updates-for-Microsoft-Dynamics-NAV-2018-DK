OBJECT Codeunit 410 Update Analysis View
{
  ...
  {
    VAR
      Text005@1001 : TextConst 'DAN=Analysevisning           #1############################\\;ENU=Analysis View     #1############################\\';
      Text006@1002 : TextConst 'DAN=Tabel opdateres          #2############################\;ENU=Updating table    #2############################\';
      Text007@1003 : TextConst 'DAN=Hast.: (poster/s)        #4########\;ENU=Speed: (Entries/s)#4########\';
      Text008@1004 : TextConst 'DAN=Gnsn.hastighed           #5########;ENU=Average Speed     #5########';
      Text009@1030 : TextConst 'DAN="                         #6############### @3@@@@@@@@@@@@@@@@@@@@@@@@@@@@\\";ENU=#6############### @3@@@@@@@@@@@@@@@@@@@@@@@@@@@@\\';
      Text010@1031 : TextConst 'DAN=Opsummerer;ENU=Summarizing';
      Text011@1032 : TextConst 'DAN=Databasen opdateres;ENU=Updating Database';
