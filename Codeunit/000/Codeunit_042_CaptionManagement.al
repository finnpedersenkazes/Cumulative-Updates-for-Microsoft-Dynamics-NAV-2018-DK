OBJECT Codeunit 42 CaptionManagement
{
  ...
  CODE
  {
    VAR
      ...
      Text016@1003 : TextConst 'DAN=ekskl. moms;ENU=Excl. VAT';
      Text017@1002 : TextConst 'DAN=Inkl. moms;ENU=Incl. VAT';
      DefaultTxt@1005 : TextConst 'DAN=RV;ENU=LCY';
      DefaultLongTxt@1004 : TextConst 'DAN=Lokal valuta;ENU=Local Currency';
    ...
    [Integration]
    LOCAL PROCEDURE OnExtensionCaptionArea@8(Language@1001 : Integer;CaptionArea@1002 : Text[80];CaptionRef@1003 : Text[1024];VAR CaptionExpr@1000 : Text[1024]);
    BEGIN
    END;
