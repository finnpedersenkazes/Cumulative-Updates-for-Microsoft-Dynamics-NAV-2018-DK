OBJECT Codeunit 41 TextManagement
{
  ...
  {
    VAR
      TodayText@1000 : TextConst '@@@=Must be uppercase hint reuse the transtaltion from cod1 for 2009 sp1;DAN=DAGSDATO;ENU=TODAY';
      WorkdateText@1001 : TextConst '@@@=Must be uppercase hint reuse the transtaltion from cod1 for 2009 sp1;DAN=ARBEJDSDATO;ENU=WORKDATE';
      PeriodText@1004 : TextConst '@@@=Must be uppercase hint reuse the transtaltion from cod1 for 2009 sp1;DAN=PERIODE;ENU=PERIOD';
      YearText@1003 : TextConst '@@@=Must be uppercase hint reuse the transtaltion from cod1 for 2009 sp1;DAN=èR;ENU=YEAR';
      NumeralOutOfRangeError@1006 : TextConst 'DAN=I periode- og Ürsangivelser skal/kan du benytte tal fra 1 - 999, f.eks. P-1, P1, è2 eller è+3.;ENU=When you specify periods and years, you can use numbers from 1 - 999, such as P-1, P1, Y2 or Y+3.';
      AlphabetText@1002 : TextConst '@@@=Uppercase - translate into entire alphabet.;DAN=ABCDEFGHIJKLMNOPQRSTUVWXYZíùè;ENU=ABCDEFGHIJKLMNOPQRSTUVWXYZ';
      NowText@1007 : TextConst '@@@=Must be uppercase.;DAN=NU;ENU=NOW';
      YesterdayText@1009 : TextConst '@@@=Must be uppercase;DAN=I GèR;ENU=YESTERDAY';
      TomorrowText@1010 : TextConst '@@@=Must be uppercase;DAN=I MORGEN;ENU=TOMORROW';
      WeekText@1012 : TextConst '@@@=Must be uppercase;DAN=UGE;ENU=WEEK';
      MonthText@1005 : TextConst '@@@=Must be uppercase;DAN=MèNED;ENU=MONTH';
      QuarterText@1018 : TextConst '@@@=Must be uppercase;DAN=KVARTAL;ENU=QUARTER';
      UserText@1013 : TextConst '@@@=Must be uppercase;DAN=BRUGER;ENU=USER';
      MeText@1011 : TextConst '@@@=Must be uppercase;DAN=MIG;ENU=ME';
      MyCustomersText@1014 : TextConst '@@@=Must be uppercase;DAN=MINE KUNDER;ENU=MYCUSTOMERS';
      MyItemsText@1015 : TextConst '@@@=Must be uppercase;DAN=MINE VARER;ENU=MYITEMS';
      MyVendorsText@1016 : TextConst '@@@=Must be uppercase;DAN=MINE KREDITORER;ENU=MYVENDORS';
      ...
      UnincrementableStringErr@1019 : TextConst 'DAN=%1 indeholder ikke noget nummer og kan derfor ikke forõges.;ENU=%1 contains no number and cannot be incremented.';
