OBJECT Codeunit 21 Item Jnl.-Check Line
{
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=m† ikke v‘re en ultimodato;ENU=cannot be a closing date';
      ...
      Text003@1002 : TextConst 'DAN=m† ikke v‘re negativ, n†r %1 er %2.;ENU=must not be negative when %1 is %2';
      Text004@1003 : TextConst 'DAN=skal have samme v‘rdi som %1;ENU=must have the same value as %1';
      Text005@1004 : TextConst 'DAN=skal v‘re %1 eller %2, n†r %3 er %4;ENU=must be %1 or %2 when %3 is %4';
      Text006@1005 : TextConst 'DAN=skal svare til %1 - %2, %3 er %4, og %5 er %6.;ENU=must equal %1 - %2 when %3 is %4 and %5 is %6';
      Text007@1006 : TextConst 'DAN="Du kan ikke bogf›re linjerne, fordi du ikke har angivet et antal p† ‚n eller flere af linjerne. ";ENU="You cannot post these lines because you have not entered a quantity on one or more of the lines. "';
      DimCombBlockedErr@1008 : TextConst '@@@="%1 = Journal Template Name; %2 = Journal Batch Name; %3 = Line No.";DAN=Kombinationen af de dimensioner, der bliver brugt i varekladdelinje %1, %2, %3, er sp‘rret. %4.;ENU=The combination of dimensions used in item journal line %1, %2, %3 is blocked. %4.';
      DimCausedErr@1009 : TextConst '@@@="%1 = Journal Template Name; %2 = Journal Batch Name; %3 = Line No.";DAN=En dimension, der bliver brugt i varekladdelinje %1, %2, %3, har for†rsaget en fejl. %4.;ENU=A dimension used in item journal line %1, %2, %3 has caused an error. %4.';
      Text011@1019 : TextConst 'DAN=%1 m† ikke v‘re lig med %2;ENU=%1 must not be equal to %2';
      ...
      Text012@1021 : TextConst 'DAN="Der kr‘ves lagerekspedition for %1 = %2, %3 = %4, %5 = %6.";ENU="Warehouse handling is required for %1 = %2, %3 = %4, %5 = %6."';
      CalledFromInvtPutawayPick@1022 : Boolean;
      CalledFromAdjustment@1020 : Boolean;
      UseInTransitLocationErr@1024 : TextConst 'DAN=Du kan kun bruge transitlokationen %1 til overflytningsordrer.;ENU=You can use In-Transit location %1 for transfer orders only.';
