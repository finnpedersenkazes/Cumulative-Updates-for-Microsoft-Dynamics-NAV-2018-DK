OBJECT Codeunit 64 Sales-Get Shipment
{
  ...
  {
    VAR
      Text001@1000 : TextConst 'DAN=%1 p† %2 %3 og %4 %5 skal v‘re identiske.;ENU=The %1 on the %2 %3 and the %4 %5 must be the same.';
      SalesHeader@1001 : Record 36;
      SalesLine@1002 : Record 37;
      SalesShptHeader@1003 : Record 110;
      SalesShptLine@1004 : Record 111;
      GetShipments@1005 : Page 5708;
      Text002@1007 : TextConst 'DAN=Opretter salgsfakturalinjer\;ENU=Creating Sales Invoice Lines\';
      Text003@1006 : TextConst 'DAN=Indsatte linjer            #1######;ENU=Inserted lines             #1######';
