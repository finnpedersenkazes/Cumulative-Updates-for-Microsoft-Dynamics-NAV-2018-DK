OBJECT Codeunit 1250 Match General Journal Lines
{
  ...
  {
    VAR
      MatchSummaryMsg@1000 : TextConst 'DAN=%1 betalingslinjer af %2 er matchet.\\;ENU=%1 payment lines out of %2 are matched.\\';
      MissingMatchMsg@1001 : TextConst 'DAN=Tekster p† under %1 tegn kan ikke matches.;ENU=Text shorter than %1 characters cannot be matched.';
      ProgressBarMsg@1002 : TextConst 'DAN=Vent venligst, mens operationen afsluttes.;ENU=Please wait while the operation is being completed.';
