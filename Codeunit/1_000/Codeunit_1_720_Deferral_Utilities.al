OBJECT Codeunit 1720 Deferral Utilities
{
  ...
  CODE
  {
    VAR
      ...
      InvalidPostingDateErr@1007 : TextConst '@@@="%1=The date passed in for the posting date.";DAN=%1 er ikke inden for intervallet af bogf›ringsdatoer for regnskabet.;ENU=%1 is not within the range of posting dates for your company.';
      DeferSchedOutOfBoundsErr@1022 : TextConst 'DAN=Periodiseringsplanen falder uden for de regnskabsperioder, der er oprettet for virksomheden.;ENU=The deferral schedule falls outside the accounting periods that have been set up for the company.';
      SelectDeferralCodeMsg@1023 : TextConst 'DAN=Du skal angive en periodiseringskode for linjen for at f† vist periodiseringsplanen.;ENU=A deferral code must be selected for the line to view the deferral schedule.';
