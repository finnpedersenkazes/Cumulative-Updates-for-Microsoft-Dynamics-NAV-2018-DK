OBJECT Codeunit 1750 Data Classification Mgt.
{
  ...
  CODE
  {
    VAR
      ...
      SyncFieldsReminderNotificationTxt@1026 : TextConst 'DAN=PÜmindelse om synkronisering af dataklassificeringer;ENU=Data Classifications sync reminder';
      SyncFieldsReminderNotificationDescriptionTxt@1027 : TextConst 'DAN=PÜmind mig for at finde ikke-klassificerede felter hver 30. dag;ENU=Remind me to find unclassified fields every 30 days';
      UnclassifiedFieldsNotificationTxt@1028 : TextConst 'DAN=Der mangler datafõlsomheder;ENU=Data Sensitivities are missing';
      UnclassifiedFieldsNotificationDescriptionTxt@1029 : TextConst 'DAN=Vis en advarsel, nÜr der er felter med manglende datafõlsomhed;ENU=Show a warning when there are fields with missing Data Sensitivity';
      ReviewPrivacySettingsNotificationTxt@1030 : TextConst 'DAN=Gennemse din pÜmindelse om indstillinger for beskyttelse af personlige oplysninger;ENU=Review your privacy settings reminder';
      ReviewPrivacySettingsNotificationDescriptionTxt@1031 : TextConst 'DAN=Vis en advarsel om at gennemse dine indstillinger for beskyttelse af personlige oplysninger, nÜr der findes personer fra EU i systemet.;ENU=Show a warning to review your privacy settings when persons from EU are found in your system';
