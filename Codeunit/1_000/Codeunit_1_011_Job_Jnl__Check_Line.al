OBJECT Codeunit 1011 Job Jnl.-Check Line
{
  ...
  CODE
  {
    VAR
      ...
      Text002@1002 : TextConst 'DAN=Kombinationen af dimensioner, der bliver brugt i %1 %2, %3, %4 er sp‘rret. %5;ENU=The combination of dimensions used in %1 %2, %3, %4 is blocked. %5';
      Text003@1003 : TextConst 'DAN=En dimension, der bliver brugt i %1 %2, %3, %4, har for†rsaget en fejl. %5;ENU=A dimension used in %1 %2, %3, %4 has caused an error. %5';
      ...
      Text004@1010 : TextConst '@@@="%1=Item;%2=JobJnlline.""No."";%3=Job;%4=JobJnlline.""Job No."";%5=JobJnlline.""Journal Batch Name"";%6=""Line No"";%7=JobJnlline.""Line No.""";DAN="Du skal bogf›re mere forbrug af %1 %2 i %3 %4, inden du kan bogf›re sagskladde %5 %6 = %7.";ENU="You must post more usage of %1 %2 in %3 %4 before you can post job journal %5 %6 = %7."';
    ...
    VAR
      ...
      Job@1007 : Record 167;
    BEGIN
      IF JobJnlline.IsServiceItem THEN
        EXIT;
