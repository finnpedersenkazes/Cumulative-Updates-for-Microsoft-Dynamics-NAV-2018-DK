OBJECT Codeunit 1605 PEPPOL Management
{
  ...
  CODE
  {
    VAR
      ...
      InvoiceDisAmtTxt@1001 : TextConst 'DAN=Fakturarabatbel›b;ENU=Invoice Discount Amount';
      LineDisAmtTxt@1011 : TextConst 'DAN=Linjerabatbel›b;ENU=Line Discount Amount';
      GLNTxt@1008 : TextConst '@@@={locked};DAN=GLN;ENU=GLN';
      VATTxt@1007 : TextConst '@@@={locked};DAN=VAT;ENU=VAT';
      MultiplyTxt@1006 : TextConst '@@@={locked};DAN=Multiply;ENU=Multiply';
      IBANPaymentSchemeIDTxt@1005 : TextConst '@@@={locked};DAN=IBAN;ENU=IBAN';
      LocalPaymentSchemeIDTxt@1004 : TextConst '@@@={locked};DAN=LOCAL;ENU=LOCAL';
      BICTxt@1003 : TextConst '@@@={locked};DAN=BIC;ENU=BIC';
      AllowanceChargeReasonCodeTxt@1002 : TextConst '@@@={locked};DAN=78;ENU=78';
      PaymentMeansFundsTransferCodeTxt@1009 : TextConst '@@@={locked};DAN=31;ENU=31';
      GTINTxt@1010 : TextConst '@@@={locked};DAN=GTIN;ENU=GTIN';
      UoMforPieceINUNECERec20ListIDTxt@1013 : TextConst '@@@={Locked};DAN=EA;ENU=EA';
      NoUnitOfMeasureErr@1014 : TextConst '@@@=1: document type, 2: document no 3 Unit of Measure Code;DAN=%1 %2 indeholder linjer, hvor feltet %3 er tomt.;ENU=The %1 %2 contains lines on which the %3 field is empty.';
    ...
    BEGIN
      ...
      IF TypeHelper.FindFields(FromRecRef.NUMBER,Field) THEN
        REPEAT
