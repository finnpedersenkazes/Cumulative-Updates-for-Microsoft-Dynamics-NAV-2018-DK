OBJECT Codeunit 1242 Set Up Curr Exch Rate Service
{
  ...
  CODE
  {
    VAR
      ...
      ECB_EXCH_RATESDescTxt@1005 : TextConst 'DAN=Ops‘tning af valutakurser for Den Europ‘iske Centralbank;ENU=European Central Bank Currency Exchange Rates Setup';
      ...
      ECBServiceProviderTxt@1011 : TextConst 'DAN=Den Europ‘iske Centralbank;ENU=European Central Bank';
