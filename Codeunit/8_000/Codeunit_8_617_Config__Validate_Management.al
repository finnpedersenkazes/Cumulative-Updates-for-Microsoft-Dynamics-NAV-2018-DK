OBJECT Codeunit 8617 Config. Validate Management
{
  ...
  {
    VAR
      Text001@1010 : TextConst 'DAN=Feltet %2 i tabellen %1 m† kun indeholde %3 tegn (%4).;ENU=Field %2 in table %1 can only contain %3 characters (%4).';
      Text002@1009 : TextConst 'DAN=%1 er ikke en underst›ttet datatype.;ENU=%1 is not a supported data type.';
      Text003@1008 : TextConst 'DAN=%1 er ikke en gyldig %2.;ENU=%1 is not a valid %2.';
      Text004@1011 : TextConst 'DAN=%1 er ikke en gyldig indstilling.\Gyldige indstillinger er %2.;ENU=%1 is not a valid option.\Valid options are %2.';
