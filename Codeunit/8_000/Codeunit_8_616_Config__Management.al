OBJECT Codeunit 8616 Config. Management
{
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Du skal angive et virksomhedsnavn.;ENU=You must specify a company name.';
      Text001@1001 : TextConst 'DAN=Vil du kopiere dataene fra tabellen %1 i %2?;ENU=Do you want to copy the data from the %1 table in %2?';
      Text002@1002 : TextConst 'DAN=Dataene fra tabellen %1 i %2 er blevet kopieret.;ENU=Data from the %1 table in %2 has been copied successfully.';
      Text003@1003 : TextConst 'DAN=Vil du kopiere dataene fra de valgte tabeller i %1?;ENU=Do you want to copy the data from the selected tables in %1?';
      Text004@1026 : TextConst 'DAN=Dataene fra de valgte tabeller i %1 er blevet kopieret.;ENU=Data from the selected tables in %1 has been copied successfully.';
      Text006@1006 : TextConst 'DAN=Basisvirksomheden m† ikke v‘re den samme som den aktuelle virksomhed.;ENU=The base company must not be the same as the current company.';
      Text007@1007 : TextConst 'DAN=Tabellen %1 i %2 indeholder allerede data.\\Du skal slette dataene fra tabellen, f›r du kan bruge denne funktion.;ENU=The %1 table in %2 already contains data.\\You must delete the data from the table before you can use this function.';
      Text009@1009 : TextConst 'DAN=Der er ingen data i tabellen %1 i %2.\\Du skal konfigurere tabellen manuelt i %3.;ENU=There is no data in the %1 table in %2.\\You must set up the table in %3 manually.';
      ...
      Text023@1005 : TextConst 'DAN=Behandler tabeller;ENU=Processing tables';
