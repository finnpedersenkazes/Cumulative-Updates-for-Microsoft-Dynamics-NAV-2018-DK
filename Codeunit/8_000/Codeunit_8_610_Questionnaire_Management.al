OBJECT Codeunit 8610 Questionnaire Management
{
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=V‘rdien af n›glefeltet %1 er ikke udfyldt i sp›rgeskemaet %2.;ENU=The value of the key field %1 has not been filled in for questionnaire %2.';
      ...
      Text001@1008 : TextConst 'DAN=Eksporterer sp›rgeskema;ENU=Exporting questionnaire';
      Text002@1009 : TextConst 'DAN=Indl‘ser sp›rgeskema;ENU=Importing questionnaire';
      Text005@1010 : TextConst 'DAN=XML-skemaet kunne ikke oprettes.;ENU=Could not create the XML schema.';
      Text007@1026 : TextConst 'DAN=Anvender svar;ENU=Applying answers';
      Text008@1025 : TextConst 'DAN=Opdaterer sp›rgeskema;ENU=Updating questionnaire';
      TypeHelper@1031 : Codeunit 10;
      Text019@1017 : TextConst 'DAN=Der kunne ikke oprettes en Excel-forekomst.;ENU=Could not create an Excel instance.';
      Text020@1014 : TextConst 'DAN=Excel indeholder ikke et XML-skema.;ENU=Excel does not contain an XML schema.';
      Text022@1005 : TextConst 'DAN=Opretter Excel-regneark;ENU=Creating Excel worksheet';
      ...
      Text024@1020 : TextConst 'DAN=Hent;ENU=Download';
      Text025@1021 : TextConst 'DAN=*.*|*.*;ENU=*.*|*.*';
      Text026@1022 : TextConst 'DAN=Standard;ENU=Default';
      CalledFromCode@1024 : Boolean;
      Text028@1019 : TextConst 'DAN=Indl‘s fil;ENU=Import File';
      Text029@1004 : TextConst '@@@="Only translate ''XML Files'' {Split=r""[\|\(]\*\.[^ |)]*[|) ]?""}";DAN=XML-fil (*.xml)|*.xml;ENU=XML file (*.xml)|*.xml';
