OBJECT Codeunit 5760 Whse.-Post Receipt
{
  ...
  CODE
  {
    VAR
      ...
      Text002@1002 : TextConst 'DAN=Antal bogf›rte kildedokumenter: %1 ud af %2.;ENU=Number of source documents posted: %1 out of a total of %2.';
      Text003@1003 : TextConst 'DAN=Antal oprettede l‘g-p†-lager-aktiviteter: %3.;ENU=Number of put-away activities created: %3.';
      ...
      Text004@1102601000 : TextConst 'DAN=er ikke inden for den tilladte bogf›ringsperiode;ENU=is not within your range of allowed posting dates';
    ...
    [Integration]
    LOCAL PROCEDURE OnBeforePostUpdateWhseRcptLine@23(VAR WarehouseReceiptLine@1000 : Record 7317);
    BEGIN
    END;
