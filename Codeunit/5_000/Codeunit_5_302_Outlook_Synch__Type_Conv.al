OBJECT Codeunit 5302 Outlook Synch. Type Conv
{
  ...
  CODE
  {
    VAR
      ...
      Text003@1003 : TextConst 'DAN=Synkroniseringen mislykkedes, fordi feltet %1 i tabellen %2 er af en ikke-underst›ttet type. Kontakt systemadministratoren.;ENU=The synchronization failed because the %1 field in the %2 table is of an unsupported type. Please contact your system administrator.';
