OBJECT Codeunit 5059 ProfileManagement
{
  ...
  {
    VAR
      Text000@1001 : TextConst 'DAN=Generelt;ENU=General';
      Text001@1002 : TextConst 'DAN=Der er ikke oprettet et profilsp›rgeskema til denne kontakt.;ENU=No profile questionnaire is created for this contact.';
