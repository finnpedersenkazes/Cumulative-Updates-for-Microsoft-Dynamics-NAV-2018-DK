OBJECT Codeunit 5300 Outlook Synch. Setup Mgt.
{
  ...
  CODE
  {
    VAR
      ...
      Text001@1021 : TextConst 'DAN=Du skal v‘lge en tabel og angive et filter.;ENU=You should select a table and define a filter.';
      Text002@1015 : TextConst 'DAN=Du kan ikke konfigurere en korrelation med en egenskab for et Outlook-element for dette felt, fordi det ikke er af typen Indstilling.;ENU=You cannot setup a correlation with a property of an Outlook item for this field because it is not of the Option type.';
      Text003@1009 : TextConst 'DAN=Filteret kan ikke behandles, fordi dets l‘ngde overskrider %1 symboler. Angiv kriterierne igen.;ENU=The filter cannot be processed because its length exceeds %1 symbols. Please redefine your criteria.';
      Text004@1003 : TextConst 'DAN=Enheden %1 blev ikke fundet i %2 for den valgte samling.;ENU=The %1 entity cannot be found in the %2 for the selected collection.';
      Text005@1002 : TextConst 'DAN=Enheden %1 m† ikke have ''%2'' %3 i %4.;ENU=The %1 entity should not have the ''%2'' %3 in the %4.';
      Text006@1024 : TextConst 'DAN=Enhederne %1 blev ikke fundet i %2 for den valgte samling.;ENU=The %1 entities cannot be found in the %2 for the selected collection.';
      Text007@1000 : TextConst 'DAN=Du kan ikke konfigurere en korrelation med dette felt. Denne egenskab for et Outlook-element er ikke en opt‘llingsv‘rdi. Klik p† knappen Assist for at f† vist en liste over gyldige opt‘llingsv‘rdier.;ENU=You cannot setup a correlation with this field. This property of an Outlook item is not an enumeration value. Use the Assist button to see a list of valid enumeration values.';
      Text008@1026 : TextConst 'DAN=Feltet %1 m† ikke v‘re tomt.;ENU=The %1 field cannot be empty.';
      Text011@1016 : TextConst 'DAN=Tabellen %1 kan ikke behandles, fordi dens prim‘re n›gle indeholder mere end 3 felter.;ENU=The %1 table cannot be processed because its primary key contains more than 3 fields.';
      Text014@1201 : TextConst 'DAN=Installationen og konfigurationen af tilf›jelsesprogrammet Microsoft Outlook Integration er endnu ikke fuldf›rt. Kontroller, at Outlook Integration er installeret, og at alle de n›dvendige objekter har tilladelse til at k›re.;ENU=Installation and configuration of the Microsoft Outlook Integration add-in is not complete. Be sure that Outlook Integration is installed and all required objects are allowed to run.';
