OBJECT Codeunit 5790 Available to Promise
{
  ...
  CODE
  {
    ...
    [Integration]
    LOCAL PROCEDURE OnBeforeCalcAvailableInventory@40(VAR Item@1000 : Record 27);
    BEGIN
    END;

    [Integration]
    LOCAL PROCEDURE OnBeforeExitCalcGrossRequirement@43(VAR Item@1000 : Record 27);
    BEGIN
    END;

    [Integration]
    LOCAL PROCEDURE OnBeforeExitCalcScheduledReceipt@44(VAR Item@1000 : Record 27);
    BEGIN
    END;

    [Integration]
    LOCAL PROCEDURE OnCalcAvailableInventory@41(VAR Item@1000 : Record 27;VAR AvailableInventory@1001 : Decimal);
    BEGIN
    END;
