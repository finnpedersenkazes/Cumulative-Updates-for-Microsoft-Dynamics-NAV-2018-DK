OBJECT Codeunit 5811 Change Exp. Cost Post. to G/L
{
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Hvis du ‘ndrer %1, skal programmet opdatere tabel %2.;ENU=If you change the %1, the program must update table %2.';
      Text001@1001 : TextConst 'DAN=Dette kan tage flere timer.\;ENU=This can take several hours.\';
      Text002@1002 : TextConst 'DAN=Er du sikker p†, at du vil ‘ndre %1?;ENU=Do you really want to change the %1?';
      Text003@1003 : TextConst 'DAN=’ndringen er annulleret.;ENU=The change has been cancelled.';
      Text004@1004 : TextConst 'DAN=Behandler poster...\\;ENU=Processing entries...\\';
      Text005@1005 : TextConst 'DAN=Varenr.  #1########## @2@@@@@@@@@@@@@;ENU=Item No. #1########## @2@@@@@@@@@@@@@';
      Text007@1007 : TextConst 'DAN=%1 blev ‘ndret til %2. Du skal starte %3.;ENU=%1 has been changed to %2. You should now run %3.';
      Text008@1008 : TextConst 'DAN=Sletter %1 poster...;ENU=Deleting %1 entries...';
      Window@1012 : Dialog;
