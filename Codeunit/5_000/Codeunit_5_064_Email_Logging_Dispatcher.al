OBJECT Codeunit 5064 Email Logging Dispatcher
{
  ...
  CODE
  {
    VAR
      ...
      Text001@1001 : TextConst 'DAN=Det lykkedes ikke at udfõre automatisk registrering af Exchange-tjenesten.;ENU=Autodiscovery of exchange service failed.';
      Text002@1000 : TextConst 'DAN=Mappen %1 findes ikke. Kontroller, at stien til mappen er korrekt i vinduet Marketingopsëtning.;ENU=The %1 folder does not exist. Verify that the path to the folder is correct in the Marketing Setup window.';
      Text003@1003 : TextConst 'DAN=Kõ- eller lagermappen er ikke blevet initialiseret. Indtast mappestien i vinduet Marketingopsëtning.;ENU=The queue or storage folder has not been initialized. Enter the folder path in the Marketing Setup window.';
      Text101@1004 : TextConst 'DAN=Validerer opsëtning;ENU=Validating setup';
      ...
      Text103@1006 : TextConst 'DAN=èbner kõmappe;ENU=Opening queue folder';
      Text104@1007 : TextConst 'DAN=èbner lagringsmappe;ENU=Opening storage folder';
      Text105@1008 : TextConst 'DAN=Lëser mails;ENU=Reading email messages';
      Text106@1009 : TextConst 'DAN=Kontrollerer nëste mail;ENU=Checking next email message';
      Text107@1010 : TextConst 'DAN=Logfõrer mails;ENU=Logging email messages';
      Text108@1011 : TextConst 'DAN=Sletter mail fra kõen;ENU=Deleting email message from queue';
      ErrorContext@1002 : Text;
      Text109@1014 : TextConst 'DAN=Interaktionsskabelonen til mails er ikke blevet angivet i vinduet Interaktionsskabelonopsëtning.;ENU=The interaction template for email messages has not been specified in the Interaction Template Setup window.';
      Text110@1013 : TextConst 'DAN=Der er blevet angivet en skabelon til mails i vinduet Interaktionsskabelonopsëtning, men skabelonen findes ikke.;ENU=An interaction template for email messages has been specified in the Interaction Template Setup window, but the template does not exist.';
