OBJECT Codeunit 5431 Calc. Item Plan - Plan Wksh.
{
  ...
  CODE
  {
    VAR
      ...
      FromDate@1007 : Date;
      ToDate@1006 : Date;
      Text000@1045 : TextConst 'DAN=Du skal angive det, der skal beregnes.;ENU=You must decide what to calculate.';
      Text001@1044 : TextConst 'DAN=Angiv en startdato.;ENU=Enter a starting date.';
      Text002@1043 : TextConst 'DAN=Angiv en slutdato.;ENU=Enter an ending date.';
      Text003@1042 : TextConst 'DAN=Slutdatoen m† ikke v‘re tidligere end ordredatoen.;ENU=The ending date must not be before the order date.';
      Text004@1041 : TextConst 'DAN=Du kan ikke bruge et variantfilter, n†r du beregner hovedplan ud fra et forecast.;ENU=You must not use a variant filter when calculating MPS from a forecast.';
