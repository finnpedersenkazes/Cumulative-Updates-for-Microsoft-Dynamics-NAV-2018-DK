OBJECT Codeunit 5304 Outlook Synch. Outlook Mgt.
{
  ...
  CODE
  {
    VAR
      ...
      Text002@1000 : TextConst 'DAN=Enheden %1 kan ikke synkroniseres, fordi den nu er baseret p† en anden tabel. Fors›g igen senere, og kontakt systemadministratoren, hvis problemet ikke er l›st.;ENU=The %1 entity cannot be synchronized because it is now based on another table. Try again later and if the problem persists contact your system administrator.';
      Text003@1001 : TextConst 'DAN=Outlook-elementet til enheden %1 kan ikke synkroniseres, fordi det ikke blev fundet i Outlook-synkroniseringsmapperne.;ENU=The Outlook item for the %1 entity cannot be synchronized because it was not found in Outlook synchronization folders.';
      Text004@1015 : TextConst 'DAN=Enheden %1 findes ikke. Fors›g igen senere, og kontakt systemadministratoren, hvis problemet ikke er l›st.;ENU=The %1 entity does not exist. Try again later and if the problem persists contact your system administrator.';
