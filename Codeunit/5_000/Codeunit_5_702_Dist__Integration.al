OBJECT Codeunit 5702 Dist. Integration
{
  ...
  CODE
  {
    ...
    [Integration]
    LOCAL PROCEDURE OnAfterInsertPurchLine@1001(VAR PurchaseLine@1000 : Record 39);
    BEGIN
    END;
