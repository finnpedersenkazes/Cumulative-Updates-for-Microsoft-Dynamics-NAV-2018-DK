OBJECT Codeunit 5980 Service-Post
{
  ...
  CODE
  {
    VAR
      ...
      Text001@1025 : TextConst 'DAN=Der er intet at bogf›re.;ENU=There is nothing to post.';
      Text002@1024 : TextConst 'DAN=Linjerne bogf›res          #2######\;ENU=Posting lines              #2######\';
      Text003@1023 : TextConst 'DAN=Bogf›rer serv. og moms     #3######\;ENU=Posting serv. and VAT      #3######\';
      Text004@1022 : TextConst 'DAN=Debitorerne bogf›res       #4######\;ENU=Posting to customers       #4######\';
      Text005@1021 : TextConst 'DAN=Bogf›rer p† modkonto       #5######;ENU=Posting to bal. account    #5######';
      Text006@1020 : TextConst 'DAN=Linjer bogf›res            #2######;ENU=Posting lines              #2######';
      Text007@1003 : TextConst 'DAN=er ikke inden for den tilladte bogf›ringsperiode;ENU=is not within your range of allowed posting dates';
      WhseShip@1017 : Boolean;
      OIOXMLCheckServiceHeader@1101100000 : Codeunit 13613;
      PreviewMode@1019 : Boolean;
      NotSupportedDocumentTypeErr@1026 : TextConst '@@@="%1=Document Type e.g. Invoice";DAN=Dokumenttypen %1 underst›ttes ikke.;ENU=Document type %1 is not supported.';
    ...
    [Internal]
    PROCEDURE SendPostedDocumentRecord@223(ServiceHeader@1000 : Record 5900;VAR DocumentSendingProfile@1001 : Record 60);
    VAR
      ServiceInvHeader@1007 : Record 5992;
      ServiceCrMemoHeader@1006 : Record 5994;
    BEGIN
    ...
    [Integration]
    LOCAL PROCEDURE OnBeforePostWithLines@1(VAR PassedServHeader@1004 : Record 5900;VAR PassedServLine@1003 : Record 5902;VAR PassedShip@1002 : Boolean;VAR PassedConsume@1001 : Boolean;VAR PassedInvoice@1000 : Boolean);
    BEGIN
    END;
