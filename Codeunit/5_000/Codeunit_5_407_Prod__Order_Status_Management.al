OBJECT Codeunit 5407 Prod. Order Status Management
{
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=%2 %3  med status %1 er ‘ndret til %5 %6 med status %4.;ENU=%2 %3  with status %1 has been changed to %5 %6 with status %4.';
      Text002@1002 : TextConst 'DAN=Auto. forbrug bogf›res       ...\\;ENU=Posting Automatic consumption...\\';
      Text003@1003 : TextConst 'DAN=Linjerne bogf›res     #1###### @2@@@@@@@@@@@@@;ENU=Posting lines         #1###### @2@@@@@@@@@@@@@';
      Text004@1004 : TextConst 'DAN=%1 %2 er ikke f‘rdig. Der mangler stadig afgang. Vil du f‘rdigg›re ordren?;ENU=%1 %2 has not been finished. Some output is still missing. Do you still want to finish the order?';
      ...
      Text006@1006 : TextConst 'DAN=%1 %2 er ikke f‘rdig. Der mangler stadig forbrug. Vil du f‘rdigg›re ordren?;ENU=%1 %2 has not been finished. Some consumption is still missing. Do you still want to finish the order?';
      ...
      Text008@1001 : TextConst 'DAN=Det er ikke muligt at afslutte %1 %2, fordi den tilknyttede underkontraktordre %3 ikke er fuldt leveret.;ENU=%1 %2 cannot be finished as the associated subcontract order %3 has not been fully delivered.';
      Text009@1010 : TextConst 'DAN=Du kan ikke afslutte linje %1 p† %2 %3, fordi der er bogf›rt forbrug eller kapacitet uden afgang.;ENU=You cannot finish line %1 on %2 %3. It has consumption or capacity posted with no output.';
      Text010@1019 : TextConst 'DAN=Du skal angive %1 i %2 %3 %4.;ENU=You must specify a %1 in %2 %3 %4.';
