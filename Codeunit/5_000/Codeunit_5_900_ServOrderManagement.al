OBJECT Codeunit 5900 ServOrderManagement
{
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Du kan ikke oprette en %1, fordi feltet %2 ikke er tomt.;ENU=You cannot create a %1, because the %2 field is not empty.';
      Text001@1001 : TextConst 'DAN=Du skal angive %1, %2 og %3 i %4 %5, f›r du opretter nye %6.;ENU=You must specify %1, %2 and %3 in %4 %5, before you create new %6.';
      Text002@1002 : TextConst 'DAN=Debitoren findes allerede.\\;ENU=This customer already exists.\\';
      Text003@1003 : TextConst 'DAN=Vil du oprette en ny %1 i stedet for at bruge en eksisterende?;ENU=Do you want create a new %1 instead of using the existing one?';
      Text004@1004 : TextConst 'DAN=Der er ikke oprettet nogen debitorskabeloner.;ENU=There are no Customer Templates.';
      Text005@1005 : TextConst 'DAN=Bogf›ringen kan ikke udf›res. Feltet %1 p† servicefakturalinjerne skal indeholde 1, fordi %2 %3 blev erstattet.;ENU=Posting cannot be completed successfully. The %1 field on the service invoice lines should contain 1 because %2 %3 was replaced.';
      Text006@1006 : TextConst 'DAN=%1 %2 er allerede tildelt til %3 %4.;ENU=The %1 %2 is already assigned to %3 %4.';
      Text007@1007 : TextConst 'DAN=%1 %2 blev oprettet.;ENU=%1 %2 was created.';
      Text008@1008 : TextConst 'DAN=Der er ikke plads til at inds‘tte %1.;ENU=There is not enough space to insert %1.';
      Text009@1009 : TextConst 'DAN=Rejseomkostningerne i tabellen %1 med %2 %3 blev ikke fundet.;ENU=Travel fee in the %1 table with %2 %3 cannot be found.';
      Text011@1011 : TextConst 'DAN=Der er ingen %1 for %2 %3.;ENU=There is no %1 for %2 %3.';
      Text012@1012 : TextConst 'DAN=Du kan ikke bogf›re %1 %2.\\%3 %4 i %5 linje %6 forhindrer dette.;ENU=You can not post %1 %2.\\%3 %4 in %5 line %6 is preventing it.';
    ...
    [External]
    PROCEDURE ReplacementCreateServItem@1(FromServItem@1000 : Record 5940;ServiceLine@1001 : Record 5902;ServShptDocNo@1011 : Code[20];ServShptLineNo@1012 : Integer;VAR TempTrackingSpecification@1008 : TEMPORARY Record 336);
    VAR
    ...
    LOCAL PROCEDURE CopyComponentsFromSI@11(OldServItem@1000 : Record 5940;NewServItem@1001 : Record 5940;CopySerialNo@1002 : Boolean);
    VAR
