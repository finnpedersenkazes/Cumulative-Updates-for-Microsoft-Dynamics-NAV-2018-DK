OBJECT Codeunit 5600 FA Insert Ledger Entry
{
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN="%2 = %3 findes ikke for %1.";ENU="%2 = %3 does not exist for %1."';
      Text001@1001 : TextConst 'DAN="%2 = %3 svarer ikke til kladdelinje for %1.";ENU="%2 = %3 does not match the journal line for %1."';
      Text002@1002 : TextConst 'DAN=%1 er et %2. %3 skal v‘re %4 i %5.;ENU=%1 is a %2. %3 must be %4 in %5.';
      ...
      Text003@1025 : TextConst 'DAN=%1 m† ikke v‘re %2 i %3 %4.;ENU=%1 must not be %2 in %3 %4.';
      Text004@1024 : TextConst 'DAN=Tilbagef›rslen fandt %1 uden tilsvarende %2.;ENU=Reversal found a %1 without a matching %2.';
      RegisterInserted@1026 : Boolean;
      Text005@1029 : TextConst 'DAN=Du kan ikke tilbagef›re transaktionen, fordi den allerede er tilbagef›rt.;ENU=You cannot reverse the transaction, because it has already been reversed.';
      Text006@1030 : TextConst 'DAN=Kombinationen af de dimensioner, der bliver brugt i %1 %2, er sp‘rret. %3;ENU=The combination of dimensions used in %1 %2 is blocked. %3';
      LastEntryNo@1031 : Integer;
      Text007@1032 : TextConst 'DAN="%1 = %2 findes allerede for %5 (%3 = %4).";ENU="%1 = %2 already exists for %5 (%3 = %4)."';
