OBJECT XMLport 1010 SEPA DD pain.008.001.02
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=SEPA DD pain.008.001.02;
               ENU=SEPA DD pain.008.001.02];
    Direction=Export;
    Encoding=UTF-8;
  ...
  ELEMENTS
  {
    ...
    { [{6F3D66BA-368F-4018-AC01-5F66B2E7E93B}];5 ;Ustrd               ;Element ;Text    ;
                                                  VariableName=RemittanceText;
                                                  DataType=Text;
                                                  Export::OnBeforePassVariable=BEGIN
  ...
  {
    VAR
      NoDataToExportErr@1000 : TextConst '@@@="%1=Field;%2=Value;%3=Value";DAN=Der er ingen data at udl‘se. Kontroll‚r, at feltet %1 ikke er angivet til %2 eller %3.;ENU=There is no data to export. Make sure the %1 field is not set to %2 or %3.';
