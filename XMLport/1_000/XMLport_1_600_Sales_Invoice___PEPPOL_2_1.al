OBJECT XMLport 1600 Sales Invoice - PEPPOL 2.1
{
  OBJECT-PROPERTIES
  {
    Date=27-07-18;
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Salgsfaktura - PEPPOL 2.1;
               ENU=Sales Invoice - PEPPOL 2.1];
    Direction=Export;
    Encoding=UTF-8;
  ...
  ELEMENTS
  {
    { [{F76F4B37-89D5-4ED8-86C2-1317CF089B42}];  ;Invoice             ;Element ;Table   ;
                                                  VariableName=InvoiceHeaderLoop;
                                                  SourceTable=Table2000000026;
                                                  SourceTableView=SORTING(Field1)
                                                                  WHERE(Field1=FILTER(1..));
                                                  MaxOccurs=Once;
                                                  Export::OnAfterGetRecord=VAR
                                                                             TaxCurrencyCode@1001 : Text;
                                                                             TaxCurrencyCodeListID@1000 : Text;
                                                                           BEGIN
    ...
    { [{4D3A5B2A-ACDF-4167-A01F-C6207D34689C}];1 ;InvoiceTypeCode     ;Element ;Text    ;
                                                  NamespacePrefix=cbc }

    { [{86E015DE-1E82-4FB2-932E-FC82CD4FDD14}];2 ;listID              ;Attribute;Text   ;
                                                  VariableName=InvoiceTypeCodeListID }
    ...
    { [{BB7BF69E-D2C0-4D5B-BCA3-B27415BD292D}];1 ;ContractDocumentReference;Element;Text;
                                                  ...
                                                  Export::OnBeforePassVariable=VAR
                                                                                 DocumentTypeCode@1000 : Text;
                                                                                 ContractRefDocTypeCodeListID@1001 : Text;
                                                                               BEGIN
    ...
    { [{9989D34D-B9BF-4AE5-B733-F1D5F0DFD2BC}];1 ;InvoiceLine         ;Element ;Table   ;
                                                  VariableName=InvoiceLineLoop;
                                                  SourceTable=Table2000000026;
                                                  SourceTableView=SORTING(Field1)
                                                                  WHERE(Field1=FILTER(1..));
                                                  NamespacePrefix=cac;
    ...
    { [{07B507A9-A5FB-4F95-9648-D6DE32ECA4A6}];2 ;InvoicedQuantity    ;Element ;Text    ;
                                                  NamespacePrefix=cbc }
    ...
    { [{F226C977-3523-4015-BE61-ABB366F61F10}];2 ;LineExtensionAmount ;Element ;Text    ;
                                                  VariableName=InvoiceLineExtensionAmount;
                                                  NamespacePrefix=cbc }
    ...
    { [{C94B92A2-8B3F-435A-8687-BDD3876661A0}];2 ;AccountingCost      ;Element ;Text    ;
                                                  VariableName=InvoiceLineAccountingCost;
                                                  NamespacePrefix=cbc }

    { [{F04FA211-6719-4B9B-A39B-66EBCB237B03}];2 ;InvoicePeriod       ;Element ;Text    ;
                                                  VariableName=InvoiceLineInvoicePeriod;
                                                  NamespacePrefix=cac;
                                                  Export::OnBeforePassVariable=BEGIN
    ...
    { [{FC51F12D-6D45-401F-A2FC-CCAE91B19033}];2 ;Delivery            ;Element ;Text    ;
                                                  VariableName=InvoiceLineDelivery;
                                                  NamespacePrefix=cac;
                                                  Export::OnBeforePassVariable=BEGIN
    ...
    { [{3E7C0013-CCA8-4E46-BCBC-E7627C254860}];3 ;ChargeIndicator     ;Element ;Text    ;
                                                  VariableName=InvLnAllowanceChargeIndicator;
                                                  NamespacePrefix=cbc }

    { [{CEB0CD22-AC2C-47F8-9E28-DEA9D590882D}];3 ;AllowanceChargeReason;Element;Text    ;
                                                  VariableName=InvLnAllowanceChargeReason;
                                                  NamespacePrefix=cbc }

    { [{4C3E9FAA-465F-4A3F-B2F2-BBEA5B739123}];3 ;Amount              ;Element ;Text    ;
                                                  VariableName=InvLnAllowanceChargeAmount;
                                                  NamespacePrefix=cbc }

    { [{83958EAB-563D-454F-B3BD-1D560E05B706}];4 ;currencyID          ;Attribute;Text   ;
                                                  VariableName=InvLnAllowanceChargeAmtCurrID }

    { [{475CB8C2-1C39-4634-A8AB-BFD033C726EF}];2 ;TaxTotal            ;Element ;Text    ;
                                                  VariableName=InvoiceLineTaxTotal;
                                                  NamespacePrefix=cac;
                                                  Export::OnBeforePassVariable=BEGIN
    ...
    { [{7A27083A-25BC-4174-935F-259E54C9B266}];3 ;TaxAmount           ;Element ;Text    ;
                                                  VariableName=InvoiceLineTaxAmount;
                                                  NamespacePrefix=cbc }

    { [{E198B5B1-1ECC-4D39-8C19-B99978B1587B}];4 ;currencyID          ;Attribute;Text    }
    ...
    { [{2E586EB8-67A3-4D22-8E19-BA5B1C567584}];4 ;Percent             ;Element ;Text    ;
                                                  VariableName=InvoiceLineTaxPercent;
                                                  NamespacePrefix=cbc }
    ...
    { [{9F8E303C-D885-4800-8127-4E1D79A1DF3C}];3 ;PriceAmount         ;Element ;Text    ;
                                                  VariableName=InvoiceLinePriceAmount;
                                                  NamespacePrefix=cbc }

    { [{58D2614F-230C-45B4-964A-68BC63710A49}];4 ;currencyID          ;Attribute;Text   ;
                                                  VariableName=InvLinePriceAmountCurrencyID }

    { [{6C453197-C3CD-428B-89D0-70F1684156DA}];3 ;BaseQuantity        ;Element ;Text    ;
                                                  NamespacePrefix=cbc }

    { [{E7E570BF-E74C-46C5-B2BF-656E2D653BDF}];4 ;unitCode            ;Attribute;Text   ;
                                                  VariableName=UnitCodeBaseQty }

    { [{3BA8C4C7-0DDB-42C0-B74E-55CA709960BE}];4 ;unitCodeListID      ;Attribute;Text   ;
                                                  VariableName=CodeListIDBaseQty;
                                                  Export::OnBeforePassVariable=BEGIN
  ...
  REQUESTPAGE
  {
    ...
    CONTROLS
    {
      ...
      { 3   ;2   ;Field     ;
                  CaptionML=[DAN=Salgsfakturanr.;
                             ENU=Sales Invoice No.];
                  SourceExpr=SalesInvoiceHeader."No.";
  ...
  CODE
  {
    VAR
      ...
      SpecifyASalesInvoiceNoErr@1014 : TextConst 'DAN=Du skal angive et salgsfakturanummer.;ENU=You must specify a sales invoice number.';
      SpecifyAServInvoiceNoErr@1010 : TextConst 'DAN=Du skal angive et servicefakturanummer.;ENU=You must specify a service invoice number.';
      ...
      DefaultUnitCostListID@1011 : Text;

    [External]
    PROCEDURE GetTotals@1170000009();
    BEGIN
    ...
    LOCAL PROCEDURE FindNextInvoiceRec@80(Position@1000 : Integer) : Boolean;
    VAR
    ...
    LOCAL PROCEDURE FindNextInvoiceLineRec@84(Position@1000 : Integer) : Boolean;
    VAR
      Found@1001 : Boolean;
    BEGIN
      CASE ProcessedDocType OF
