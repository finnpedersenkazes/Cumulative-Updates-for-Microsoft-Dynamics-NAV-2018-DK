OBJECT XMLport 9000 Export/Import User Groups
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Eksport‚r/import‚r brugergrupper;
               ENU=Export/Import User Groups];
    OnPostXMLport=BEGIN
                    IF IsImport THEN
  ...
  ELEMENTS
  {
    ...
    { [{E52059C6-3FC9-4563-958C-C6EB3C84442F}];2 ;DefaultProfile      ;Element ;Field   ;
                                                  DataType=Code;
                                                  SourceField=User Group::Default Profile ID }
  ...
  CODE
  {
    VAR
      ...
      InsertedMsg@1002 : TextConst '@@@=%1 and %2 are numbers/quantities.;DAN=%1 brugergrupper med et samlet rettighedss‘t for brugergruppe p† %2 blev indsat.;ENU=%1 user groups with a total of %2 user group permission sets were inserted.';
