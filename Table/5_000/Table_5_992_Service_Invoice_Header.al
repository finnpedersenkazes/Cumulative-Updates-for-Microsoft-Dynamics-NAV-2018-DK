OBJECT Table 5992 Service Invoice Header
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Servicefakturahoved;
               ENU=Service Invoice Header];
  ...
  FIELDS
  {
    ...
    { 61  ;   ;Amount Including VAT;Decimal       ;FieldClass=FlowField;
                                                   ...
                                                   AutoFormatType=1;
                                                   AutoFormatExpr="Currency Code" }
    { 62  ;   ;Shipping No.        ;Code20        ;CaptionML=[DAN=Leverancenr.;
                                                              ENU=Shipping No.] }
    ...
    { 13601;  ;Account Code        ;Text30        ;ObsoleteState=Pending;
                                                   ...
                                                   CaptionML=[DAN=Kontokode;
                                                              ENU=Account Code] }
    { 13602;  ;Electronic Invoice Created;Boolean ;ObsoleteState=Pending;
                                                   ObsoleteReason=Moved to extension.;
  ...
  CODE
  {
    VAR
      ...
      DocTxt@1002 : TextConst 'DAN=Servicefaktura;ENU=Service Invoice';
