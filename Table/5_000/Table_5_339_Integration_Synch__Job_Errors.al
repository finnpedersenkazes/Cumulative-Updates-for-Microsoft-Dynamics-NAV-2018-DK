OBJECT Table 5339 Integration Synch. Job Errors
{
  ...
  FIELDS
  {
    ...
    { 4   ;   ;Destination Record ID;RecordID     ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Destinationsrecord-id;
                                                              ENU=Destination Record ID] }
    { 5   ;   ;Message             ;Text250       ;CaptionML=[DAN=Meddelelse;
                                                              ENU=Message] }
    { 6   ;   ;Date/Time           ;DateTime      ;CaptionML=[DAN=Dato/klokkesl‘t;
                                                              ENU=Date/Time] }
  ...
  {
    VAR
      DeleteEntriesQst@1000 : TextConst '@@@="%1 = Integration Synch. Job Errors caption";DAN=Er du sikker p†, at du vil slette posterne %1?;ENU=Are you sure that you want to delete the %1 entries?';
