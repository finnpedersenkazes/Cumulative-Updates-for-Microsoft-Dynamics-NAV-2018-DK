OBJECT Table 5409 Prod. Order Routing Line
{
  ...
  FIELDS
  {
    ...
    { 5   ;   ;Next Operation No.  ;Code30        ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Nëste operationsnr.;
    ...
    { 16  ;   ;Fixed Scrap Quantity;Decimal       ;OnValidate=BEGIN
                                                   ...
                                                   DecimalPlaces=0:5;
                                                   MinValue=0 }
    { 17  ;   ;Lot Size            ;Decimal       ;CaptionML=[DAN=Lotstõrrelse;
                                                              ENU=Lot Size];
                                                   DecimalPlaces=0:5 }
    ...
    { 41  ;   ;Recalculate         ;Boolean       ;CaptionML=[DAN=Genberegn;
                                                              ENU=Recalculate] }
    { 50  ;   ;Sequence No. (Forward);Integer     ;CaptionML=[DAN=Rëkkefõlgenr. (fremad);
                                                              ENU=Sequence No. (Forward)];
                                                   Editable=No }
    { 51  ;   ;Sequence No. (Backward);Integer    ;CaptionML=[DAN=Rëkkefõlgenr. (bagud);
    ...
    { 53  ;   ;Scrap Factor % (Accumulated);Decimal;
                                                   ...
                                                   DecimalPlaces=0:5;
                                                   Editable=No }
    { 55  ;   ;Sequence No. (Actual);Integer      ;CaptionML=[DAN=Rëkkefõlgenr. (faktisk);
    ...
    { 74  ;   ;Status              ;Option        ;CaptionML=[DAN=Status;
                                                              ENU=Status];
                                                   OptionCaptionML=[DAN=Simuleret,Planlagt,Fastlagt,Frigivet,Udfõrt;
    ...
    { 100 ;   ;Schedule Manually   ;Boolean       ;CaptionML=[DAN=Planlëg manuelt;
  ...
  {
    VAR
      Text000@1000 : TextConst '@@@="%1 = Document status; %2 = Table Caption; %3 = Field Value; %4 = Table Caption";DAN=Du kan ikke slette %1 %2 %3, fordi der er tilknyttet mindst Çn %4.;ENU=You cannot delete %1 %2 %3 because there is at least one %4 associated with it.';
      ...
      Text003@1003 : TextConst 'DAN=Denne rutelinje kan ikke flyttes pga. kritiske arbejdscentre i de fõlgende operationer;ENU=This routing line cannot be moved because of critical work centers in next operations';
      ...
      Text004@1019 : TextConst 'DAN=Nogle rutelinjer refererer til den operation, der lige er blevet slettet. Referencerne findes\i felterne %1 og %2.\\Det skal muligvis rettes, da en rutelinje, der refererer til en ikkeeksisterende\operation, vil forÜrsage alvorlige fejl i kapacitetsplanlëgningen.\\Vil du have vist en oversigt over de pÜgëldende linjer?\(GÜ til kolonnerne Nëste operationsnr. og Forrige operationsnr.).;ENU=Some routing lines are referring to the operation just deleted. The references are\in the fields %1 and %2.\\This may have to be corrected as a routing line referring to a non-existent\operation will lead to serious errors in capacity planning.\\Do you want to see a list of the lines in question?\(Access the columns Next Operation No. and Previous Operation No.)';
      ...
      Text006@1020 : TextConst 'DAN=%1 %2 kan ikke indsëttes, ëndres eller slettes.;ENU=A %1 %2 can not be inserted, modified, or deleted.';
      Direction@1018 : 'Forward,Backward';
      Text007@1022 : TextConst 'DAN=Du kan ikke ëndre %1, fordi der er mindst Çn/Çt %2 knyttet til %3 %4 %5.;ENU=You cannot change %1, because there is at least one %2 associated with %3 %4 %5.';
      Text008@1023 : TextConst 'DAN=Du kan ikke ëndre %1 fra %2 til %3.;ENU=You cannot change the %1 from %2 to %3.';
      Text009@1024 : TextConst 'DAN=Hvis du ëndrer %1 til %2, slettes hele den relaterede allokerede kapacitet, og du kan ikke ëndre %1 for operationen igen.\\Er du sikker pÜ, at du vil fortsëtte?;ENU=If you change the %1 to %2, then all related allocated capacity will be deleted, and you will not be able to change the %1 of the operation again.\\Are you sure that you want to continue?';
