OBJECT Table 5998 Standard Service Item Gr. Code
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Gruppekode for standardserviceartikel;
               ENU=Standard Service Item Gr. Code];
  }
  FIELDS
  {
  ...
  {
    VAR
      Text001@1000 : TextConst 'DAN=%1 i standardservicekoden skal v‘re identisk med to %2 p† %3.;ENU=%1 of the standard service code must be equal to %2 on the %3.';
