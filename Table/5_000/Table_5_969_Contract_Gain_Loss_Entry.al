OBJECT Table 5969 Contract Gain/Loss Entry
{
  ...
  FIELDS
  {
    ...
    { 4   ;   ;Change Date         ;Date          ;CaptionML=[DAN=índringsdato;
                                                              ENU=Change Date] }
    { 5   ;   ;Reason Code         ;Code10        ;TableRelation="Reason Code";
                                                   CaptionML=[DAN=èrsagskode;
                                                              ENU=Reason Code] }
    { 6   ;   ;Type of Change      ;Option        ;CaptionML=[DAN=índringstype;
                                                              ENU=Type of Change];
                                                   OptionCaptionML=[DAN=Linje tilfõjet,Linje slettet,Kontrakt underskr.,Kontrakt annulleret,Manuel opdatering,Prisregulering;
