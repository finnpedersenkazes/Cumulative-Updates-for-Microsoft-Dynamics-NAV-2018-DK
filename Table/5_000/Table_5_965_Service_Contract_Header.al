OBJECT Table 5965 Service Contract Header
{
  ...
  FIELDS
  {
    ...
    { 5   ;   ;Status              ;Option        ;OnValidate=VAR
                                                   ...
                                                   Editable=Yes }
    { 6   ;   ;Change Status       ;Option        ;CaptionML=[DAN=índringsstatus;
                                                              ENU=Change Status];
                                                   OptionCaptionML=[DAN=èben,LÜst;
                                                                    ENU=Open,Locked];
    ...
    { 32  ;   ;Invoice Period      ;Option        ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Faktureringsperiode;
                                                              ENU=Invoice Period];
                                                   OptionCaptionML=[DAN=MÜned,To mÜneder,Kvartal,HalvÜr,èr,Ingen;
    ...
    { 38  ;   ;First Service Date  ;Date          ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Fõrste servicedato;
    ...
    { 40  ;   ;Calcd. Annual Amount;Decimal       ;FieldClass=FlowField;
                                                   ...
                                                   CaptionML=[DAN=Beregnet Ürligt belõb;
    ...
    { 42  ;   ;Annual Amount       ;Decimal       ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=èrligt belõb;
                                                              ENU=Annual Amount];
                                                   MinValue=0;
                                                   BlankZero=Yes;
                                                   AutoFormatType=1 }
    { 43  ;   ;Amount per Period   ;Decimal       ;CaptionML=[DAN=Periodebelõb;
    ...
    { 45  ;   ;Prepaid             ;Boolean       ;OnValidate=VAR
                                                   ...
                                                   CaptionML=[DAN=Forudbetalt;
                                                              ENU=Prepaid] }
    { 46  ;   ;Next Invoice Period ;Text30        ;CaptionML=[DAN=Nëste faktureringsperiode;
    ...
    { 50  ;   ;Cancel Reason Code  ;Code10        ;TableRelation="Reason Code";
                                                   CaptionML=[DAN=AnnulleringsÜrsagskode;
    ...
    { 52  ;   ;Next Price Update Date;Date        ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Dato for nëste prisregulering;
                                                              ENU=Next Price Update Date] }
    { 53  ;   ;Last Price Update % ;Decimal       ;CaptionML=[DAN=Nëste prisreguleringspct.;
    ...
    { 55  ;   ;Response Time (Hours);Decimal      ;OnValidate=BEGIN
                                                   ...
                                                   DecimalPlaces=0:5;
                                                   BlankZero=Yes }
    { 56  ;   ;Contract Lines on Invoice;Boolean  ;CaptionML=[DAN=Kontraktlinjer pÜ faktura;
    ...
    { 57  ;   ;No. of Posted Invoices;Integer     ;FieldClass=FlowField;
                                                   ...
                                                   CaptionML=[DAN=Antal bogfõrte fakturaer;
    ...
    { 58  ;   ;No. of Unposted Invoices;Integer   ;FieldClass=FlowField;
                                                   ...
                                                   CaptionML=[DAN=Antal ikkebogfõrte fakturaer;
    ...
    { 64  ;   ;Allow Unbalanced Amounts;Boolean   ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Tillad belõb, der ikke stemmer;
    ...
    { 68  ;   ;Shortcut Dimension 2 Code;Code20   ;TableRelation="Dimension Value".Code WHERE (Global Dimension No.=CONST(2));
                                                   ...
                                                   CaptionClass='1,2,2' }
    { 69  ;   ;Accept Before       ;Date          ;CaptionML=[DAN=Accept fõr;
                                                              ENU=Accept Before] }
    ...
    { 79  ;   ;Price Inv. Increase Code;Code20    ;TableRelation="Standard Text";
                                                   CaptionML=[DAN=Prisforhõjelseskode;
                                                              ENU=Price Inv. Increase Code] }
    { 80  ;   ;Print Increase Text ;Boolean       ;CaptionML=[DAN=Udskriv prisforhõjelsestekst;
    ...
    { 97  ;   ;Ship-to Name 2      ;Text50        ;FieldClass=FlowField;
                                                   ...
                                                   CaptionML=[DAN=Leveringsnavn 2;
                                                              ENU=Ship-to Name 2];
                                                   Editable=No }
    { 98  ;   ;Next Invoice Period Start;Date     ;CaptionML=[DAN=Nëste fakturaperiodestart;
                                                              ENU=Next Invoice Period Start];
                                                   Editable=No }
    { 99  ;   ;Next Invoice Period End;Date       ;CaptionML=[DAN=Nëste fakt.periodeafslut.;
    ...
    { 100 ;   ;Contract Invoice Amount;Decimal    ;FieldClass=FlowField;
                                                   CalcFormula=-Sum("Service Ledger Entry"."Amount (LCY)" WHERE (Service Contract No.=FIELD(Contract No.),
                                                                                                                 ...
                                                                                                                 Open=CONST(No)));
                                                   CaptionML=[DAN=Kontraktsfakturabelõb;
    ...
    { 101 ;   ;Contract Prepaid Amount;Decimal    ;FieldClass=FlowField;
                                                   CalcFormula=-Sum("Service Ledger Entry"."Amount (LCY)" WHERE (Service Contract No.=FIELD(Contract No.),
                                                                                                                 ...
                                                                                                                 Open=CONST(No),
                                                                                                                 Prepaid=CONST(Yes)));
                                                   CaptionML=[DAN=Forudbetalt kontraktbelõb;
    ...
    { 102 ;   ;Contract Discount Amount;Decimal   ;FieldClass=FlowField;
                                                   CalcFormula=Sum("Service Ledger Entry"."Contract Disc. Amount" WHERE (Service Contract No.=FIELD(Contract No.),
                                                                                                                         ...
                                                                                                                         Posting Date=FIELD(Date Filter),
                                                                                                                         Open=CONST(No)));
                                                   CaptionML=[DAN=Kontraktrabatbelõb;
    ...
    { 103 ;   ;Contract Cost Amount;Decimal       ;FieldClass=FlowField;
                                                   CalcFormula=Sum("Service Ledger Entry"."Cost Amount" WHERE (Service Contract No.=FIELD(Contract No.),
                                                                                                               ...
                                                                                                               Posting Date=FIELD(Date Filter),
                                                                                                               Open=CONST(No)));
                                                   CaptionML=[DAN=Kontraktkostbelõb;
    ...
    { 104 ;   ;Contract Gain/Loss Amount;Decimal  ;FieldClass=FlowField;
                                                   ...
                                                   CaptionML=[DAN=Kontraktgevinst/-tab (belõb);
    ...
    { 106 ;   ;No. of Posted Credit Memos;Integer ;FieldClass=FlowField;
                                                   ...
                                                   CaptionML=[DAN=Antal bogfõrte kreditnotaer;
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Vil du oprette kontrakten ved hjëlp af en kontraktskabelon?;ENU=Do you want to create the contract using a contract template?';
      ...
      Text006@1006 : TextConst 'DAN=Feltet %1 kan kun ëndres til Annulleret.;ENU=The %1 field can only be changed to Canceled.';
      CancelTheContractQst@1007 : TextConst '@@@=%1: Text008;DAN=%1 Det ikke er muligt at ëndre en servicekontrakt til en tidligere status.\\Vil du annullere kontrakten?;ENU=%1 It is not possible to change a service contract to its previous status.\\Do you want to cancel the contract?';
      OpenPrepaymentEntriesExistTxt@1008 : TextConst 'DAN=èbn de forudbetalingsposter, der findes for kontrakten.;ENU=Open prepayment entries exist for the contract.';
      Text009@1009 : TextConst 'DAN=Du kan ikke ëndre feltet %1 til %2, nÜr feltet %3 er %4.;ENU=You cannot change the %1 field to %2 when the %3 field is %4.';
      Text010@1010 : TextConst 'DAN=Vil du annullere %1?;ENU=Do you want to cancel %1?';
      Text011@1011 : TextConst 'DAN=Du kan ikke ëndre feltet %1 manuelt, fordi der er kontraktlinjer til denne debitor.\\;ENU=You cannot change the %1 field manually because there are contract lines for this customer.\\';
      ...
      Text014@1014 : TextConst 'DAN=Skal %1 ëndres?;ENU=Do you want to change %1?';
      Text023@1015 : TextConst 'DAN=%1 kan ikke vëre mindre end %2.;ENU=%1 cannot be less than %2.';
      Text024@1016 : TextConst 'DAN=%1 kan ikke ligge fõr %2.;ENU=The %1 cannot be before the %2.';
      Text026@1017 : TextConst 'DAN=%1 skal vëre den fõrste dag i mÜneden.;ENU=%1 must be the first day in the month.';
      Text027@1018 : TextConst 'DAN=%1 til %2;ENU=%1 to %2';
      Text028@1019 : TextConst 'DAN=%1 skal vëre den sidste dag i mÜneden.;ENU=%1 must be the last day in the month.';
      Text029@1020 : TextConst 'DAN=Du kan ikke ëndre %1, fordi %2 er blevet faktureret.;ENU=You are not allowed to change %1 because the %2 has been invoiced.';
      Text030@1021 : TextConst 'DAN=Du kan ikke ëndre feltet %1 pÜ underskrevne servicekontrakter.;ENU=You cannot change the %1 field on signed service contracts.';
      Text031@1022 : TextConst 'DAN=Du har ëndret feltet %1.\\Kontraktlinjerne bliver ikke opdateret.;ENU=You have changed the %1 field.\\The contract lines will not be updated.';
      Text032@1023 : TextConst 'DAN=Du kan ikke ëndre %1, fordi %2 %3 er blevet faktureret.;ENU=You cannot change %1 because %2 %3 has been invoiced.';
      Text034@1024 : TextConst 'DAN=Nogle kontraktlinjer har en lëngere svartid end feltet %1 pÜ servicekontrakthovedet. Vil du opdatere dem?;ENU=Some of the contract lines have a longer response time than the %1 field on the service contract header. Do you want to update them?';
      ...
      TempDate@1055 : Date;
      Text041@1056 : TextConst 'DAN=%1 kan ikke ëndres til %2, fordi denne %3 er blevet faktureret.;ENU=%1 cannot be changed to %2 because this %3 has been invoiced';
      Text042@1057 : TextConst 'DAN=Belõbene pÜ servicekontrakthovedet og servicekontraktlinjerne er ikke blevet opdateret. Vërdien i feltet %1 angiver den valuta, der anvendes til at beregne belõbene i de salgsdokumenter, der tilhõrer denne kontrakt. Belõbene i servicekontrakten vises kun i RV.;ENU=The amounts on the service contract header and service contract lines have not been updated. The value of the %1 field indicates the currency in which the amounts in the sales documents belonging to this contract are calculated. The amounts on the service contract are presented in LCY only.';
      ...
      Text048@1065 : TextConst 'DAN=Der er knyttet ikkebogfõrte fakturaer til denne kontrakt.\\Vil du annullere kontrakten?;ENU=There are unposted invoices linked to this contract.\\Do you want to cancel the contract?';
      Text049@1066 : TextConst 'DAN=Der er knyttet ikkebogfõrte kreditnotaer til denne kontrakt.\\Vil du annullere kontrakten?;ENU=There are unposted credit memos linked to this contract.\\Do you want to cancel the contract?';
      ...
      Text052@1070 : TextConst 'DAN=Der findes %1 serviceposter til denne servicekontrakt\Vil du fortsëtte?;ENU=%1 service ledger entries exist for this service contract\Would you like to continue?';
      ...
      Text055@1079 : TextConst 'DAN=Der er knyttet ikkebogfõrte fakturaer og kreditnotaer til denne kontrakt.\\Vil du annullere kontrakten?;ENU=There are unposted invoices and credit memos linked to this contract.\\Do you want to cancel the contract?';
      StrToInsert@1078 : Text[250];
      Text056@1080 : TextConst 'DAN=Kontraktudlõbsdatoerne i servicekontraktlinjerne, som ligger senere end %1 pÜ %2, vil blive erstattet med %3.\Vil du fortsëtte?;ENU=The contract expiration dates on the service contract lines that are later than %1 on the %2 will be replaced with %3.\Do you want to continue?';
      Text057@1081 : TextConst 'DAN=Du kan ikke bÜde markere felterne %1 og %2.;ENU=You cannot select both the %1 and the %2 check boxes.';
      ...
      Text059@1082 : TextConst 'DAN=Du kan ikke bruge indstillingen Fordeling baseret pÜ avance, hvis summen af vërdier i feltet Avance i kontraktlinjerne er lig med nul.;ENU=You cannot use the Distribution Based on Profit option if the sum of values in the Profit field on the contract lines equals to zero.';
      Text060@1083 : TextConst 'DAN=Du kan ikke bruge indstillingen Fordeling baseret pÜ linjebelõb, hvis summen af vërdier i feltet Linjebelõb er lig med nul.;ENU=You cannot use the Distribution Based on Line Amount option if the sum of values in the Line Amount field on the contract lines equals to zero.';
      Text061@1084 : TextConst 'DAN=Differencen i det Ürlige belõb er blevet fordelt, og en eller flere kontraktlinjer indeholder vërdien nul eller mindre i felterne %1.\Du kan angive et belõb i feltet %1.;ENU=The annual amount difference has been distributed and one or more contract lines have zero or less in the %1 fields.\You can enter an amount in the %1 field.';
      Text062@1085 : TextConst 'DAN=Der er fõjet linjer med serviceartikler til en eller flere kontrakter,\mens tilbuddet havde %1 %2.\Vil du have vist disse linjer?;ENU=Some lines containing service items have been added to one or more contracts\while the quote had the %1 %2.\Do you want to see these lines?';
      HideValidationDialog@1004 : Boolean;
      Confirmed@1005 : Boolean;
      Text063@1025 : TextConst 'DAN=%1 kan ikke omdõbes.;ENU=You cannot rename a %1.';
      InvPeriodDuration@1100 : DateFormula;
      Text064@1103 : TextConst 'DAN=%1 kan ikke vëre mindre end %2.;ENU=%1 cannot be less than %2.';
      Text065@1104 : TextConst 'DAN=%1 kan ikke vëre stõrre end %2.;ENU=%1 cannot be more than %2.';
