OBJECT Table 5530 Inventory Event Buffer
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Lagerh‘ndelsesbuffer;
               ENU=Inventory Event Buffer];
  }
  FIELDS
  {
    ...
    { 14  ;   ;Availability Date   ;Date          ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Disponibilitetsdato;
                                                              ENU=Availability Date];
                                                   Editable=No }
    { 15  ;   ;Type                ;Option        ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Type;
                                                              ENU=Type];
                                                   OptionCaptionML=[DAN=Lagerbeholdning,K›b,Salg,,,Overf›rsel,Komponent,Producktion,Service,Sag,Forecast,Rammesalgsordre,Plan,Tilbagef›r plan,Montageordre,Montagekomponent;
                                                                    ENU=Inventory,Purchase,Sale,,,Transfer,Component,Production,Service,Job,Forecast,Blanket Sales Order,Plan,Plan Revert,Assembly Order,Assembly Component];
    ...
    { 22  ;   ;Transfer Direction  ;Option        ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Overf›rselsretning;
                                                              ENU=Transfer Direction];
    ...
    { 35  ;   ;Orig. Quantity (Base);Decimal      ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Orig. antal (basis);
                                                              ENU=Orig. Quantity (Base)];
                                                   Editable=No }
    { 37  ;   ;Ref. Order Type     ;Option        ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Referenceordretype;
                                                              ENU=Ref. Order Type];
                                                   OptionCaptionML=[DAN=" ,K›b,Prod.ordre,Montage,Overf›rsel";
                                                                    ENU=" ,Purchase,Prod. Order,Assembly,Transfer"];
                                                   OptionString=[ ,Purchase,Prod. Order,Assembly,Transfer];
                                                   Editable=No }
    { 38  ;   ;Ref. Order Line No. ;Integer       ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Referenceordrelinjenr.;
