OBJECT Table 5301 Outlook Synch. Entity Element
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Element til Outlook-synkroniseringsenhed;
               ENU=Outlook Synch. Entity Element];
    PasteIsValid=No;
  }
  FIELDS
  {
    ...
    { 9   ;   ;No. of Dependencies ;Integer       ;FieldClass=FlowField;
                                                   ...
                                                   CaptionML=[DAN=Antal afh‘ngige poster;
                                                              ENU=No. of Dependencies];
                                                   Editable=No }
  }
  KEYS
  {
  ...
  CODE
  {
    VAR
      ...
      Text001@1005 : TextConst 'DAN=Denne samling kan ikke slettes, fordi den bruges med synkronisering.;ENU=You cannot delete this collection because it is used with synchronization.';
      Text002@1007 : TextConst 'DAN=Outlook-elementsamlingen med dette navn findes ikke.\Klik p† AssistButton for at f† vist en liste over gyldige samlinger for dette Outlook-element.;ENU=The Outlook item collection with this name does not exist.\Click the AssistButton to see a list of valid collections for this Outlook item.';
      Text003@1004 : TextConst 'DAN=Hvis du ‘ndrer v‘rdien i dette felt, slettes recorderne %1, %2 og %3, som har relation til denne samling.\Vil du ‘ndre den alligevel?;ENU=If you change the value in this field, the %1, %2, and %3 records related to this collection will be deleted.\Do you want to change it anyway?';
      Text004@1006 : TextConst 'DAN=Denne samling kan ikke ‘ndres, fordi den bruges med synkronisering for brugeren %1.;ENU=You cannot change this collection because it is used with synchronization for user %1.';
      Text005@1008 : TextConst 'DAN="Der findes allerede en Outlook-elementsamling med dette navn.\Identifikationsfelter og v‘rdier:\%1=''''%2'''',%3=''''%4''''.";ENU="An Outlook item collection with this name already exists.\Identification fields and values:\%1=''''%2'''',%3=''''%4''''."';
