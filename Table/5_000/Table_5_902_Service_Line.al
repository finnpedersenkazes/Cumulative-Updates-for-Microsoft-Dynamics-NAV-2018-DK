OBJECT Table 5902 Service Line
{
  ...
  FIELDS
  {
    ...
    { 92  ;   ;Outstanding Amount (LCY);Decimal   ;CaptionML=[DAN=UdestÜende belõb (RV);
                                                   ...
                                                   Editable=No;
                                                   AutoFormatType=1 }
    { 93  ;   ;Shipped Not Invoiced (LCY);Decimal ;CaptionML=[DAN=Lev. belõb ufakt. (RV);
    ...
    { 1032;   ;Job Remaining Total Cost;Decimal   ;AccessByPermission=TableData 167=R;
                                                   CaptionML=[DAN=Rest. jobantal (kostbelõb);
    ...
    { 5903;   ;Appl.-to Service Entry;Integer     ;AccessByPermission=TableData 27=R;
                                                   CaptionML=[DAN=Udl.servicepostlõbenr.;
    ...
    { 5907;   ;Serv. Price Adjmt. Gr. Code;Code10 ;TableRelation="Service Price Adjustment Group";
                                                   ...
                                                   Editable=No }
    { 5908;   ;Posting Date        ;Date          ;CaptionML=[DAN=Bogfõringsdato;
                                                              ENU=Posting Date] }
    ...
    { 5938;   ;Contract Disc. %    ;Decimal       ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Rabatpct. ifõlge kontrakt;
                                                              ENU=Contract Disc. %];
                                                   DecimalPlaces=0:5;
                                                   MinValue=0;
                                                   MaxValue=100;
    ...
    { 5997;   ;Line Discount Type  ;Option        ;CaptionML=[DAN=Linjerabattype;
                                                   ...
                                                   Editable=No }
    { 5999;   ;Copy Components From;Option        ;CaptionML=[DAN=KopiÇr komponenter fra;
  ...
  {
    VAR
      Text000@1085 : TextConst 'DAN=Du kan hõjst fakturere %1 enheder.;ENU=You cannot invoice more than %1 units.';
      Text001@1084 : TextConst 'DAN=Du kan hõjst fakturere %1 basisenheder.;ENU=You cannot invoice more than %1 base units.';
      Text002@1002 : TextConst 'DAN=%1 kan ikke omdõbes.;ENU=You cannot rename a %1.';
      Text003@1086 : TextConst 'DAN=mÜ ikke vëre mindre end %1;ENU=must not be less than %1';
      Text004@1004 : TextConst 'DAN=Du skal bekrëfte %1 %2, fordi %3 ikke er lig med %4 i %5 %6.;ENU=You must confirm %1 %2, because %3 is not equal to %4 in %5 %6.';
      Text005@1005 : TextConst 'DAN=Opdateringen er afbrudt pÜ grund af advarslen.;ENU=The update has been interrupted to respect the warning.';
      Text006@1006 : TextConst 'DAN=Udskift komponent,Ny komponent,Ignorer;ENU=Replace Component,New Component,Ignore';
      Text007@1007 : TextConst 'DAN=Du skal vëlge en %1.;ENU=You must select a %1.';
      Text008@1008 : TextConst 'DAN=Du kan ikke ëndre vërdien af feltet %1, fordi feltet %2 i vinduet FejlÜrsagskoder indeholder en markering for %3 %4.;ENU=You cannot change the value of the %1 field because the %2 field in the Fault Reason Codes window contains a check mark for the %3 %4.';
      Text009@1009 : TextConst 'DAN=Du har ëndre vërdien i feltet %1.\Vil du fortsëtte?;ENU=You have changed the value of the field %1.\Do you want to continue ?';
      Text010@1010 : TextConst 'DAN=%1 kan ikke vëre mindre end %2.;ENU=%1 cannot be less than %2.';
      Text011@1011 : TextConst 'DAN=NÜr du udskifter en %1, skal antallet vëre 1.;ENU=When replacing a %1 the quantity must be 1.';
      ...
      Text013@1013 : TextConst 'DAN=" skal vëre 0, nÜr %1 er %2.";ENU=" must be 0 when %1 is %2."';
      Text015@1015 : TextConst 'DAN=Du har allerede valgt %1 %2 til udskiftning.;ENU=You have already selected %1 %2 for replacement.';
      Text016@1083 : TextConst 'DAN=Du kan hõjst levere %1 enheder.;ENU=You cannot ship more than %1 units.';
      Text017@1082 : TextConst 'DAN=Du kan hõjst levere %1 basisenheder.;ENU=You cannot ship more than %1 base units.';
      Text018@1018 : TextConst 'DAN=%1 %2 er stõrre end %3 og blev rettet til %4.;ENU=%1 %2 is greater than %3 and was adjusted to %4.';
      ...
      Text022@1019 : TextConst 'DAN=%1 kan ikke vëre stõrre end %2, der er angivet pÜ %3.;ENU=The %1 cannot be greater than the %2 set on the %3.';
      ...
      Text026@1068 : TextConst 'DAN=NÜr du udskifter eller opretter en serviceartikelkomponent, kan du kun angive et helt tal i feltet %1.;ENU=When replacing or creating a service item component you may only enter a whole number into the %1 field.';
      Text027@1070 : TextConst 'DAN=Den %1 %2, der har en markering i feltet %3, kan ikke bogfõres,  hvis servicelinjetypen ikke er Vare eller Ressource.;ENU=The %1 %2 with a check mark in the %3 field cannot be entered if the service line type is other than Item or Resource.';
      Text028@1014 : TextConst 'DAN=Du kan ikke forbruge mere end %1 enheder.;ENU=You cannot consume more than %1 units.';
      Text029@1098 : TextConst 'DAN=skal vëre positiv;ENU=must be positive';
      Text030@1094 : TextConst 'DAN=skal vëre negativ;ENU=must be negative';
      ...
      Text033@1001 : TextConst 'DAN=Den linje, du forsõger at redigere, har den justerede pris.\;ENU=The line you are trying to change has the adjusted price.\';
      Text034@1000 : TextConst 'DAN=Vil du fortsëtte?;ENU=Do you want to continue?';
      Text035@1076 : TextConst 'DAN=Lagersted;ENU=Warehouse';
      Text036@1102 : TextConst 'DAN=Lager;ENU=Inventory';
      Text037@1092 : TextConst 'DAN=Du kan ikke ëndre %1, nÜr %2 er %3, og %4 er positiv.;ENU=You cannot change %1 when %2 is %3 and %4 is positive.';
      Text038@1088 : TextConst 'DAN=Du kan ikke ëndre %1, nÜr %2 er %3, og %4 er negativ.;ENU=You cannot change %1 when %2 is %3 and %4 is negative.';
      ...
      Text042@1072 : TextConst 'DAN=NÜr du bogfõrer udligningsposten, Übnes %1 fõrst;ENU=When posting the Applied to Ledger Entry %1 will be opened first';
      HideCostWarning@1003 : Boolean;
      HideWarrantyWarning@1096 : Boolean;
      Text043@1097 : TextConst 'DAN=Du kan ikke ëndre vërdien i feltet %1 manuelt, hvis %2 for denne linje er %3.;ENU=You cannot change the value of the %1 field manually if %2 for this line is %3.';
      Text044@1012 : TextConst 'DAN=Vil du opdele ressourcelinjen og bruge den til at oprette ressourcelinjer\til de andre serviceartikler med delte belõb?;ENU=Do you want to split the resource line and use it to create resource lines\for the other service items with divided amounts?';
      ...
      Text046@1067 : TextConst 'DAN=%1 kan ikke ëndres, nÜr %2 er udfyldt.;ENU=You cannot change the %1 when the %2 has been filled in.';
      Text047@1100 : TextConst 'DAN=%1 kan kun angives, nÜr %2 er angivet.;ENU=%1 can only be set when %2 is set.';
      Text048@1101 : TextConst 'DAN=%1 kan ikke ëndres, nÜr %2 er angivet.;ENU=%1 cannot be changed when %2 is set.';
      Text049@1103 : TextConst '@@@=Example: Inventory put-away is required for Line 50000.;DAN="%1 krëves til %2 = %3.";ENU="%1 is required for %2 = %3."';
      ...
      Text051@1107 : TextConst 'DAN=Du kan ikke tilfõje en varelinje.;ENU=You cannot add an item line.';
      ...
      Text053@1020 : TextConst 'DAN=Du kan ikke ëndre denne servicelinje, da der findes en eller flere serviceposter for denne linje.;ENU=You cannot modify the service line because one or more service entries exist for this line.';
      IsCustCrLimitChecked@1049 : Boolean;
      LocationChangedMsg@1055 : TextConst '@@@="%1 = Item No., %2 = Item serial No., %3 = Location code";DAN=Varen %1 med serienummeret %2 opbevares pÜ placeringen %3. Feltet Lokationskode pÜ servicelinjen vil blive opdateret.;ENU=Item %1 with serial number %2 is stored on location %3. The Location Code field on the service line will be updated.';
      LineDiscountPctErr@1022 : TextConst 'DAN=Vërdien i feltet Linjerabat % skal vëre mellem 0 og 100.;ENU=The value in the Line Discount % field must be between 0 and 100.';
