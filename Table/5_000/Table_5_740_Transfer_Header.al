OBJECT Table 5740 Transfer Header
{
  ...
  FIELDS
  {
    ...
    { 10  ;   ;Trsf.-from Country/Region Code;Code10;
                                                   ...
                                                   CaptionML=[DAN=Lande-/omrÜdekode, der overflyttes fra;
    ...
    { 19  ;   ;Trsf.-to Country/Region Code;Code10;TableRelation=Country/Region;
                                                   CaptionML=[DAN=Lande-/omrÜdekode, der overflyttes til;
    ...
    { 70  ;   ;Direct Transfer     ;Boolean       ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Direkte overfõrsel;
                                                              ENU=Direct Transfer] }
    ...
    { 5751;   ;Posting from Whse. Ref.;Integer    ;CaptionML=[DAN=Bogfõring fra lagerref.;
  ...
  CODE
  {
    VAR
      ...
      Text001@1001 : TextConst 'DAN=%1 og %2 kan ikke vëre det samme i %3 %4.;ENU=%1 and %2 cannot be the same in %3 %4.';
      Text002@1002 : TextConst 'DAN=Skal %1 ëndres?;ENU=Do you want to change %1?';
      TransferOrderPostedMsg1@1003 : TextConst '@@@="%1 = transfer order number e.g. Transfer order 1003 was successfully posted and is now deleted ";DAN=Overfõrselsordren %1 blev bogfõrt korrekt og er nu slettet.;ENU=Transfer order %1 was successfully posted and is now deleted.';
      ...
      UpdateTransferFromCodeQst@1018 : TextConst 'DAN=Hvis du ëndrer den lokation, der overflyttes fra, slettes overfõrselslinjerne.\\Vil du fortsëtte?;ENU=If you change the transfer-from location, the transfer order lines will be deleted.\\Do you want to continue?';
      Text007@1014 : TextConst 'DAN=Du har muligvis ëndret en dimension.\\Vil du opdatere linjerne?;ENU=You may have changed a dimension.\\Do you want to update the lines?';
