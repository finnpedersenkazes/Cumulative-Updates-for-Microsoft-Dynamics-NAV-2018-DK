OBJECT Table 5895 Inventory Adjustment Buffer
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Lagerreguleringsbuffer;
               ENU=Inventory Adjustment Buffer];
  }
  FIELDS
  {
