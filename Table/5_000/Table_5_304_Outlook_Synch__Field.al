OBJECT Table 5304 Outlook Synch. Field
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Outlook-synkroniseringsfelt;
  ...
  FIELDS
  {
    ...
    { 6   ;   ;Outlook Property    ;Text80        ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Outlook-egenskab;
    ...
    { 7   ;   ;User-Defined        ;Boolean       ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Brugerdefineret;
                                                              ENU=User-Defined] }
    { 8   ;   ;Search Field        ;Boolean       ;CaptionML=[DAN=S›gefelt;
                                                              ENU=Search Field] }
    { 9   ;   ;Condition           ;Text250       ;CaptionML=[DAN=Betingelse;
                                                              ENU=Condition];
                                                   Editable=No }
    ...
    { 15  ;   ;Read-Only Status    ;Option        ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Skrivebeskyttelsesstatus;
                                                              ENU=Read-Only Status];
                                                   OptionCaptionML=[DAN=" ,Skrivebeskyttet i Microsoft Dynamics NAV,Skrivebeskyttet i Outlook";
    ...
    { 16  ;   ;Field Default Value ;Text250       ;OnValidate=VAR
                                                   ...
                                                   CaptionML=[DAN=Standardfeltv‘rdi;
                                                              ENU=Field Default Value] }
    { 17  ;   ;Record GUID         ;GUID          ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Record-GUID;
                                                              ENU=Record GUID];
                                                   Editable=No }
    { 99  ;   ;DefaultValueExpression;Text250     ;CaptionML=[DAN=DefaultValueExpression;
                                                              ENU=DefaultValueExpression] }
  }
  KEYS
  {
  ...
  CODE
  {
    VAR
      ...
      Text001@1015 : TextConst 'DAN=Du kan ikke v‘lge fra en liste over Outlook-elementsamlinger for brugerdefinerede felter.;ENU=You cannot choose from a list of Outlook item collections for user-defined fields.';
      Text002@1012 : TextConst 'DAN=Du kan ikke bruge et %1-felt til synkronisering.;ENU=You cannot use a %1 field for synchronization.';
      Text003@1011 : TextConst 'DAN=V‘rdien i feltet %1 kan ikke konverteres til datatypen %2.;ENU=The value of the %1 field cannot be converted to the %2 datatype.';
      Text004@1010 : TextConst 'DAN=V‘rdien i feltet %1 kan ikke konverteres til datatypen %2..\De mulige indstillingsv‘rdier er: ''%3''.;ENU=The value of the %1 field cannot be converted to the %2 datatype.\The possible option values are: ''%3''.';
      Text005@1009 : TextConst 'DAN=Feltet %1 skal v‘re tomt, n†r feltet %2 anvendes.;ENU=The %1 field should be blank when the %2 field is used.';
      Text006@1006 : TextConst 'DAN=Dette er ikke et gyldigt navn til en Outlook-egenskab.;ENU=This is not a valid Outlook property name.';
      Text007@1005 : TextConst 'DAN=Felterne %1 og %2 kan ikke synkroniseres, fordi de begge er skrivebeskyttede.;ENU=You cannot synchronize the %1 and the %2 fields because they are both write protected.';
      Text008@1016 : TextConst 'DAN=Hvis du ‘ndrer v‘rdien i dette felt, fjernes recorderne %1 og %2, som har relation til denne post.\Vil du ‘ndre i feltet alligevel?;ENU=If you change the value of this field, %1 and %2 records related to this entry will be removed.\Do you want to change this field anyway?';
      Text009@1018 : TextConst 'DAN=Feltet %1 kan ikke ‘ndres, hvis %2 ikke er angivet for denne enhed.;ENU=You cannot change the %1 field if the %2 is not specified for this entity.';
      Text010@1020 : TextConst '@@@=%1: Field.Class::FlowField;DAN=Dette felt kan ikke anvendes til felter for %1.;ENU=You cannot use this field for %1 fields.';
      Text011@1007 : TextConst 'DAN=Tabellen %1 kan ikke †bnes, fordi felterne %2 eller %3 er tomme.\Udfyld disse felter med de korrekte v‘rdier, og fors›g igen.;ENU=The %1 table cannot be open, because the %2 or %3 fields are empty.\Fill in these fields with the appropriate values and try again.';
