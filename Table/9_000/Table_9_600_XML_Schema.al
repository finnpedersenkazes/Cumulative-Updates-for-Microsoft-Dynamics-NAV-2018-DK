OBJECT Table 9600 XML Schema
{
  ...
  FIELDS
  {
    ...
    { 2   ;   ;Description         ;Text80        ;CaptionML=[DAN=Beskrivelse;
                                                              ENU=Description] }
    { 3   ;   ;Target Namespace    ;Text250       ;CaptionML=[DAN=M†lnavneomr†de;
                                                              ENU=Target Namespace] }
    { 4   ;   ;XSD                 ;BLOB          ;CaptionML=[DAN=XSD;
                                                              ENU=XSD] }
    { 6   ;   ;Indentation         ;Integer       ;CaptionML=[DAN=Indrykning;
                                                              ENU=Indentation] }
    { 7   ;   ;Path                ;Text250       ;CaptionML=[DAN=Sti;
                                                              ENU=Path] }
    { 10  ;   ;Target Namespace Aliases;Text250   ;CaptionML=[DAN=M†lnavneomr†dealiasser;
                                                              ENU=Target Namespace Aliases] }
  }
  KEYS
  {
    {    ;Code                                    ;Clustered=Yes }
  ...
  {
    VAR
      ReplaceQst@1000 : TextConst 'DAN=Vil du erstatte den eksisterende definition?;ENU=Do you want to replace the existing definition?';
