OBJECT Table 9186 Generic Chart Memo Buffer
{
  ...
  {
    VAR
      TextMemoToBeTruncatedMsg@1000 : TextConst 'DAN=L‘ngden p† den indtastede tekst er %1. Maksimuml‘ngden er %2. Teksten er blevet afkortet til denne l‘ngde.;ENU=The length of the text that you entered is %1. The maximum length is %2. The text has been truncated to this length.';
