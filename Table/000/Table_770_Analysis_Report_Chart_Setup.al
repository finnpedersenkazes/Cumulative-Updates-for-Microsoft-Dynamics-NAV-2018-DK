OBJECT Table 770 Analysis Report Chart Setup
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Konfiguration af analyserapportdiagram;
               ENU=Analysis Report Chart Setup];
  ...
  FIELDS
  {
    ...
    { 2   ;   ;Name                ;Text30        ;CaptionML=[DAN=Navn;
                                                              ENU=Name] }
    { 10  ;   ;Analysis Area       ;Option        ;CaptionML=[DAN=AnalyseomrÜde;
                                                              ENU=Analysis Area];
    ...
    { 30  ;   ;Base X-Axis on      ;Option        ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=BasÇr x-akse pÜ;
                                                              ENU=Base X-Axis on];
                                                   OptionCaptionML=[DAN=Periode,Linje,Kolonne;
                                                                    ENU=Period,Line,Column];
    ...
    { 32  ;   ;End Date            ;Date          ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Slutdato;
                                                              ENU=End Date] }
    { 41  ;   ;Period Length       ;Option        ;CaptionML=[DAN=Periodelëngde;
                                                              ENU=Period Length];
  ...
  {
    VAR
      Text001@1000 : TextConst '@@@="%1=Analysis Line_Description %2=Analysis Column_Coulmn Header";DAN=%1 %2;ENU=%1 %2';
      Text002@1001 : TextConst 'DAN=Du kan ikke angive %1 til %2.;ENU=You cannot set %1 to %2.';
