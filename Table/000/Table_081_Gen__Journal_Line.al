OBJECT Table 81 Gen. Journal Line
{
  ...
  CODE
  {
    VAR
      ...
      SalespersonPurchPrivacyBlockErr@1933 : TextConst '@@@="%1 = salesperson / purchaser code.";DAN=Beskyttelse af personlige oplysninger spërret mÜ ikke vëre gëldende for sëlgeren/indkõberen %1.;ENU=Privacy Blocked must not be true for Salesperson / Purchaser %1.';
      BlockedErr@1033 : TextConst '@@@="%1=Blocked field value,%2=Account Type,%3=Account No.";DAN=Feltet Blokeret mÜ ikke vëre %1 for %2 %3.;ENU=The Blocked field must not be %1 for %2 %3.';
      BlockedEmplErr@1032 : TextConst '@@@="%1 = Employee no. ";DAN=Du kan ikke eksportere filen, fordi medarbejderen %1 er blokeret pÜ grund af beskyttelse af personlige oplysninger.;ENU=You cannot export file because employee %1 is blocked due to privacy.';
