OBJECT Table 210 Job Journal Line
{
  ...
  FIELDS
  {
    ...
    { 10  ;   ;Quantity            ;Decimal       ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Antal;
                                                              ENU=Quantity];
                                                   DecimalPlaces=0:5 }
    { 12  ;   ;Direct Unit Cost (LCY);Decimal     ;CaptionML=[DAN=Kõbspris (RV);
    ...
    { 13  ;   ;Unit Cost (LCY)     ;Decimal       ;OnValidate=BEGIN
                                                   ...
                                                   Editable=No;
                                                   AutoFormatType=2 }
    { 14  ;   ;Total Cost (LCY)    ;Decimal       ;CaptionML=[DAN=Kostbelõb (RV);
                                                              ENU=Total Cost (LCY)];
                                                   Editable=No;
                                                   AutoFormatType=1 }
    { 15  ;   ;Unit Price (LCY)    ;Decimal       ;OnValidate=BEGIN
                                                   ...
                                                   Editable=No;
                                                   AutoFormatType=2 }
    { 16  ;   ;Total Price (LCY)   ;Decimal       ;CaptionML=[DAN=Salgsbelõb (RV);
                                                              ENU=Total Price (LCY)];
                                                   Editable=No;
                                                   AutoFormatType=1 }
    ...
    { 75  ;   ;Recurring Method    ;Option        ;CaptionML=[DAN=Gentagelsesprincip;
                                                   ...
                                                   BlankZero=Yes }
    { 76  ;   ;Expiration Date     ;Date          ;CaptionML=[DAN=Udlõbsdato;
                                                              ENU=Expiration Date] }
    ...
    { 93  ;   ;Source Currency Code;Code10        ;TableRelation=Currency;
                                                   ...
                                                   Editable=No }
    { 94  ;   ;Source Currency Total Cost;Decimal ;CaptionML=[DAN=Kildevaluta (kostbelõb);
                                                              ENU=Source Currency Total Cost];
                                                   Editable=No;
                                                   AutoFormatType=1 }
    { 95  ;   ;Source Currency Total Price;Decimal;CaptionML=[DAN=Kildevaluta (salgsbelõb);
                                                              ENU=Source Currency Total Price];
                                                   Editable=No;
                                                   AutoFormatType=1 }
    { 96  ;   ;Source Currency Line Amount;Decimal;CaptionML=[DAN=Linjebelõb i kildevaluta;
    ...
    { 1000;   ;Job Task No.        ;Code20        ;TableRelation="Job Task"."Job Task No." WHERE (Job No.=FIELD(Job No.));
                                                   ...
                                                   CaptionML=[DAN=Sagsopgavenr.;
                                                              ENU=Job Task No.] }
    { 1001;   ;Total Cost          ;Decimal       ;CaptionML=[DAN=Kostbelõb;
                                                              ENU=Total Cost];
                                                   Editable=No;
                                                   AutoFormatType=1;
    ...
    { 1004;   ;Applies-from Entry  ;Integer       ;OnValidate=VAR
                                                   ...
                                                   MinValue=0 }
    { 1005;   ;Job Posting Only    ;Boolean       ;CaptionML=[DAN=Kun sagsbogfõring;
    ...
    { 1013;   ;Line Discount Amount (LCY);Decimal ;OnValidate=BEGIN
                                                   ...
                                                   Editable=No;
                                                   AutoFormatType=1 }
    { 1014;   ;Total Price         ;Decimal       ;CaptionML=[DAN=Salgsbelõb;
                                                              ENU=Total Price];
                                                   Editable=No;
                                                   AutoFormatType=1;
                                                   AutoFormatExpr="Currency Code" }
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Du kan ikke ëndre %1, nÜr %2 er %3.;ENU=You cannot change %1 when %2 is %3.';
      ...
      Text001@1060 : TextConst 'DAN=mÜ ikke indtastes uden %1;ENU=cannot be specified without %1';
      Text002@1033 : TextConst 'DAN=skal vëre positiv;ENU=must be positive';
      Text003@1038 : TextConst 'DAN=skal vëre negativ;ENU=must be negative';
