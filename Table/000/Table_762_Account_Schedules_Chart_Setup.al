OBJECT Table 762 Account Schedules Chart Setup
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Konfiguration af kontoskemadiagram;
               ENU=Account Schedules Chart Setup];
  ...
  FIELDS
  {
    ...
    { 30  ;   ;Base X-Axis on      ;Option        ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=BasÇr x-akse pÜ;
                                                              ENU=Base X-Axis on];
                                                   OptionCaptionML=[DAN=Periode,Kontoskemalinje,Kontoskemakolonne;
                                                                    ENU=Period,Acc. Sched. Line,Acc. Sched. Column];
    ...
    { 50  ;   ;Last Viewed         ;Boolean       ;OnValidate=VAR
                                                   ...
                                                   CaptionML=[DAN=Sidst set;
                                                              ENU=Last Viewed];
                                                   Editable=No }
    { 51  ;   ;Look Ahead          ;Boolean       ;CaptionML=[DAN=Kig fremad;
                                                              ENU=Look Ahead] }
  }
  KEYS
  {
  ...
  {
    VAR
      Text001@1001 : TextConst '@@@="%1=Account Schdule Line_Description %2=Column Layout_Coulmn Header";DAN=%1 %2;ENU=%1 %2';
      Text002@1000 : TextConst 'DAN=Du kan ikke angive %1 til %2.;ENU=You cannot set %1 to %2.';
