OBJECT Table 38 Purchase Header
{
  ...
  CODE
  {
    VAR
      ...
      DontShowAgainFunctionTok@1104 : TextConst 'DAN=SkjulKõbsnotificationForAktuelBruger;ENU=HidePurchaseNotificationForCurrentUser';
      UpdateAddressWithBuyFromAddressFunctionTok@1105 : TextConst 'DAN=KopiÇrLeverandõradressefelterFraSalgsbilag;ENU=CopyBuyFromVendorAddressFieldsFromSalesDocument';
      UpdateAddressWithPayToAddressTok@1100 : TextConst 'DAN=KopiÇrFaktureringsleverandõradressefelterFraSalgsbilag;ENU=CopyPayToVendorAddressFieldsFromSalesDocument';
