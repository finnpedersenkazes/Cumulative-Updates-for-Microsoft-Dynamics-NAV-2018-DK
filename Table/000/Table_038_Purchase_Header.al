OBJECT Table 38 Purchase Header
{
  ...
  CODE
  {
    VAR
      ...
      RecreatePurchLinesMsg@1016 : TextConst '@@@=%1: FieldCaption;DAN=Hvis du ëndrer %1, slettes de eksisterende kõbslinjer, og der oprettes nye kõbslinjer pÜ baggrund af de nye oplysninger i hovedet.\\Vil du fortsëtte?;ENU=If you change %1, the existing purchase lines will be deleted and new purchase lines based on the new information in the header will be created.\\Do you want to continue?';
      ResetItemChargeAssignMsg@1081 : TextConst '@@@=%1: FieldCaption;DAN=Hvis du ëndrer %1, slettes de eksisterende kõbslinjer, og der oprettes nye kõbslinjer pÜ baggrund af de nye oplysninger i hovedet.\Belõbet for tildeling af varegebyr nulstilles til 0.\\Vil du fortsëtte?;ENU=If you change %1, the existing purchase lines will be deleted and new purchase lines based on the new information in the header will be created.\The amount of the item charge assignment will be reset to 0.\\Do you want to continue?';
