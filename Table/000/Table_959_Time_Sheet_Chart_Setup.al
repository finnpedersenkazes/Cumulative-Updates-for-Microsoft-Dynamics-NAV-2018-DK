OBJECT Table 959 Time Sheet Chart Setup
{
  ...
  FIELDS
  {
    ...
    { 3   ;   ;Show by             ;Option        ;CaptionML=[DAN=Vis efter;
                                                              ENU=Show by];
                                                   OptionCaptionML=[DAN=Status,Type,Bogfõrt;
                                                                    ENU=Status,Type,Posted];
                                                   OptionString=Status,Type,Posted }
    { 4   ;   ;Measure Type        ;Option        ;CaptionML=[DAN=MÜletype;
                                                              ENU=Measure Type];
                                                   OptionCaptionML=[DAN=èben,Sendt,Afvist,Godkendt,Planlagt,Bogfõrt,Ikke bogfõrt,Ressource,Sag,Service,Fravër,Montageordre;
