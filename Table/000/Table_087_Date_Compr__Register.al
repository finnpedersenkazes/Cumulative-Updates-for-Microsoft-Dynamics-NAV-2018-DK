OBJECT Table 87 Date Compr. Register
{
  ...
  FIELDS
  {
    ...
    { 8   ;   ;User ID             ;Code50        ;TableRelation=User."User Name";
                                                   ...
                                                   CaptionML=[DAN=Bruger-id;
                                                              ENU=User ID] }
    { 9   ;   ;Filter              ;Text250       ;CaptionML=[DAN=Filter;
                                                              ENU=Filter] }
  ...
  CODE
  {
    VAR
      ...
      Text001@1000 : TextConst 'DAN=Transaktionen kan ikke tilbagefõres, fordi %1 er blevet komprimeret.;ENU=The transaction cannot be reversed, because the %1 has been compressed.';
