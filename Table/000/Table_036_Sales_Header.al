OBJECT Table 36 Sales Header
{
  ...
  CODE
  {
    VAR
      ...
      RecreateSalesLinesMsg@1015 : TextConst '@@@=%1: FieldCaption;DAN=Hvis du ëndrer %1, slettes de eksisterende salgslinjer, og der oprettes nye salgslinjer pÜ baggrund af de nye oplysninger i hovedet.\\Vil du fortsëtte?;ENU=If you change %1, the existing sales lines will be deleted and new sales lines based on the new information on the header will be created.\\Do you want to continue?';
      ResetItemChargeAssignMsg@1075 : TextConst '@@@=%1: FieldCaption;DAN=Hvis du ëndrer %1, slettes de eksisterende salgslinjer, og der oprettes nye salgslinjer pÜ baggrund af de nye oplysninger i hovedet.\Belõbet for tildeling af varegebyr nulstilles til 0.\\Vil du fortsëtte?;ENU=If you change %1, the existing sales lines will be deleted and new sales lines based on the new information on the header will be created.\The amount of the item charge assignment will be reset to 0.\\Do you want to continue?';
