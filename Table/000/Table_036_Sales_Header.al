OBJECT Table 36 Sales Header
{
  ...
  CODE
  {
    VAR
      ...
      UpdateAddressWithSellToAddressFunctionTok@1079 : TextConst 'DAN=KopiÇrKundeadressefelterFraSalgsbilag;ENU=CopySellToCustomerAddressFieldsFromSalesDocument';
      UpdateAddressWithBilltoAddressTok@1080 : TextConst 'DAN=KopiÇrFaktureresTilKundeadressefelterFraSalgsbilag;ENU=CopyBillToCustomerAddressFieldsFromSalesDocument';
