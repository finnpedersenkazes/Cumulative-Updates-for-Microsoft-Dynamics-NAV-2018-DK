OBJECT Table 334 Column Layout
{
  ...
  FIELDS
  {
    ...
    { 5   ;   ;Column Type         ;Option        ;InitValue=Net Change;
                                                   CaptionML=[DAN=Kolonnetype;
                                                              ENU=Column Type];
                                                   OptionCaptionML=[DAN=Formel,Bevëgelse,Saldo til dato,Startsaldo,RegnskabsÜr-til-dato,Rest. regnskabsÜr,Hele regnskabsÜret;
    ...
    { 7   ;   ;Amount Type         ;Option        ;CaptionML=[DAN=Belõbstype;
                                                              ENU=Amount Type];
                                                   OptionCaptionML=[DAN=Nettobelõb,Debetbelõb,Kreditbelõb;
  ...
  CODE
  {
    VAR
      ...
      Text003@1001 : TextConst '@@@=Fiscal year;DAN=Rè;ENU=FY';
      ...
      Text010@1010 : TextConst 'DAN=,, Sammentëlling;ENU=,, Totaling';
      Text011@1009 : TextConst 'DAN=1,5,,Dimension 1-sammentëlling;ENU=1,5,,Dimension 1 Totaling';
      Text012@1008 : TextConst 'DAN=1,5,,Dimension 2-sammentëlling;ENU=1,5,,Dimension 2 Totaling';
      Text013@1007 : TextConst 'DAN=1,5,,Dimension 3-sammentëlling;ENU=1,5,,Dimension 3 Totaling';
      Text014@1006 : TextConst 'DAN=1,5,,Dimension 4-sammentëlling;ENU=1,5,,Dimension 4 Totaling';
