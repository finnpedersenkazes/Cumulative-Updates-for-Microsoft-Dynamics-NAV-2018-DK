OBJECT Table 485 Business Chart Buffer
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Virksomhedsdiagrambuffer;
               ENU=Business Chart Buffer];
  }
  FIELDS
  {
    ...
    { 2   ;   ;Chart Type          ;Option        ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Diagramtype;
                                                              ENU=Chart Type];
                                                   OptionCaptionML=[DAN=Punkt,,Boble,Linje,,Trinlinje,,,,,Sõjlediagram,StabletSõjlediagram,StabletSõjlediagram100,OmrÜdediagram,,StabletOmrÜdediagram,StabletOmrÜdediagram100,Cirkeldiagram,Kransediagram,,,Interval,,,,Radar,,,,,,,,Tragt;
                                                                    ENU=Point,,Bubble,Line,,StepLine,,,,,Column,StackedColumn,StackedColumn100,Area,,StackedArea,StackedArea100,Pie,Doughnut,,,Range,,,,Radar,,,,,,,,Funnel];
    ...
    { 3   ;   ;Data Type           ;Option        ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Datatype;
                                                              ENU=Data Type];
                                                   OptionCaptionML=[DAN=Streng,Heltal,Decimal,DatoKlokkeslët;
                                                                    ENU=String,Integer,Decimal,DateTime];
    ...
    { 5   ;   ;Drill-Down X Index  ;Integer       ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Detailudledning x-indeks;
                                                              ENU=Drill-Down X Index] }
    { 6   ;   ;Drill-Down Y Value  ;Decimal       ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Detailudledning y-vërdi;
                                                              ENU=Drill-Down Y Value] }
    { 7   ;   ;Drill-Down Measure Index;Integer   ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Detailudledning mÜlindeks;
                                                              ENU=Drill-Down Measure Index] }
    ...
    { 9   ;   ;Period Filter Start Date;Date      ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Startdato for periodefilter;
                                                              ENU=Period Filter Start Date] }
    { 10  ;   ;Period Filter End Date;Date        ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Slutdato for periodefilter;
                                                              ENU=Period Filter End Date] }
  }
  KEYS
  {
    {    ;ID                                      ;Clustered=Yes }
  ...
  CODE
  {
    VAR
      ...
      Text001@1002 : TextConst 'DAN=Datatypen skal vëre Heltal eller Decimal til mÜling af %1.;ENU=Data Type must be Integer or Decimal for Measure %1.';
      Text002@1007 : TextConst 'DAN=Du kan ikke indsëtte i tabellen %1.;ENU=You cannot insert into table %1.';
      Text003@1005 : TextConst 'DAN=Du kan ikke tilfõje flere end %1 mÜl.;ENU=You cannot add more than %1 measures.';
