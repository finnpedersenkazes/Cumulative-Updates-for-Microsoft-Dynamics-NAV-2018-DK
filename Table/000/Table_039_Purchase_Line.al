OBJECT Table 39 Purchase Line
{
  ...
  CODE
  {
    VAR
      ...
      LineDiscountPctErr@1036 : TextConst 'DAN=Vërdien i feltet Linjerabat % skal vëre mellem 0 og 100.;ENU=The value in the Line Discount % field must be between 0 and 100.';
