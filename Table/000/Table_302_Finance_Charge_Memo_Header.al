OBJECT Table 302 Finance Charge Memo Header
{
  ...
  CODE
  {
    VAR
      ...
      Text001@1001 : TextConst 'DAN=ùnsker du at udskrive rentenota %1?;ENU=Do you want to print finance charge memo %1?';
      Text002@1002 : TextConst 'DAN=índringen sletter linjerne i denne rentenota.\\;ENU=This change will cause the existing lines to be deleted for this finance charge memo.\\';
      ...
      Text005@1005 : TextConst 'DAN=Hvis du sletter dette dokument, opstÜr der et hul i nummerserien for rentenotaer.;ENU=Deleting this document will cause a gap in the number series for finance charge memos.';
