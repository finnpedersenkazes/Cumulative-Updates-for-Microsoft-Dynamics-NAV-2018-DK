OBJECT Table 900 Assembly Header
{
  ...
  FIELDS
  {
    ...
    { 3   ;   ;Description         ;Text50        ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Beskrivelse;
                                                              ENU=Description] }
    { 4   ;   ;Search Description  ;Code50        ;CaptionML=[DAN=Sõgebeskrivelse;
    ...
    { 65  ;   ;Unit Cost           ;Decimal       ;OnValidate=VAR
                                                   ...
                                                   MinValue=0;
                                                   AutoFormatType=2 }
    { 67  ;   ;Cost Amount         ;Decimal       ;CaptionML=[DAN=Kostbelõb;
                                                              ENU=Cost Amount];
                                                   Editable=No;
                                                   AutoFormatType=1 }
  ...
  CODE
  {
    VAR
      ...
      Text001@1003 : TextConst '@@@="%1 = Document Type, %2 = No.";DAN=%1 %2 kan ikke oprettes, da den allerede findes eller er bogfõrt.;ENU=%1 %2 cannot be created, because it already exists or has been posted.';
      Text002@1008 : TextConst 'DAN=%1 mÜ ikke vëre lavere end %2, som er %3.;ENU=%1 cannot be lower than the %2, which is %3.';
      Text003@1009 : TextConst 'DAN=%1 mÜ ikke vëre hõjere end %2, som er %3.;ENU=%1 cannot be higher than the %2, which is %3.';
      Item@1004 : Record 27;
      ...
      Text005@1001 : TextConst 'DAN=índring af %1 eller %2 er ikke tilladt, nÜr %3 er %4.;ENU=Changing %1 or %2 is not allowed when %3 is %4.';
      Text007@1007 : TextConst 'DAN=Der er intet at hÜndtere.;ENU=Nothing to handle.';
      Text009@1017 : TextConst 'DAN=%1 kan ikke omdõbes.;ENU=You cannot rename an %1.';
      ...
      Text010@1012 : TextConst 'DAN=Du har ëndret %1.;ENU=You have modified %1.';
      ...
      Text015@1019 : TextConst '@@@="%1 and %3 = Date Captions, %2 and %4 = Date Values";DAN=%1 %2 er fõr %3 %4.;ENU=%1 %2 is before %3 %4.';
      PostingDateLaterErr@1022 : TextConst 'DAN=Bogfõringsdatoen pÜ montageordren %1 mÜ ikke ligge efter bogfõringsdatoen for salgsordren %2.;ENU=Posting Date on Assembly Order %1 must not be later than the Posting Date on Sales Order %2.';
