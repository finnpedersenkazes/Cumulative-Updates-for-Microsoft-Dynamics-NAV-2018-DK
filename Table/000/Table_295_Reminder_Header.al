OBJECT Table 295 Reminder Header
{
  ...
  FIELDS
  {
    ...
    { 20  ;   ;Reason Code         ;Code10        ;TableRelation="Reason Code";
                                                   CaptionML=[DAN=èrsagskode;
                                                              ENU=Reason Code] }
    { 21  ;   ;Posting Date        ;Date          ;CaptionML=[DAN=Bogfõringsdato;
                                                              ENU=Posting Date] }
    ...
    { 26  ;   ;Post Interest       ;Boolean       ;CaptionML=[DAN=Bogfõr rente;
                                                              ENU=Post Interest] }
    { 27  ;   ;Post Additional Fee ;Boolean       ;CaptionML=[DAN=Bogfõr opkrëvningsgebyr;
    ...
    { 28  ;   ;Reminder Level      ;Integer       ;TableRelation="Reminder Level".No. WHERE (Reminder Terms Code=FIELD(Reminder Terms Code));
                                                   ...
                                                   CaptionML=[DAN=Rykkerniveau;
                                                              ENU=Reminder Level] }
    { 29  ;   ;Posting Description ;Text50        ;CaptionML=[DAN=Bogfõringsbeskrivelse;
    ...
    { 33  ;   ;Additional Fee      ;Decimal       ;FieldClass=FlowField;
                                                   CalcFormula=Sum("Reminder Line".Amount WHERE (Reminder No.=FIELD(No.),
                                                                                                 ...
                                                                                                 Line Type=FILTER(<>Not Due)));
                                                   CaptionML=[DAN=Opkrëvningsgebyr;
                                                              ENU=Additional Fee];
                                                   Editable=No;
                                                   AutoFormatType=1;
                                                   AutoFormatExpr="Currency Code" }
    ...
    { 45  ;   ;Add. Fee per Line   ;Decimal       ;FieldClass=FlowField;
                                                   CalcFormula=Sum("Reminder Line".Amount WHERE (Reminder No.=FIELD(No.),
                                                                                                 Type=CONST(Line Fee),
                                                                                                 Line Type=FILTER(<>Not Due)));
                                                   CaptionML=[DAN=Opkrëvningsgebyr pr. linje;
                                                              ENU=Add. Fee per Line];
                                                   AutoFormatExpr="Currency Code" }
    { 46  ;   ;Post Add. Fee per Line;Boolean     ;CaptionML=[DAN=Bogfõr opkrëvningsgebyr pr. linje;
  ...
  CODE
  {
    VAR
      ...
      Text001@1001 : TextConst 'DAN=ùnsker du at udskrive rykker %1?;ENU=Do you want to print reminder %1?';
      Text002@1002 : TextConst 'DAN=índringen sletter linjerne i denne rykker.\\;ENU=This change will cause the existing lines to be deleted for this reminder.\\';
      Text003@1003 : TextConst 'DAN=Vil du fortsëtte?;ENU=Do you want to continue?';
      Text004@1004 : TextConst 'DAN=Der er ikke plads til at indsëtte teksten.;ENU=There is not enough space to insert the text.';
      Text005@1005 : TextConst 'DAN="Hvis du sletter dette dokument, opstÜr der et hul i nummerserien for rykkere. ";ENU="Deleting this document will cause a gap in the number series for reminders. "';
