OBJECT Table 339 Item Application Entry
{
  ...
  PROPERTIES
  {
    Permissions=TableData 339=rm,
                TableData 343=ri;
    CaptionML=[DAN=Vareudligningspost;
               ENU=Item Application Entry];
  ...
  FIELDS
  {
    ...
    { 5805;   ;Outbound Entry is Updated;Boolean  ;InitValue=No;
                                                   CaptionML=[DAN=Udg†ende post er reguleret;
                                                              ENU=Outbound Entry is Updated] }
  }
  KEYS
  {
  ...
  {
    VAR
      Text001@1000 : TextConst 'DAN=Du skal k›re %1-k›rslen, f›r du kan regulere %2 %3.;ENU=You have to run the %1 batch job, before you can revalue %2 %3.';
