OBJECT Table 349 Dimension Value
{
  ...
  FIELDS
  {
    ...
    { 7   ;   ;Consolidation Code  ;Code20        ;AccessByPermission=TableData 220=R;
                                                   CaptionML=[DAN=Konsolideringskode;
                                                              ENU=Consolidation Code] }
    { 8   ;   ;Indentation         ;Integer       ;CaptionML=[DAN=Indrykning;
                                                              ENU=Indentation] }
    { 9   ;   ;Global Dimension No.;Integer       ;CaptionML=[DAN=Global dimension nr.;
    ...
    { 10  ;   ;Map-to IC Dimension Code;Code20    ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=IC-dim.kode for tilknytning;
    ...
    { 11  ;   ;Map-to IC Dimension Value Code;Code20;
                                                   ...
                                                   CaptionML=[DAN=IC-dim.v‘rdikode for tilknytn.;
    ...
    { 8000;   ;Id                  ;GUID          ;CaptionML=[DAN=Id;
                                                              ENU=Id] }
    { 8001;   ;Last Modified Date Time;DateTime   ;CaptionML=[DAN=Dato/klokkesl‘t for seneste ‘ndring;
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=%1\Kan ikke slettes.;ENU=%1\You cannot delete it.';
      Text002@1002 : TextConst 'DAN=(KONFLIKT);ENU=(CONFLICT)';
      Text003@1003 : TextConst 'DAN=%1 kan ikke v‘re (KONFLIKT). Dette navn bruges internt af systemet.;ENU=%1 can not be (CONFLICT). This name is used internally by the system.';
      Text004@1004 : TextConst 'DAN=%1\Du kan ikke ‘ndre typen.;ENU=%1\You cannot change the type.';
      Text005@1005 : TextConst 'DAN=Denne dimensionsv‘rdi er blevet brugt i bogf›rte poster eller budgetposter.;ENU=This dimension value has been used in posted or budget entries.';
      ...
      Text006@1006 : TextConst 'DAN=Du kan ikke ‘ndre v‘rdien %1.;ENU=You cannot change the value of %1.';
