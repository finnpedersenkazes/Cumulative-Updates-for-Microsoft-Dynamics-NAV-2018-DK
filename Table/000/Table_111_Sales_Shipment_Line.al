OBJECT Table 111 Sales Shipment Line
{
  ...
  FIELDS
  {
    ...
    { 39  ;   ;Item Shpt. Entry No.;Integer       ;CaptionML=[DAN=Varelev.postlõbenr.;
    ...
    { 68  ;   ;Bill-to Customer No.;Code20        ;TableRelation=Customer;
                                                   ...
                                                   Editable=No }
    { 71  ;   ;Purchase Order No.  ;Code20        ;CaptionML=[DAN=Kõbsordrenr.;
                                                              ENU=Purchase Order No.] }
    { 72  ;   ;Purch. Order Line No.;Integer      ;CaptionML=[DAN=Kõbsordrelinjenr.;
    ...
    { 1001;   ;Job Task No.        ;Code20        ;TableRelation="Job Task"."Job Task No." WHERE (Job No.=FIELD(Job No.));
                                                   CaptionML=[DAN=Sagsopgavenr.;
                                                              ENU=Job Task No.];
                                                   Editable=No }
    { 1002;   ;Job Contract Entry No.;Integer     ;CaptionML=[DAN=Lõbenr. for sagskontrakt;
    ...
    { 5811;   ;Appl.-from Item Entry;Integer      ;AccessByPermission=TableData 27=R;
                                                   ...
                                                   MinValue=0 }
    { 5812;   ;Item Charge Base Amount;Decimal    ;CaptionML=[DAN=Varegebyrgrundlag (belõb);
