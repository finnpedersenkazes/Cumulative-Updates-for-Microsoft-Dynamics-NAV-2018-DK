OBJECT Table 1003 Job Planning Line
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Sagsplanlëgningslinje;
  ...
  FIELDS
  {
    ...
    { 3   ;   ;Planning Date       ;Date          ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Planlëgningsdato;
                                                              ENU=Planning Date] }
    ...
    { 1008;   ;Line Discount Amount (LCY);Decimal ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Linjerabatbelõb (RV);
    ...
    { 1036;   ;Invoiced Cost Amount (LCY);Decimal ;FieldClass=FlowField;
                                                   CalcFormula=Sum("Job Planning Line Invoice"."Invoiced Cost Amount (LCY)" WHERE (Job No.=FIELD(Job No.),
                                                                                                                                   Job Task No.=FIELD(Job Task No.),
                                                                                                                                   Job Planning Line No.=FIELD(Line No.)));
                                                   CaptionML=[DAN=Faktureret kostbelõb (RV);
                                                              ENU=Invoiced Cost Amount (LCY)];
                                                   Editable=No }
    { 1037;   ;VAT Unit Price      ;Decimal       ;CaptionML=[DAN=Momsenhedspris;
                                                              ENU=VAT Unit Price] }
    { 1038;   ;VAT Line Discount Amount;Decimal   ;CaptionML=[DAN=Momslinjerabatbelõb;
                                                              ENU=VAT Line Discount Amount] }
    { 1039;   ;VAT Line Amount     ;Decimal       ;CaptionML=[DAN=Momslinjebelõb;
                                                              ENU=VAT Line Amount] }
    ...
    { 1061;   ;Remaining Qty. (Base);Decimal      ;CaptionML=[DAN=Restantal (basis);
                                                   ...
                                                   DecimalPlaces=0:5;
                                                   Editable=No }
    { 1062;   ;Remaining Total Cost;Decimal       ;CaptionML=[DAN=Resterende kostbelõb;
                                                              ENU=Remaining Total Cost];
                                                   Editable=No;
                                                   AutoFormatType=1;
                                                   AutoFormatExpr="Currency Code" }
    { 1063;   ;Remaining Total Cost (LCY);Decimal ;CaptionML=[DAN=Resterende kostbelõb (RV);
                                                              ENU=Remaining Total Cost (LCY)];
                                                   Editable=No;
                                                   AutoFormatType=1 }
    { 1064;   ;Remaining Line Amount;Decimal      ;CaptionML=[DAN=Resterende linjebelõb;
                                                              ENU=Remaining Line Amount];
                                                   Editable=No;
                                                   AutoFormatType=1;
                                                   AutoFormatExpr="Currency Code" }
    { 1065;   ;Remaining Line Amount (LCY);Decimal;CaptionML=[DAN=Resterende linjebelõb (RV);
    ...
    { 1070;   ;Qty. Posted         ;Decimal       ;CaptionML=[DAN=Bogf. antal;
                                                   ...
                                                   DecimalPlaces=0:5;
                                                   Editable=No }
    { 1071;   ;Qty. to Transfer to Journal;Decimal;CaptionML=[DAN=Antal, der skal overfõres til kladde;
                                                              ENU=Qty. to Transfer to Journal];
                                                   DecimalPlaces=0:5 }
    { 1072;   ;Posted Total Cost   ;Decimal       ;CaptionML=[DAN=Bogfõrt kostbelõb;
                                                              ENU=Posted Total Cost];
                                                   Editable=No;
                                                   AutoFormatType=1;
                                                   AutoFormatExpr="Currency Code" }
    { 1073;   ;Posted Total Cost (LCY);Decimal    ;CaptionML=[DAN=Bogfõrt kostbelõb (RV);
                                                              ENU=Posted Total Cost (LCY)];
                                                   Editable=No;
                                                   AutoFormatType=1 }
    { 1074;   ;Posted Line Amount  ;Decimal       ;CaptionML=[DAN=Bogfõrt linjebelõb;
                                                              ENU=Posted Line Amount];
                                                   Editable=No;
                                                   AutoFormatType=1;
                                                   AutoFormatExpr="Currency Code" }
    { 1075;   ;Posted Line Amount (LCY);Decimal   ;CaptionML=[DAN=Bogfõrt linjebelõb (RV);
    ...
    { 1080;   ;Qty. Transferred to Invoice;Decimal;FieldClass=FlowField;
                                                   CalcFormula=Sum("Job Planning Line Invoice"."Quantity Transferred" WHERE (Job No.=FIELD(Job No.),
                                                                                                                             Job Task No.=FIELD(Job Task No.),
                                                                                                                             Job Planning Line No.=FIELD(Line No.)));
                                                   CaptionML=[DAN=Antal overfõrt til faktura;
  ...
  CODE
  {
    VAR
      ...
      CurrencyFactorErr@1020 : TextConst '@@@="%1 = Currency Code field name";DAN=mÜ ikke indtastes uden %1;ENU=cannot be specified without %1';
      RecordRenameErr@1024 : TextConst '@@@="%1 = Job Number field name; %2 = Job Task Number field name; %3 = Job Planning Line table name";DAN=Du kan ikke ëndre %1 eller %2 for denne %3.;ENU=You cannot change the %1 or %2 of this %3.';
      CurrencyDate@1023 : Date;
      MissingItemResourceGLErr@1031 : TextConst '@@@="%1 = Document Type (Item, Resoure, or G/L); %2 = Field name";DAN=Du skal angive %1 %2 pÜ planlëgningslinjen.;ENU=You must specify %1 %2 in planning line.';
      HasGotGLSetup@1016 : Boolean;
      UnitAmountRoundingPrecision@1019 : Decimal;
      AmountRoundingPrecision@1028 : Decimal;
      QtyLessErr@1027 : TextConst '@@@="%1 = Name of first field to compare; %2 = Name of second field to compare";DAN=%1 kan ikke vëre mindre end %2.;ENU=%1 cannot be less than %2.';
      ControlUsageLinkErr@1029 : TextConst '@@@="%1 = Job Planning Line table name; %2 = Caption for field Schedule Line; %3 = Captiion for field Usage Link";DAN=%1 skal vëre en %2, og %3 skal vëre aktiveret, da der findes tilknyttede sagsposter.;ENU=The %1 must be a %2 and %3 must be enabled, because linked Job Ledger Entries exist.';
      ...
      LinkedJobLedgerErr@1033 : TextConst 'DAN=Du kan ikke ëndre denne vërdi, fordi der findes tilknyttede sagsposter.;ENU=You cannot change this value because linked job ledger entries exist.';
      LineTypeErr@1003 : TextConst '@@@=The Job Planning Line cannot be of Line Type Schedule, because it is transferred to an invoice.;DAN=%1 kan ikke vëre %2 %3, fordi den er overfõrt til en faktura.;ENU=The %1 cannot be of %2 %3 because it is transferred to an invoice.';
      QtyToTransferToInvoiceErr@1005 : TextConst '@@@="%1 = Qty. to Transfer to Invoice field name; %2 = First value in comparison; %3 = Second value in comparison";DAN=%1 mÜ ikke vëre lavere end %2 og mÜ ikke overskride %3.;ENU=%1 may not be lower than %2 and may not exceed %3.';
      ...
      NoContractLineErr@1021 : TextConst '@@@="%1 = Qty. to Transfer to Invoice field name; %2 = Job Planning Line table name; %3 = The job''s line type";DAN=%1 kan ikke vëre angivet pÜ en %2 af typen %3.;ENU=%1 cannot be set on a %2 of type %3.';
      QtyAlreadyTransferredErr@1038 : TextConst '@@@="%1 = Job Planning Line table name";DAN=%1 er allerede overfõrt.;ENU=The %1 has already been completely transferred.';
      UsageLinkErr@1039 : TextConst '@@@=Usage Link cannot be enabled on a Job Planning Line with Line Type Schedule;DAN=%1 kan ikke aktiveres pÜ en %2 med %3 %4.;ENU=%1 cannot be enabled on a %2 with %3 %4.';
      QtyGreaterErr@1041 : TextConst '@@@="%1 = Caption for field Quantity; %2 = Captiion for field Qty. Transferred to Invoice";DAN=%1 kan ikke vëre stõrre end %2.;ENU=%1 cannot be higher than %2.';
      RequestedDeliveryDateErr@1026 : TextConst '@@@="%1 = Caption for field Requested Delivery Date; %2 = Captiion for field Promised Delivery Date";DAN=%1 kan ikke ëndres, nÜr %2 er udfyldt.;ENU=You cannot change the %1 when the %2 has been filled in.';
      UnitAmountRoundingPrecisionFCY@1036 : Decimal;
      AmountRoundingPrecisionFCY@1037 : Decimal;
      NotPossibleJobPlanningLineErr@1000 : TextConst 'DAN=Det er ikke muligt at slette en sagsplanlëgningslinje, der er overfõrt til en faktura.;ENU=It is not possible to deleted job planning line transferred to an invoice.';
