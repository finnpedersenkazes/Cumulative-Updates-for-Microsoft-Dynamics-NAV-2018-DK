OBJECT Table 1513 Notification Schedule
{
  ...
  FIELDS
  {
    ...
    { 10  ;   ;Friday              ;Boolean       ;InitValue=Yes;
                                                   CaptionML=[DAN=Fredag;
                                                              ENU=Friday] }
    { 11  ;   ;Saturday            ;Boolean       ;CaptionML=[DAN=Lõrdag;
                                                              ENU=Saturday] }
    { 12  ;   ;Sunday              ;Boolean       ;CaptionML=[DAN=Sõndag;
                                                              ENU=Sunday] }
    { 13  ;   ;Date of Month       ;Integer       ;CaptionML=[DAN=Dato i mÜned;
                                                              ENU=Date of Month];
                                                   MinValue=1;
                                                   MaxValue=31 }
    { 14  ;   ;Monthly Notification Date;Option   ;CaptionML=[DAN=MÜnedlig notifikationsdato;
                                                              ENU=Monthly Notification Date];
                                                   OptionCaptionML=[DAN=Fõrste arbejdsdag,Sidste arbejdsdag,Brugerdefineret;
  ...
  {
    VAR
      NotifyNowDescriptionTxt@1000 : TextConst 'DAN=Sag med õjeblik. notifikation;ENU=Instant Notification Job';
