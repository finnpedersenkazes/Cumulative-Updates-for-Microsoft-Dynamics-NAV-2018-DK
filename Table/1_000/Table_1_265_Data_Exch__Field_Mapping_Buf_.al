OBJECT Table 1265 Data Exch. Field Mapping Buf.
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Koblingsbuffer for feltet Dataudveksling;
               ENU=Data Exch. Field Mapping Buf.];
  }
  FIELDS
  {
    { 1   ;   ;Data Exchange Def Code;Code20      ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Dataudvekslingsdefinitionskode;
                                                              ENU=Data Exchange Def Code] }
    { 2   ;   ;Data Exchange Line Def Code;Code20 ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Definitionskode for dataudvekslingslinje;
                                                              ENU=Data Exchange Line Def Code] }
    ...
    { 5   ;   ;Type                ;Option        ;DataClassification=SystemMetadata;
                                                   CaptionML=[DAN=Type;
                                                              ENU=Type];
                                                   OptionCaptionML=[DAN=Felt,Tabel;
                                                                    ENU=Field,Table];
