OBJECT Table 1107 Cost Allocation Target
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=OmkostningsfordelingsmÜl;
  ...
  FIELDS
  {
    ...
    { 5   ;   ;Target Cost Type    ;Code20        ;TableRelation="Cost Type";
                                                   CaptionML=[DAN=MÜlomkostningstype;
    ...
    { 6   ;   ;Target Cost Center  ;Code20        ;TableRelation="Cost Center";
                                                   ...
                                                   CaptionML=[DAN=MÜlomkostningssted;
    ...
    { 7   ;   ;Target Cost Object  ;Code20        ;TableRelation="Cost Object";
                                                   ...
                                                   CaptionML=[DAN=MÜlomkostningsemne;
    ...
    { 9   ;   ;Static Weighting    ;Decimal       ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Statisk vëgtning;
    ...
    { 11  ;   ;Percent             ;Decimal       ;CaptionML=[DAN=Procent;
                                                   ...
                                                   MaxValue=100;
                                                   Editable=No }
    { 20  ;   ;Comment             ;Text50        ;CaptionML=[DAN=Bemërkning;
                                                              ENU=Comment] }
    { 30  ;   ;Base                ;Option        ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Grundlag;
                                                              ENU=Base];
                                                   OptionCaptionML=[DAN=Statisk,Finansposter,Finansbudgetposter,Omkostningstypeposter,Omkostningsbudgetposter,,,,,Antal medarbejdere,,Varer solgt (ant.),Varer kõbt (ant.),Varer solgt (belõb),Varer kõbt (belõb);
    ...
    { 34  ;   ;Date Filter Code    ;Option        ;CaptionML=[DAN=Datofilterkode;
                                                   ...
                                                   OptionCaptionML=[DAN=" ,Uge,Sidste uge,MÜned,Sidste mÜned,MÜned i sidste Ür,èr,Sidste Ür,Periode,Sidste periode,Preriode i sidste Ür,RegnskabÜr,Sidste regnskabsÜr";
    ...
    { 38  ;   ;Allocation Target Type;Option      ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=FordelingsmÜltype;
                                                              ENU=Allocation Target Type];
                                                   OptionCaptionML=[DAN=Alle omkostninger,Procent pr. fordeling,Belõb pr. fordeling;
    ...
    { 41  ;   ;Amount per Share    ;Decimal       ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Belõb pr. fordeling;
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Du kan ikke bÜde definere et omkostningssted og et omkostningsemne.;ENU=You cannot define both cost center and cost object.';
