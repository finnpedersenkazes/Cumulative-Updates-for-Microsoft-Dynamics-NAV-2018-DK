OBJECT Table 99000880 Order Promising Line
{
  ...
  FIELDS
  {
    ...
    { 15  ;   ;Qty. per Unit of Measure;Decimal   ;CaptionML=[DAN=Antal pr. enhed;
                                                   ...
                                                   DecimalPlaces=0:5;
                                                   Editable=No }
    { 16  ;   ;Unavailable Quantity;Decimal       ;CaptionML=[DAN=Ikketilgëngeligt antal;
                                                              ENU=Unavailable Quantity];
                                                   DecimalPlaces=0:5 }
    { 17  ;   ;Quantity (Base)     ;Decimal       ;CaptionML=[DAN=Antal (basis);
                                                              ENU=Quantity (Base)];
                                                   DecimalPlaces=0:5 }
    { 18  ;   ;Unavailable Quantity (Base);Decimal;CaptionML=[DAN=Ikketilgëng. antal (basis);
                                                              ENU=Unavailable Quantity (Base)];
                                                   DecimalPlaces=0:5 }
    { 19  ;   ;Required Quantity (Base);Decimal   ;CaptionML=[DAN=PÜkrëvet antal (basis);
                                                              ENU=Required Quantity (Base)];
                                                   DecimalPlaces=0:5 }
    { 20  ;   ;Source Type         ;Option        ;CaptionML=[DAN=Kildetype;
                                                              ENU=Source Type];
                                                   OptionCaptionML=[DAN=" ,Salg,Rekvisitionslinje,Kõb,Varekladde,Styklistekladde,Varepost,Prod.ordrelinje,Prod.ordrekomponent,Planlëgningslinje,Planlëgningskomponent,Overfõrsel,Serviceordre,Job";
    ...
    { 30  ;   ;Description         ;Text50        ;CaptionML=[DAN=Beskrivelse;
                                                              ENU=Description] }
    { 31  ;   ;Required Quantity   ;Decimal       ;CaptionML=[DAN=PÜkrëvet antal;
    ...
    { 44  ;   ;Requested Shipment Date;Date       ;CaptionML=[DAN=ùnsket afsendelsesdato;
