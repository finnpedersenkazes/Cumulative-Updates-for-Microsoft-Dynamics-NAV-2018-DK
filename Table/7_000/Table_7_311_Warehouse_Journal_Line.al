OBJECT Table 7311 Warehouse Journal Line
{
  ...
  FIELDS
  {
    ...
    { 25  ;   ;Source Document     ;Option        ;CaptionML=[DAN=Kildedokument;
                                                              ENU=Source Document];
                                                   OptionCaptionML=[DAN=,S.ordre,S.faktura,S.kreditnota,S.returv.ordre,K.ordre,K.faktura,K.kreditnota,K.returv.ordre,Indg. overfõr.,Udg. overfõr.,Prod.forbrug,Varekld.,Lageropg.kld.,Ompost.kld.,Forbrugskld.,Afgangskld.,Styklistekld.,Serv.ordre,Sagskld.,Montageforbrug,Montageordre;
    ...
    { 40  ;   ;Cubage              ;Decimal       ;CaptionML=[DAN=RummÜl;
                                                              ENU=Cubage];
                                                   DecimalPlaces=0:5;
                                                   Editable=No }
    { 41  ;   ;Weight              ;Decimal       ;CaptionML=[DAN=Vëgt;
                                                              ENU=Weight];
                                                   DecimalPlaces=0:5;
                                                   Editable=No }
    ...
    { 51  ;   ;Whse. Document Type ;Option        ;CaptionML=[DAN=Lagerdokumenttype;
                                                   ...
                                                   OptionCaptionML=[DAN=Lagerkladde,Modtagelse,Leverance,Internt lëg-pÜ-lager,Internt pluk,Produktion,Lagerplac.opg., ,Montage;
    ...
    { 55  ;   ;Entry Type          ;Option        ;CaptionML=[DAN=Posttype;
                                                              ENU=Entry Type];
                                                   OptionCaptionML=[DAN=Nedregulering,Opregulering,Bevëgelse;
    ...
    { 60  ;   ;Reference Document  ;Option        ;CaptionML=[DAN=Referencedokument;
                                                   ...
                                                   OptionCaptionML=[DAN=" ,Bogfõrt modt.,Bogf. kõbsfakt.,Bogf. returv.modt.,Bogf. kõbskred.nota,Bogf. leverance,Bogf. salgsfakt.,Bogf. returv.leverance,Bogf. salgskred.nota,Bogf. overfõr.kvit.,Bogf. overfõr.lev.,Varekladde,Prod.,Lëg-pÜ-lager,Pluk,Bevëgelse,Styklistekld.,Sagskladde,Montage";
    ...
    { 6502;   ;Warranty Date       ;Date          ;CaptionML=[DAN=Garantiophõr den;
                                                              ENU=Warranty Date];
                                                   Editable=No }
    { 6503;   ;Expiration Date     ;Date          ;CaptionML=[DAN=Udlõbsdato;
                                                              ENU=Expiration Date];
                                                   Editable=No }
    ...
    { 6505;   ;New Lot No.         ;Code20        ;CaptionML=[DAN=Nyt lotnr.;
                                                              ENU=New Lot No.];
                                                   Editable=No }
    { 6506;   ;New Expiration Date ;Date          ;CaptionML=[DAN=Ny udlõbsdato;
  ...
  CODE
  {
    VAR
      ...
      Text000@1009 : TextConst 'DAN=mÜ ikke vëre negativ;ENU=must not be negative';
      ...
      Text006@1017 : TextConst 'DAN=%1 skal vëre 0 eller 1 for en vare der, spores ved hjëlp af serienummer.;ENU=%1 must be 0 or 1 for an Item tracked by Serial Number.';
