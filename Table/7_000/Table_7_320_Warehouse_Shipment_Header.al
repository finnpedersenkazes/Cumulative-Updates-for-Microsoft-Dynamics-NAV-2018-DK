OBJECT Table 7320 Warehouse Shipment Header
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Lagerleverancehoved;
  ...
  FIELDS
  {
    ...
    { 6   ;   ;Sorting Method      ;Option        ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Sorteringsmetode;
                                                              ENU=Sorting Method];
                                                   OptionCaptionML=[DAN=" ,Vare,Bilag,Placering,Forfaldsdato,Destination";
    ...
    { 34  ;   ;Document Status     ;Option        ;OnValidate=VAR
                                                   ...
                                                   Editable=No }
    { 39  ;   ;Posting Date        ;Date          ;CaptionML=[DAN=Bogfõringsdato;
                                                              ENU=Posting Date] }
    ...
    { 46  ;   ;Completely Picked   ;Boolean       ;FieldClass=FlowField;
                                                   ...
                                                   Editable=No }
    { 47  ;   ;Status              ;Option        ;CaptionML=[DAN=Status;
                                                              ENU=Status];
                                                   OptionCaptionML=[DAN=èben,Frigivet;
                                                                    ENU=Open,Released];
                                                   OptionString=Open,Released;
                                                   Editable=No }
    { 48  ;   ;External Document No.;Code35       ;CaptionML=[DAN=Eksternt bilagsnr.;
                                                              ENU=External Document No.] }
    { 50  ;   ;Create Posted Header;Boolean       ;CaptionML=[DAN=Opret bogfõrt hoved;
                                                              ENU=Create Posted Header] }
    { 61  ;   ;Shipping No.        ;Code20        ;CaptionML=[DAN=Salgslev.nr.;
                                                              ENU=Shipping No.] }
    ...
    { 63  ;   ;Shipping No. Series ;Code20        ;TableRelation="No. Series";
                                                   ...
                                                   CaptionML=[DAN=Salgslev.nummerserie;
  ...
  CODE
  {
    VAR
      ...
      Text000@1011 : TextConst 'DAN=%1 kan ikke omdõbes.;ENU=You cannot rename a %1.';
      Text001@1010 : TextConst 'DAN=%1 kan ikke ëndres, fordi dokumentet indeholder en eller flere linjer.;ENU=You cannot change the %1, because the document has one or more lines.';
      Text002@1000 : TextConst 'DAN=Du skal fõrst oprette brugeren %1 som lagermedarbejder.;ENU=You must first set up user %1 as a warehouse employee.';
      WmsManagement@1004 : Codeunit 7302;
      Text003@1005 : TextConst 'DAN=Du kan ikke bruge lokationskode %1.;ENU=You are not allowed to use location code %1.';
      ItemTrackingMgt@1006 : Codeunit 6500;
      HideValidationDialog@1007 : Boolean;
      Text006@1012 : TextConst 'DAN=Du har ëndret %1 pÜ %2, men der er ikke foretaget ëndringer pÜ de eksisterende lagerleverancelinjer.\;ENU=You have changed %1 on the %2, but it has not been changed on the existing Warehouse Shipment Lines.\';
      Text007@1009 : TextConst 'DAN=Du skal opdatere de eksisterende lagerleverancelinjer manuelt.;ENU=You must update the existing Warehouse Shipment Lines manually.';
      Text008@1014 : TextConst 'DAN=Du har ëndret %1.\\Vil du opdatere linjerne?;ENU=You have modified the %1.\\Do you want to update the lines?';
      Text009@1008 : TextConst 'DAN=Varerne er plukket. Hvis du sletter leverancen, forbliver varerne i afsendelsesomrÜdet, indtil du lëgger dem pÜ lager.\Relaterede varesporingsoplysninger, der defineres under pluk, slettes.\Er du sikker pÜ, at du vil slette leverancen?;ENU=The items have been picked. If you delete the warehouse shipment, then the items will remain in the shipping area until you put them away.\Related item tracking information that is defined during the pick will be deleted.\Are you sure that you want to delete the warehouse shipment?';
