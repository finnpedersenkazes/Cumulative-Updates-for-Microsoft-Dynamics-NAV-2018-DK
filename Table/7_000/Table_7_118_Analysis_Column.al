OBJECT Table 7118 Analysis Column
{
  ...
  FIELDS
  {
    { 1   ;   ;Analysis Area       ;Option        ;CaptionML=[DAN=AnalyseomrÜde;
                                                              ENU=Analysis Area];
                                                   OptionCaptionML=[DAN=Salg,Kõb,Lager;
    ...
    { 16  ;   ;Value Entry Type Filter;Text250    ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Vërdiposttypefilter;
                                                              ENU=Value Entry Type Filter] }
    { 17  ;   ;Value Type          ;Option        ;CaptionML=[DAN=Vërditype;
                                                              ENU=Value Type];
                                                   OptionCaptionML=[DAN=" ,Antal,Salgsbelõb,Kostbelõb,Ikke-lagermëssigt belõb,Enhedspris,Kostpris (standard),Indirekte omkostning,Kostpris";
