OBJECT Table 7134 Item Budget Entry
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Varebudgetpost;
               ENU=Item Budget Entry];
  ...
  FIELDS
  {
    { 1   ;   ;Entry No.           ;Integer       ;CaptionML=[DAN=L›benr.;
                                                              ENU=Entry No.] }
    { 2   ;   ;Analysis Area       ;Option        ;CaptionML=[DAN=Analyseomr†de;
                                                              ENU=Analysis Area];
    ...
    { 9   ;   ;Quantity            ;Decimal       ;CaptionML=[DAN=Antal;
                                                              ENU=Quantity];
                                                   DecimalPlaces=0:5 }
    { 10  ;   ;Cost Amount         ;Decimal       ;CaptionML=[DAN=Kostbel›b;
                                                              ENU=Cost Amount];
                                                   AutoFormatType=1 }
    { 11  ;   ;Sales Amount        ;Decimal       ;CaptionML=[DAN=Salgsbel›b;
                                                              ENU=Sales Amount];
                                                   AutoFormatType=1 }
