OBJECT Table 7332 Whse. Internal Put-away Line
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Int. l‘g-p†-lager-linje (log.);
               ENU=Whse. Internal Put-away Line];
  ...
  FIELDS
  {
    ...
    { 23  ;   ;Qty. Put Away       ;Decimal       ;OnValidate=BEGIN
                                                   ...
                                                   CaptionML=[DAN=Antal lagt-p†-lager;
                                                              ENU=Qty. Put Away];
                                                   DecimalPlaces=0:5;
                                                   Editable=No }
    { 24  ;   ;Qty. Put Away (Base);Decimal       ;CaptionML=[DAN=Antal lagt-p†-lager (basis);
    ...
    { 26  ;   ;Put-away Qty. (Base);Decimal       ;FieldClass=FlowField;
                                                   ...
                                                   DecimalPlaces=0:5;
                                                   Editable=No }
    { 27  ;   ;Status              ;Option        ;CaptionML=[DAN=Status;
                                                              ENU=Status];
    ...
    { 36  ;   ;Due Date            ;Date          ;CaptionML=[DAN=Forfaldsdato;
                                                              ENU=Due Date] }
    { 37  ;   ;Cubage              ;Decimal       ;CaptionML=[DAN=Rumm†l;
                                                              ENU=Cubage];
                                                   DecimalPlaces=0:5 }
    { 38  ;   ;Weight              ;Decimal       ;CaptionML=[DAN=V‘gt;
                                                              ENU=Weight];
                                                   DecimalPlaces=0:5 }
  }
  KEYS
  ...
  CODE
  {
    VAR
      ...
      Text000@1003 : TextConst 'DAN=kan ikke v‘re %1 i %2;ENU=must not be the %1 of the %2';
      Text001@1005 : TextConst 'DAN=skal v‘re st›rre end %1;ENU=must be greater than %1';
      Text002@1006 : TextConst 'DAN=m† ikke v‘re mere end %1 enheder;ENU=must not be greater than %1 units';
      Text003@1007 : TextConst 'DAN=%1 kan ikke omd›bes.;ENU=You cannot rename a %1.';
      LastLineNo@1012 : Integer;
      HideValidationDialog@1008 : Boolean;
      Text004@1009 : TextConst 'DAN="%1 = %2 er mindre end %3 = %4.\Er du sikker p†, at du vil slette %5?";ENU="%1 = %2 is less than the %3 = %4.\Do you really want to delete the %5?"';
      Text005@1010 : TextConst 'DAN=Annulleret.;ENU=Cancelled.';
      Text006@1011 : TextConst 'DAN=Der er intet at h†ndtere.;ENU=Nothing to handle.';
