OBJECT Table 7317 Warehouse Receipt Line
{
  ...
  FIELDS
  {
    ...
    { 9   ;   ;Source Document     ;Option        ;CaptionML=[DAN=Kildedokument;
                                                              ENU=Source Document];
                                                   OptionCaptionML=[DAN=,Salgsordre,,,Salgsreturvareordre,K›bsordre,,,K›bsreturvareordre,Indg†ende overflyt.;
    ...
    { 37  ;   ;Starting Date       ;Date          ;CaptionML=[DAN=Startdato;
                                                              ENU=Starting Date] }
    { 38  ;   ;Cubage              ;Decimal       ;CaptionML=[DAN=Rumm†l;
                                                              ENU=Cubage];
                                                   DecimalPlaces=0:5 }
    { 39  ;   ;Weight              ;Decimal       ;CaptionML=[DAN=V‘gt;
                                                              ENU=Weight];
                                                   DecimalPlaces=0:5 }
  ...
  CODE
  {
    VAR
      ...
      Text001@1022 : TextConst 'DAN=%1 kan ikke omd›bes.;ENU=You cannot rename a %1.';
      Text002@1021 : TextConst 'DAN=Du kan ikke h†ndtere mere end de udest†ende %1 enheder.;ENU=You cannot handle more than the outstanding %1 units.';
      Text003@1001 : TextConst 'DAN=Annulleret.;ENU=Cancelled.';
      Text004@1004 : TextConst 'DAN=%1 %2 er ikke fuldt modtaget.\Er du sikker p†, at du vil slette %1?;ENU=%1 %2 is not completely received.\Do you really want to delete the %1?';
