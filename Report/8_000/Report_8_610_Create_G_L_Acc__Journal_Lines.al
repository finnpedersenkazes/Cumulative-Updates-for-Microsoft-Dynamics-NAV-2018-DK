OBJECT Report 8610 Create G/L Acc. Journal Lines
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Opret kladdelinjer for finanskonto;
    ...
    CONTROLS
    {
      ...
      { 2   ;2   ;Field     ;
                  CaptionML=[DAN=Bilagstype;
                             ENU=Document Type];
                  ToolTipML=[DAN=Angiver dokumenttypen for kladdelinjen.;
      ...
      { 4   ;2   ;Field     ;
                  CaptionML=[DAN=Bogf›ringsdato;
                             ENU=Posting Date];
                  ToolTipML=[DAN=Angiver bogf›ringsdatoen for kladdelinjen.;
      ...
      { 6   ;2   ;Field     ;
                  ...
                  ToolTipML=[DAN=Angiver navnet p† den kladde, som linjerne skal tilf›jes i.;
      ...
      { 10  ;2   ;Field     ;
                  ...
                  ToolTipML=[DAN=Angiver den finanskladde, som du opretter linjer i.;
  ...
  CODE
  {
    VAR
      ...
      LineNo@1008 : Integer;
      Text001@1014 : TextConst 'DAN=Skabelonen for den generelle kladde har ikke et navn.;ENU=Gen. Journal Template name is blank.';
      Text002@1009 : TextConst 'DAN=Den generelle massebogf›ringskladde har ikke et navn.;ENU=Gen. Journal Batch name is blank.';
      JournalTemplate@1012 : Text[10];
      Text004@1016 : TextConst 'DAN=De generelle kladdelinjer er oprettet.;ENU=General journal lines are successfully created.';
