OBJECT Report 5914 Delete Invoiced Service Orders
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Slet fakturerede serviceordrer;
  ...
  DATASET
  {
    { 1634;    ;DataItem;                    ;
               ...
               ReqFilterHeadingML=[DAN=Serviceordre;
                                   ENU=Service Order];
               OnPreDataItem=BEGIN
                               Window.OPEN(Text000);
                             END;
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Behandler serviceordrer #1##########;ENU=Processing Service orders #1##########';
