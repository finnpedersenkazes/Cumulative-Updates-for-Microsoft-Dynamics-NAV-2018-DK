OBJECT Report 5751 Put-away List
{
  OBJECT-PROPERTIES
  {
    Date=30-08-18;
  ...
  DATASET
  {
    { 9684;    ;DataItem;                    ;
               ...
               DataItemTableView=SORTING(Type,No.)
                                 WHERE(Type=FILTER(Put-away|Invt. Put-away));
    ...
    { 157 ;1   ;Column  ;No_WhseActivHeader  ;
               SourceExpr="No." }
    ...
    { 145 ;2   ;Column  ;SumUpLines          ;
               SourceExpr=SumUpLines }

    { 146 ;2   ;Column  ;ShowLotSN           ;
               SourceExpr=ShowLotSN }

    { 147 ;2   ;Column  ;InvtPutAway         ;
               SourceExpr=InvtPutAway }

    { 148 ;2   ;Column  ;BinMandatory        ;
               SourceExpr=Location."Bin Mandatory" }

    { 149 ;2   ;Column  ;DirPutAwayAndPick   ;
               SourceExpr=Location."Directed Put-away and Pick" }

    { 150 ;2   ;Column  ;PutAwayFilter       ;
               SourceExpr=PutAwayFilter }

    { 7   ;2   ;Column  ;TblCptnPutAwayFilter;
               SourceExpr="Warehouse Activity Header".TABLECAPTION + ': ' + PutAwayFilter }
    ...
    { 46  ;2   ;Column  ;AssgndUID_WhseActivHeader;
               IncludeCaption=Yes;
               SourceExpr="Warehouse Activity Header"."Assigned User ID" }

    { 44  ;2   ;Column  ;SortingMthd_WhseActivHeader;
               IncludeCaption=Yes;
               SourceExpr="Warehouse Activity Header"."Sorting Method" }

    { 38  ;2   ;Column  ;SrcDoc_WhseActivHeader;
               IncludeCaption=Yes;
    ...
    { 5   ;2   ;Column  ;PutawayListCaption  ;
               SourceExpr=PutawayListCaptionLbl }
    ...
    { 8   ;3   ;Column  ;SrcNo_WhseActivLine ;
               IncludeCaption=No;
               SourceExpr="Source No." }

    { 10  ;3   ;Column  ;SrcDoc_WhseActivLine;
    ...
    { 14  ;3   ;Column  ;ItemNo1_WhseActivLine;
               IncludeCaption=No;
               SourceExpr="Item No." }

    { 16  ;3   ;Column  ;Desc_WhseActivLine  ;
               IncludeCaption=No;
               SourceExpr=Description }

    { 18  ;3   ;Column  ;CrsDocInfo_WhseActivLine;
               IncludeCaption=No;
    ...
    { 36  ;3   ;Column  ;QtyToHndl_WhseActivLine;
               IncludeCaption=No;
    ...
    { 22  ;3   ;Column  ;CrossDockMark       ;
               SourceExpr=CrossDockMark }

    { 65  ;3   ;Column  ;VariantCode_WhseActivLine;
               IncludeCaption=No;
    ...
    { 118 ;3   ;Column  ;LotNo1_WhseActivLine;
               IncludeCaption=Yes;
               SourceExpr="Lot No." }

    { 120 ;3   ;Column  ;SerialNo_WhseActivLine;
               IncludeCaption=Yes;
               SourceExpr="Serial No." }

    { 161 ;3   ;Column  ;LineNo1_WhseActivLine;
               SourceExpr="Line No." }

    { 164 ;3   ;Column  ;BinRanking_WhseActivLine;
    ...
    { 132 ;4   ;Column  ;LotNo_WhseActivLine ;
               SourceExpr="Lot No." }

    { 134 ;4   ;Column  ;SerialNo2_WhseActivLine;
               SourceExpr="Serial No." }

    { 135 ;4   ;Column  ;QtyBase2_WhseActivLine;
               SourceExpr="Qty. (Base)" }

    { 136 ;4   ;Column  ;QtyToHndl2_WhseActivLine;
               SourceExpr="Qty. to Handle" }

    { 167 ;4   ;Column  ;LineNo_WhseActivLine;
               SourceExpr="Line No." }
  ...
  REQUESTPAGE
  {
    ...
    CONTROLS
    {
      ...
      { 3   ;2   ;Field     ;
                  ...
                  ToolTipML=[DAN=Angiver, at du ikke vil have vist de midlertidige linjer, som oprettes, n†r der ‘ndres enhed i l‘g-p†-lager-instruktionerne.;
                             ENU=Specifies if you do not want to view the intermediate lines that are created when the unit of measure is changed in put-away instructions.];
      ...
      { 5   ;2   ;Field     ;
                  ...
                  CaptionML=[DAN=Samment‘lling af linjer;
                             ENU=Sum up Lines];
                  ToolTipML=[DAN=Angiver, om du vil have linjerne opsummeret for hver vare, f.eks. flere l‘g-p†-lager-linjer, der stammer fra forskellige kildedokumenter, men vedr›rer samme vare og placeringer.;
                             ENU=Specifies if you want the lines to be summed up for each item, such as several put-away lines that originate from different source documents that concern the same item and bins.];
                  ApplicationArea=#Warehouse;
                  SourceExpr=SumUpLines;
  ...
  LABELS
  {
    { 2   ;WhseActLineItemNoCaption;
                                CaptionML=[DAN=Varenr.;
                                           ENU=Item No.] }
    { 9   ;WhseActLineDescriptionCaption;
                                CaptionML=[DAN=Beskrivelse;
                                           ENU=Description] }
    { 11  ;WhseActLineVariantCodeCaption;
                                CaptionML=[DAN=Variantkode;
                                           ENU=Variant Code] }
    { 13  ;WhseActLineCrossDockInformationCaption;
                                CaptionML=[DAN=Oplysn. om dir. afsend.;
                                           ENU=Cross-Dock Information] }
    { 15  ;WhseActLineShelfNoCaption;
                                CaptionML=[DAN=Placeringsnr.;
                                           ENU=Shelf No.] }
    { 17  ;WhseActLineQtyBaseCaption;
                                CaptionML=[DAN=Antal (basis);
                                           ENU=Quantity(Base)] }
    { 19  ;WhseActLineQtytoHandleCaption;
                                CaptionML=[DAN=Antal til h†ndtering;
                                           ENU=Quantity to Handle] }
    { 21  ;WhseActLineUnitofMeasureCodeCaption;
                                CaptionML=[DAN=Enhedskode;
                                           ENU=Unit of Measure Code] }
    { 24  ;WhseActLineSourceNoCaption;
  ...
  CODE
  {
    VAR
      ...
      PutAwayFilter@1002 : Text;
      BreakbulkFilter@1008 : Boolean;
      SumUpLines@1010 : Boolean;
      HideOptions@1000 : Boolean;
      InvtPutAway@1003 : Boolean;
      ShowLotSN@1006 : Boolean;
      Counter@1011 : Integer;
      CrossDockMark@1004 : Text[1];
      BreakbulkEditable@19076051 : Boolean INDATASET;
      SumUpLinesEditable@19074758 : Boolean INDATASET;
      CurrReportPAGENOCaptionLbl@5397 : TextConst 'DAN=Side;ENU=Page';
      PutawayListCaptionLbl@9419 : TextConst 'DAN=L‘g-p†-lager-oversigt;ENU=Put-away List';
      WhseActLineDueDateCaptionLbl@7143 : TextConst 'DAN=Forfaldsdato;ENU=Due Date';
      QtyHandledCaptionLbl@9503 : TextConst 'DAN=Antal h†ndteret;ENU=Quantity Handled';
    ...
    PROCEDURE SetCrossDockMark@3(CrossDockInfo@1000 : Option);
    BEGIN
...
<Report xmlns="http://schemas.microsoft.com/sqlserver/reporting/2016/01/reportdefinition" xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner">
  ...
  <DataSources>
    <DataSource Name="DataSource">
      ...
      <rd:DataSourceID>d5cfc493-c18a-497d-896b-bd6936e879c8</rd:DataSourceID>
    </DataSource>
  </DataSources>
  <DataSets>
    <DataSet Name="DataSet_Result">
      ...
      <Fields>
        ...
        <Field Name="InvtPutAway">
          <DataField>InvtPutAway</DataField>
        </Field>
        <Field Name="BinMandatory">
          <DataField>BinMandatory</DataField>
        </Field>
        <Field Name="DirPutAwayAndPick">
          <DataField>DirPutAwayAndPick</DataField>
        </Field>
        <Field Name="PutAwayFilter">
          <DataField>PutAwayFilter</DataField>
        </Field>
        <Field Name="TblCptnPutAwayFilter">
          <DataField>TblCptnPutAwayFilter</DataField>
        </Field>
        ...
        <Field Name="AssgndUID_WhseActivHeader">
          <DataField>AssgndUID_WhseActivHeader</DataField>
        </Field>
        <Field Name="SortingMthd_WhseActivHeader">
          <DataField>SortingMthd_WhseActivHeader</DataField>
        </Field>
        <Field Name="SrcDoc_WhseActivHeader">
          <DataField>SrcDoc_WhseActivHeader</DataField>
        </Field>
        <Field Name="CurrReportPAGENOCaption">
          <DataField>CurrReportPAGENOCaption</DataField>
        </Field>
        <Field Name="PutawayListCaption">
          <DataField>PutawayListCaption</DataField>
        </Field>
        ...
        <Field Name="SrcNo_WhseActivLine">
          <DataField>SrcNo_WhseActivLine</DataField>
        </Field>
        <Field Name="SrcDoc_WhseActivLine">
          <DataField>SrcDoc_WhseActivLine</DataField>
        </Field>
        <Field Name="ShelfNo_WhseActivLine">
          <DataField>ShelfNo_WhseActivLine</DataField>
        </Field>
        <Field Name="ItemNo1_WhseActivLine">
          <DataField>ItemNo1_WhseActivLine</DataField>
        </Field>
        <Field Name="Desc_WhseActivLine">
          <DataField>Desc_WhseActivLine</DataField>
        </Field>
        <Field Name="CrsDocInfo_WhseActivLine">
          <DataField>CrsDocInfo_WhseActivLine</DataField>
        </Field>
        ...
        <Field Name="QtyToHndl_WhseActivLine">
          <DataField>QtyToHndl_WhseActivLine</DataField>
        </Field>
        <Field Name="QtyToHndl_WhseActivLineFormat">
          <DataField>QtyToHndl_WhseActivLineFormat</DataField>
        </Field>
        ...
        <Field Name="CrossDockMark">
          <DataField>CrossDockMark</DataField>
        </Field>
        ...
        <Field Name="LotNo1_WhseActivLine">
          <DataField>LotNo1_WhseActivLine</DataField>
        </Field>
        <Field Name="SerialNo_WhseActivLine">
          <DataField>SerialNo_WhseActivLine</DataField>
        </Field>
        <Field Name="LineNo1_WhseActivLine">
          <DataField>LineNo1_WhseActivLine</DataField>
        </Field>
        <Field Name="BinRanking_WhseActivLine">
          <DataField>BinRanking_WhseActivLine</DataField>
        </Field>
        ...
        <Field Name="SerialNo2_WhseActivLine">
          <DataField>SerialNo2_WhseActivLine</DataField>
        </Field>
        <Field Name="QtyBase2_WhseActivLine">
          <DataField>QtyBase2_WhseActivLine</DataField>
        </Field>
        <Field Name="QtyBase2_WhseActivLineFormat">
          <DataField>QtyBase2_WhseActivLineFormat</DataField>
        </Field>
        <Field Name="QtyToHndl2_WhseActivLine">
          <DataField>QtyToHndl2_WhseActivLine</DataField>
        </Field>
        <Field Name="QtyToHndl2_WhseActivLineFormat">
          <DataField>QtyToHndl2_WhseActivLineFormat</DataField>
        </Field>
          ...
          <Tablix Name="PutAwayListTable">
              ...
              <TablixRows>
                        ...
                        <Textbox Name="textbox126">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!TblCptnPutAwayFilter.Value</Value>
                                  <Style>
                        ...
                        <Textbox Name="textbox127">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!AssgndUID_WhseActivHeaderCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox131">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!AssgndUID_WhseActivHeader.Value</Value>
                                  <Style />
                                </TextRun>
                              </TextRuns>
                              <Style />
                        ...
                        <Textbox Name="textbox157">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!SortingMthd_WhseActivHeaderCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox162">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!SortingMthd_WhseActivHeader.Value</Value>
                                  <Style />
                                </TextRun>
                              </TextRuns>
                              <Style />
                ...
                <TablixRow>
                  ...
                  <TablixCells>
                        ...
                        <Textbox Name="textbox159">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!SrcDoc_WhseActivHeaderCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox238">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!WhseActLineSourceNoCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox241">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!WhseActLineDueDateCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox243">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!WhseActLineItemNoCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="textbox24413">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!WhseActLineDescriptionCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox245">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!WhseActLineVariantCodeCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox246">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!WhseActLineCrossDockInformationCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox247">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!WhseActLineShelfNoCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox248">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!WhseActLineQtyBaseCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox249">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!WhseActLineQtytoHandleCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox250">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!WhseActLineUnitofMeasureCodeCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox242">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!ActionType_WhseActivLineCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox279">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!ZoneCode_WhseActivLineCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox273">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!BinCode_WhseActivLineCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                ...
                <TablixRow>
                  ...
                  <TablixCells>
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="textbox890">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!SrcDoc_WhseActivLine.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                  </Style>
                                </TextRun>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="textbox891">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!SrcNo_WhseActivLine.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                  </Style>
                                </TextRun>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="textbox896">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!ItemNo1_WhseActivLine.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                  </Style>
                                </TextRun>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="textbox897">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!Desc_WhseActivLine.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="textbox59">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!CrossDockMark.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="textbox44">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!CrsDocInfo_WhseActivLine.Value</Value>
                                  <Style />
                                </TextRun>
                              </TextRuns>
                              <Style />
                        ...
                        <Textbox Name="textbox902">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!QtyToHndl_WhseActivLine.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <Format>=Fields!QtyToHndl_WhseActivLineFormat.Value</Format>
                                  </Style>
                                </TextRun>
                              </TextRuns>
                              <Style />
                ...
                <TablixRow>
                  ...
                  <TablixCells>
                        ...
                        <Textbox Name="textbox848">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!LotNo1_WhseActivLineCaption.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="textbox849">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!LotNo1_WhseActivLine.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                  </Style>
                                </TextRun>
                ...
                <TablixRow>
                  ...
                  <TablixCells>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="textbox746">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!SerialNo2_WhseActivLine.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                  </Style>
                                </TextRun>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="textbox747">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!QtyBase2_WhseActivLine.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="textbox748">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!QtyToHndl2_WhseActivLine.Value</Value>
                                  <Style>
                                    <FontSize>9pt</FontSize>
                                    <Format>=Fields!QtyToHndl_WhseActivLineFormat.Value</Format>
                                  </Style>
            ...
            <TablixRowHierarchy>
              <TablixMembers>
                <TablixMember>
                  <Visibility>
                    <Hidden>=iif(Fields!PutAwayFilter.Value="",true,false)</Hidden>
                  </Visibility>
                ...
                <TablixMember>
                  ...
                  <TablixMembers>
                    ...
                    <TablixMember>
                      <Visibility>
                        <Hidden>=iif(Fields!DirPutAwayAndPick.Value,false,true)</Hidden>
                      </Visibility>
                      <KeepWithGroup>After</KeepWithGroup>
                      <KeepTogether>true</KeepTogether>
                    </TablixMember>
                    ...
                    <TablixMember>
                      <Visibility>
                        <Hidden>=iif((not Fields!BinMandatory.Value) and (not Fields!InvtPutAway.Value),false,true)</Hidden>
                      </Visibility>
                      <KeepWithGroup>After</KeepWithGroup>
                      <KeepTogether>true</KeepTogether>
                    </TablixMember>
                    ...
                    <TablixMember>
                      <Visibility>
                        <Hidden>=iif(Fields!BinMandatory.Value and (not Fields!InvtPutAway.Value),false,true)</Hidden>
                      </Visibility>
                      <KeepWithGroup>After</KeepWithGroup>
                      <KeepTogether>true</KeepTogether>
                    </TablixMember>
                    ...
                    <TablixMember>
                      <Visibility>
                        <Hidden>=iif(Fields!BinMandatory.Value and Fields!InvtPutAway.Value,false,true)</Hidden>
                      </Visibility>
                      <KeepWithGroup>After</KeepWithGroup>
                      <KeepTogether>true</KeepTogether>
                    </TablixMember>
                    <TablixMember>
                      <Visibility>
                        <Hidden>=iif((not Fields!BinMandatory.Value) and Fields!InvtPutAway.Value,false,true)</Hidden>
                      </Visibility>
                      <KeepWithGroup>After</KeepWithGroup>
                      <KeepTogether>true</KeepTogether>
                    </TablixMember>
                    ...
                    <TablixMember>
                      <Group Name="table2_Group1">
                        <GroupExpressions>
                          <GroupExpression>=Fields!SrcNo_WhseActivLine.Value</GroupExpression>
                          <GroupExpression>=Fields!ShelfNo_WhseActivLine.Value</GroupExpression>
                          <GroupExpression>=Fields!ItemNo1_WhseActivLine.Value</GroupExpression>
                          <GroupExpression>=Fields!DueDate_WhseActivLine.Value</GroupExpression>
                          <GroupExpression>=Fields!BinCode_WhseActivLine.Value</GroupExpression>
                          <GroupExpression>=Fields!BinRanking_WhseActivLine.Value</GroupExpression>
                        </GroupExpressions>
                      </Group>
                      <TablixMembers>
                        <TablixMember>
                          ...
                          <TablixMembers>
                            <TablixMember>
                              <Visibility>
                                <Hidden>=iif((not Fields!BinMandatory.Value) and (not Fields!InvtPutAway.Value),false,true)
or iif(Fields!LineNo1_WhseActivLine.Value=previous(Fields!LineNo1_WhseActivLine.Value) 
and Fields!No1_WhseActivHeader.Value=previous(Fields!No1_WhseActivHeader.Value),true,false)</Hidden>
                              </Visibility>
                            </TablixMember>
                            <TablixMember>
                              <Visibility>
...
and Fields!No1_WhseActivHeader.Value=previous(Fields!No1_WhseActivHeader.Value),true,false)</Hidden>
                            ...
                            <TablixMember>
                              <Visibility>
                                <Hidden>=iif(Fields!BinMandatory.Value and (not Fields!InvtPutAway.Value),false,true)
or iif(Fields!LineNo1_WhseActivLine.Value=previous(Fields!LineNo1_WhseActivLine.Value) 
and Fields!No1_WhseActivHeader.Value=previous(Fields!No1_WhseActivHeader.Value),true,false)</Hidden>
                              </Visibility>
                            </TablixMember>
...
and Fields!No1_WhseActivHeader.Value=previous(Fields!No1_WhseActivHeader.Value),true,false)</Hidden>
                            ...
                            <TablixMember>
                              <Visibility>
                                <Hidden>=iif((Fields!BinMandatory.Value and Fields!InvtPutAway.Value),false,true)
or iif(Fields!LineNo1_WhseActivLine.Value=previous(Fields!LineNo1_WhseActivLine.Value) 
and Fields!No1_WhseActivHeader.Value=previous(Fields!No1_WhseActivHeader.Value),true,false)</Hidden>
                              </Visibility>
                            </TablixMember>
                            <TablixMember>
                              <Visibility>
                                <Hidden>=iif((not Fields!BinMandatory.Value) and Fields!InvtPutAway.Value,false,true)
or iif(Fields!LineNo1_WhseActivLine.Value=previous(Fields!LineNo1_WhseActivLine.Value) 
and Fields!No1_WhseActivHeader.Value=previous(Fields!No1_WhseActivHeader.Value),true,false)</Hidden>
                              </Visibility>
                            </TablixMember>
...
and (Fields!LotNo1_WhseActivLine.Value &lt;&gt; "") 
...
and (Fields!LotNo1_WhseActivLine.Value &lt;&gt; "") 
and (Fields!SerialNo_WhseActivLine.Value &lt;&gt; ""),false,true)
or iif(Fields!LineNo_WhseActivLine.Value=previous(Fields!LineNo_WhseActivLine.Value) 
and Fields!No1_WhseActivHeader.Value=previous(Fields!No1_WhseActivHeader.Value),true,false)</Hidden>
                              </Visibility>
                            </TablixMember>
                            <TablixMember>
...
and Fields!No1_WhseActivHeader.Value=previous(Fields!No1_WhseActivHeader.Value),true,false)</Hidden>
      ...
      <Page>
        <PageHeader>
          ...
          <ReportItems>
            <Textbox Name="PutawayListCaption1">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
                    <TextRun>
                      <Value>=First(Fields!PutawayListCaption.Value, "DataSet_Result")</Value>
                      <Style>
                        <FontSize>9pt</FontSize>
                        <FontWeight>Bold</FontWeight>
                      </Style>
  ...
  <ReportParameters>
    ...
    <ReportParameter Name="AssgndUID_WhseActivHeaderCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>AssgndUID_WhseActivHeaderCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>AssgndUID_WhseActivHeaderCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="SortingMthd_WhseActivHeaderCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>SortingMthd_WhseActivHeaderCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>SortingMthd_WhseActivHeaderCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="SrcDoc_WhseActivHeaderCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>SrcDoc_WhseActivHeaderCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>SrcDoc_WhseActivHeaderCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="ZoneCode_WhseActivLineCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>ZoneCode_WhseActivLineCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>ZoneCode_WhseActivLineCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="BinCode_WhseActivLineCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>BinCode_WhseActivLineCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>BinCode_WhseActivLineCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="ActionType_WhseActivLineCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>ActionType_WhseActivLineCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>ActionType_WhseActivLineCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="LotNo1_WhseActivLineCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>LotNo1_WhseActivLineCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>LotNo1_WhseActivLineCaption</Prompt>
    </ReportParameter>
    ...
    <ReportParameter Name="WhseActLineItemNoCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>WhseActLineItemNoCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>WhseActLineItemNoCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="WhseActLineDescriptionCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>WhseActLineDescriptionCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>WhseActLineDescriptionCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="WhseActLineVariantCodeCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>WhseActLineVariantCodeCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>WhseActLineVariantCodeCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="WhseActLineCrossDockInformationCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>WhseActLineCrossDockInformationCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>WhseActLineCrossDockInformationCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="WhseActLineShelfNoCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>WhseActLineShelfNoCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>WhseActLineShelfNoCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="WhseActLineQtyBaseCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>WhseActLineQtyBaseCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>WhseActLineQtyBaseCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="WhseActLineQtytoHandleCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>WhseActLineQtytoHandleCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>WhseActLineQtytoHandleCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="WhseActLineUnitofMeasureCodeCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>WhseActLineUnitofMeasureCodeCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>WhseActLineUnitofMeasureCodeCaption</Prompt>
    </ReportParameter>
    <ReportParameter Name="WhseActLineSourceNoCaption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>WhseActLineSourceNoCaption</Value>
        </Values>
      </DefaultValue>
      <Prompt>WhseActLineSourceNoCaption</Prompt>
    </ReportParameter>
  </ReportParameters>
    ...
    <GridLayoutDefinition>
      ...
      <CellDefinitions>
        ...
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>2</RowIndex>
          <ParameterName>AssgndUID_WhseActivHeaderCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>3</RowIndex>
          <ParameterName>SortingMthd_WhseActivHeaderCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>4</RowIndex>
          <ParameterName>SrcDoc_WhseActivHeaderCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>5</RowIndex>
          <ParameterName>ZoneCode_WhseActivLineCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>6</RowIndex>
          <ParameterName>BinCode_WhseActivLineCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>7</RowIndex>
          <ParameterName>ActionType_WhseActivLineCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>8</RowIndex>
          <ParameterName>LotNo1_WhseActivLineCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>9</RowIndex>
        ...
        <CellDefinition>
          ...
          <ParameterName>WhseActLineItemNoCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>11</RowIndex>
          <ParameterName>WhseActLineDescriptionCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>12</RowIndex>
          <ParameterName>WhseActLineVariantCodeCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>13</RowIndex>
          <ParameterName>WhseActLineCrossDockInformationCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>14</RowIndex>
          <ParameterName>WhseActLineShelfNoCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>15</RowIndex>
          <ParameterName>WhseActLineQtyBaseCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>16</RowIndex>
          <ParameterName>WhseActLineQtytoHandleCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>17</RowIndex>
          <ParameterName>WhseActLineUnitofMeasureCodeCaption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>18</RowIndex>
          <ParameterName>WhseActLineSourceNoCaption</ParameterName>
        </CellDefinition>
      </CellDefinitions>
    </GridLayoutDefinition>
  </ReportParametersLayout>
...
End Function
  ...
  <rd:ReportID>c9cdb135-3134-4625-a7a9-42288af6e819</rd:ReportID>
</Report>
    END_OF_RDLDATA
  }
}
