OBJECT Report 5186 Remove Contacts
{
  ...
  DATASET
  {
    ...
    { 6043;3   ;DataItem;                    ;
               ...
               ReqFilterHeadingML=[DAN=Mailgruppe;
                                   ENU=Mailing Group];
               OnPreDataItem=BEGIN
                               IF ContactOK AND (GETFILTERS <> '') THEN
                                 ContactOK := FALSE
    ...
    { 6030;3   ;DataItem;                    ;
               ...
               ReqFilterHeadingML=[DAN=Ansvarsomr†de;
    ...
    { 4008;3   ;DataItem;                    ;
               ...
               ReqFilterHeadingML=[DAN=Branche;
                                   ENU=Industry Group];
               OnPreDataItem=BEGIN
                               IF ContactOK AND (GETFILTERS <> '') THEN
                                 ContactOK := FALSE
    ...
    { 8768;3   ;DataItem;                    ;
               ...
               ReqFilterHeadingML=[DAN=Forretningsrelation;
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Fjerner kontakter @1@@@@@@@@@@@@@;ENU=Reducing Contacts @1@@@@@@@@@@@@@';
      Text001@1001 : TextConst 'DAN=Opd. kontakter    @1@@@@@@@@@@@@@;ENU=Refining Contacts @1@@@@@@@@@@@@@';
