OBJECT Report 5300 Outlook Synch. Change Log Set.
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Ops‘tning af ‘ndringslog for Outlook-synkronisering;
  ...
  CODE
  {
    VAR
      ...
      Text001@1002 : TextConst 'DAN=Relationen mellem tabellen %1 og tabellen %2 i enheden %3 kan ikke bestemmes. Kontroller synkroniseringsindstillingerne for denne enhed.;ENU=The relation between the %1 table and %2 table in the %3 entity cannot be determined. Please verify your synchronization settings for this entity.';
      Text002@1001 : TextConst 'DAN=’ndringslogindstillingerne er registreret. Du skal lukke og derefter †bne firmaet igen, f›r de nye ‘ndringslogindstillinger tr‘der i kraft.;ENU=The change log settings have been registered successfully. You must close and reopen the company for the new change log settings to take effect.';
      Text003@1003 : TextConst 'DAN=’ndringslogindstillingerne er registreret.;ENU=The change log settings have been registered successfully.';
      Text004@1005 : TextConst 'DAN=Enheden blev ikke fundet. Kontroll‚r, at du har skrevet navnet korrekt.;ENU=The entity cannot be found. Make sure that you have typed its name correctly.';
      Text005@1006 : TextConst 'DAN=Relationen mellem tabellen %1 og tabellen %2 i samlingen %3 fra enheden %4 kan ikke bestemmes. Kontroll‚r synkroniseringsindstillingerne for denne enhed.;ENU=The relation between the %1 table and %2 table in the %3 collection from the %4 entity cannot be determined. Verify your synchronization settings for this entity.';
