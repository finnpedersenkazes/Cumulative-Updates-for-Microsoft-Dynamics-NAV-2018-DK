OBJECT Report 99001025 Refresh Production Order
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Opdater produktionsordre;
  ...
  REQUESTPAGE
  {
    ...
    CONTROLS
    {
      ...
      { 6   ;2   ;Field     ;
                  CaptionML=[DAN=Planl‘gningsretning;
                             ENU=Scheduling direction];
                  ToolTipML=[DAN=Angiver, om planl‘gningen skal opdateres fremad eller bagud.;
                             ENU=Specifies whether you want the scheduling to be refreshed forward or backward.];
                  OptionCaptionML=[DAN=Frem,Tilbage;
                                   ENU=Forward,Back];
      ...
      { 4   ;3   ;Field     ;
                  CaptionML=[DAN=Linjer;
                             ENU=Lines];
                  ToolTipML=[DAN=Angiver, om programmet skal beregne produktionsordrelinjerne.;
      ...
      { 13  ;3   ;Field     ;
                  CaptionML=[DAN=Ruter;
                             ENU=Routings];
                  ToolTipML=[DAN=Angiver, om programmet skal beregne ruten.;
      ...
      { 15  ;3   ;Field     ;
                  CaptionML=[DAN=Komponentbehov;
                             ENU=Component Need];
                  ToolTipML=[DAN=Angiver, om programmet skal beregne komponentbehovet.;
      ...
      { 18  ;3   ;Field     ;
                  CaptionML=[DAN=Opret indg†ende anmodning;
                             ENU=Create Inbound Request];
                  ToolTipML=[DAN=Angiver, om du vil oprette en indg†ende anmodning ved beregning og opdatering af en produktionsordre.;
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Opdaterer produktionsordrer...\\;ENU=Refreshing Production Orders...\\';
      Text001@1001 : TextConst 'DAN=Status         #1##########\;ENU=Status         #1##########\';
      Text002@1002 : TextConst 'DAN=Nr.            #2##########;ENU=No.            #2##########';
      Text003@1003 : TextConst 'DAN=Ruter skal beregnes, n†r linjer beregnes.;ENU=Routings must be calculated, when lines are calculated.';
      Text004@1004 : TextConst 'DAN=Komponentbehov skal beregnes, n†r linjer beregnes.;ENU=Component Need must be calculated, when lines are calculated.';
      ...
      Text005@1014 : TextConst 'DAN=En eller flere linjer i denne %1 kr‘ver s‘rlig lagerekspedition. %2 for disse linjer er tomme.;ENU=One or more of the lines on this %1 require special warehouse handling. The %2 for these lines has been set to blank.';
      DeletePickedLinesQst@1016 : TextConst '@@@=Production order no.: Components for production order 101001 have already been picked. Do you want to continue?;DAN=Der er allerede plukket komponenter til produktionsordren %1. Vil du forts‘tte?;ENU=Components for production order %1 have already been picked. Do you want to continue?';
