OBJECT Report 6036 Create Contract Service Orders
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Opret kontraktserviceordrer;
    ...
    CONTROLS
    {
      ...
      { 5   ;2   ;Field     ;
                  ...
                  CaptionML=[DAN=Startdato;
                             ENU=Starting Date];
                  ToolTipML=[DAN=Angiver startdatoen i den periode, du vil oprette kontraktserviceordrer for. K›rslen omfatter kontrakter, hvor n‘ste planlagte servicedato er p† eller efter denne dato.;
      ...
      { 1   ;2   ;Field     ;
                  ...
                  CaptionML=[DAN=Slutdato;
                             ENU=Ending Date];
                  ToolTipML=[DAN=Angiver slutdatoen i den periode, du vil oprette kontraktserviceordrer for. K›rslen omfatter kontrakter, hvor n‘ste planlagte servicedato er p† eller f›r denne dato.;
      ...
      { 8   ;2   ;Field     ;
                  ...
                  CaptionML=[DAN=Handling;
                             ENU=Action];
                  ToolTipML=[DAN=Angiver den ›nskede handling til kontraktserviceordrer.;
                             ENU=Specifies the desired action relating to contract service orders.];
                  OptionCaptionML=[DAN=Opret serviceordre,Kun udskrift;
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Der er blevet oprettet %1 serviceordrer.;ENU=%1 service orders were created.';
      Text001@1001 : TextConst 'DAN=Der er blevet oprette %1 serviceordre.;ENU=%1 service order was created.';
      Text002@1002 : TextConst 'DAN=Feltet Slutdato skal udfyldes.;ENU=You must fill in the ending date field.';
      Text003@1003 : TextConst 'DAN=Startdatoen ligger efter slutdatoen.;ENU=The starting date is after the ending date.';
      Text004@1004 : TextConst 'DAN=Det datointerval, du har angivet, er l‘ngere end den periode, der er tilladt i tabellen %1.;ENU=The date range you have entered is a longer period than is allowed in the %1 table.';
      ...
      Text005@1009 : TextConst 'DAN=Der kan ikke oprettes en serviceordre for kontraktnr. %1, da debitornr.. %2 ikke har %3.;ENU=A service order cannot be created for contract no. %1 because customer no. %2 does not have a %3.';
