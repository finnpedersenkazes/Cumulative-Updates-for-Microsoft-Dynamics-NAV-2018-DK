OBJECT Report 321 Vendor - Balance to Date
{
  OBJECT-PROPERTIES
  {
    Date=27-07-18;
  ...
  DATASET
  {
    ...
    { 1   ;1   ;Column  ;VendorBalancetoDateCptn;
               SourceExpr=VendorBalancetoDateCptnLbl }
    ...
    { 29  ;1   ;Column  ;PostingDateCption   ;
               SourceExpr=PostingDateCptionLbl }

    { 45  ;1   ;Column  ;OriginalAmtCaption  ;
               SourceExpr=OriginalAmtCaptionLbl }

    { 6920;1   ;DataItem;VendLedgEntry3      ;
               DataItemTable=Table25;
               DataItemTableView=SORTING(Entry No.);
               OnPreDataItem=VAR
                               TempVendorLedgerEntry@1000 : TEMPORARY Record 25;
    ...
    { 28  ;2   ;Column  ;PostDt_VendLedgEntry3;
               SourceExpr=FORMAT("Posting Date") }

    { 32  ;2   ;Column  ;DocType_VendLedgEntry3;
               IncludeCaption=Yes;
               SourceExpr="Document Type" }

    { 34  ;2   ;Column  ;DocNo_VendLedgEntry3;
               IncludeCaption=Yes;
               SourceExpr="Document No." }

    { 36  ;2   ;Column  ;Desc_VendLedgEntry3 ;
               IncludeCaption=Yes;
    ...
    { 54  ;2   ;Column  ;EntryNo_VendLedgEntry3;
               IncludeCaption=Yes;
               SourceExpr="Entry No." }
    ...
    { 42  ;3   ;Column  ;EntryTp_DtldVendLedgEntry;
               SourceExpr="Entry Type" }

    { 46  ;3   ;Column  ;PostDate_DtldVendLedEnt;
               SourceExpr=FORMAT("Posting Date") }

    { 48  ;3   ;Column  ;DocType_DtldVendLedEnt;
               SourceExpr="Document Type" }

    { 50  ;3   ;Column  ;DocNo_DtldVendLedgEntry;
               SourceExpr="Document No." }
    ...
    { 56  ;3   ;Column  ;CurrencyCode1       ;
               SourceExpr=CurrencyCode }

    { 14  ;3   ;Column  ;DtldVendtLedgEntryNum;
               SourceExpr=DtldVendtLedgEntryNum }
    ...
    { 12  ;1   ;Column  ;CurrTotalBuffer2CurrCode;
               SourceExpr=CurrencyTotalBuffer2."Currency Code" }

    { 19  ;1   ;Column  ;CurrTotalBuffer2TotalAmt;
  ...
  REQUESTPAGE
  {
    ...
    CONTROLS
    {
      ...
      { 2   ;2   ;Field     ;
                  ...
                  ToolTipML=[DAN=Angiver, at du vil udskrive hvert kreditorbel›b p† en ny side, hvis du har valgt to eller flere kreditorer, der skal med i rapporten.;
                             ENU=Specifies that you want to print each vendor balance on a separate page, if you have chosen two or more vendors to be included in the report.];
                  ApplicationArea=#Suite;
                  SourceExpr=PrintOnePrPage }
  ...
  CODE
  {
    VAR
      ...
      VendFilter@1007 : Text;
      MaxDate@1009 : Date;
      OriginalAmt@1010 : Decimal;
      Amt@1011 : Decimal;
      RemainingAmt@1012 : Decimal;
      Counter1@1013 : Integer;
      DtldVendtLedgEntryNum@1008 : Integer;
      OK@1014 : Boolean;
      CurrencyCode@1015 : Code[10];
      PrintUnappliedEntries@1016 : Boolean;
      ShowEntriesWithZeroBalance@1004 : Boolean;
      VendorBalancetoDateCptnLbl@9082 : TextConst 'DAN=Kreditor - saldo til dato;ENU=Vendor - Balance to Date';
      ...
      PostingDateCptionLbl@6194 : TextConst 'DAN=Bogf›ringsdato;ENU=Posting Date';
      OriginalAmtCaptionLbl@8860 : TextConst 'DAN=Bel›b;ENU=Amount';
      TotalCaptionLbl@1909 : TextConst 'DAN=I alt;ENU=Total';

    PROCEDURE InitializeRequest@1(NewPrintAmountInLCY@1000 : Boolean;NewPrintOnePrPage@1001 : Boolean;NewPrintUnappliedEntries@1002 : Boolean);
    BEGIN
    ...
    LOCAL PROCEDURE FilterVendorLedgerEntry@5(VAR VendorLedgerEntry@1000 : Record 25);
    BEGIN
    ...
    LOCAL PROCEDURE AddVendorDimensionFilter@3(VAR VendorLedgerEntry@1000 : Record 25);
    BEGIN
      WITH VendorLedgerEntry DO BEGIN
    ...
    LOCAL PROCEDURE CalcTotalVendorAmount@10(VAR TempVendorLedgerEntry@1001 : TEMPORARY Record 25);
    BEGIN
    ...
    LOCAL PROCEDURE CheckVendEntryIncluded@8(EntryNo@1000 : Integer) : Boolean;
    VAR
...
<Report xmlns="http://schemas.microsoft.com/sqlserver/reporting/2016/01/reportdefinition" xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner">
  ...
  <DataSources>
    <DataSource Name="DataSource">
      ...
      <rd:DataSourceID>b1ae6499-0a45-40cd-9987-9dd826a2a750</rd:DataSourceID>
    </DataSource>
  </DataSources>
  <DataSets>
    <DataSet Name="DataSet_Result">
      ...
      <Fields>
        <Field Name="StrNoVenGetMaxDtFilter">
          <DataField>StrNoVenGetMaxDtFilter</DataField>
        </Field>
        ...
        <Field Name="VendorBalancetoDateCptn">
          <DataField>VendorBalancetoDateCptn</DataField>
        </Field>
        ...
        <Field Name="PostingDateCption">
          <DataField>PostingDateCption</DataField>
        </Field>
        <Field Name="OriginalAmtCaption">
          <DataField>OriginalAmtCaption</DataField>
        </Field>
        <Field Name="PostDt_VendLedgEntry3">
          <DataField>PostDt_VendLedgEntry3</DataField>
        </Field>
        <Field Name="DocType_VendLedgEntry3">
          <DataField>DocType_VendLedgEntry3</DataField>
        </Field>
        <Field Name="DocNo_VendLedgEntry3">
          <DataField>DocNo_VendLedgEntry3</DataField>
        </Field>
        <Field Name="Desc_VendLedgEntry3">
          <DataField>Desc_VendLedgEntry3</DataField>
        </Field>
        ...
        <Field Name="EntryNo_VendLedgEntry3">
          <DataField>EntryNo_VendLedgEntry3</DataField>
        </Field>
        <Field Name="CurrencyCode">
          <DataField>CurrencyCode</DataField>
        </Field>
        <Field Name="EntryTp_DtldVendLedgEntry">
          <DataField>EntryTp_DtldVendLedgEntry</DataField>
        </Field>
        <Field Name="PostDate_DtldVendLedEnt">
          <DataField>PostDate_DtldVendLedEnt</DataField>
        </Field>
        <Field Name="DocType_DtldVendLedEnt">
          <DataField>DocType_DtldVendLedEnt</DataField>
        </Field>
        <Field Name="DocNo_DtldVendLedgEntry">
          <DataField>DocNo_DtldVendLedgEntry</DataField>
        </Field>
        <Field Name="Amt">
        ...
        <Field Name="DtldVendtLedgEntryNum">
          <DataField>DtldVendtLedgEntryNum</DataField>
        </Field>
        ...
        <Field Name="Name1_Vendor">
          <DataField>Name1_Vendor</DataField>
        </Field>
        <Field Name="CurrTotalBufferTotalAmt">
          <DataField>CurrTotalBufferTotalAmt</DataField>
        </Field>
        <Field Name="CurrTotalBufferTotalAmtFormat">
          <DataField>CurrTotalBufferTotalAmtFormat</DataField>
        </Field>
        <Field Name="CurrTotalBufferCurrCode">
          <DataField>CurrTotalBufferCurrCode</DataField>
        </Field>
        <Field Name="CurrTotalBuffer2CurrCode">
          <DataField>CurrTotalBuffer2CurrCode</DataField>
        </Field>
        <Field Name="CurrTotalBuffer2TotalAmt">
          <DataField>CurrTotalBuffer2TotalAmt</DataField>
        </Field>
        <Field Name="CurrTotalBuffer2TotalAmtFormat">
          <DataField>CurrTotalBuffer2TotalAmtFormat</DataField>
        </Field>
              ...
              <TablixRows>
                <TablixRow>
                  ...
                  <TablixCells>
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="VendLedgEntry3PostingDateCaption">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=First(Fields!PostingDateCption.Value)</Value>
                                  <Style>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="VendLedgEntry3DocumentTypeCaption">
                          <CanGrow>true</CanGrow>
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!DocType_VendLedgEntry3Caption.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="VendLedgEntry3DocumentNoCaption">
                          <CanGrow>true</CanGrow>
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!DocNo_VendLedgEntry3Caption.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="VendLedgEntry3DescriptionCaption">
                          <CanGrow>true</CanGrow>
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!Desc_VendLedgEntry3Caption.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="VendLedgEntry3EntryNoCaption">
                          <CanGrow>true</CanGrow>
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Parameters!EntryNo_VendLedgEntry3Caption.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                ...
                <TablixRow>
                  ...
                  <TablixCells>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="VendorPhoneNoCaption">
                          <CanGrow>true</CanGrow>
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                ...
                <TablixRow>
                  ...
                  <TablixCells>
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="VendLedgEntry3PostingDate">
                          <CanGrow>true</CanGrow>
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!PostDt_VendLedgEntry3.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                    <Format>d</Format>
                                  </Style>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="VendLedgEntry3DocumentType">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!DocType_VendLedgEntry3.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                  </Style>
                                </TextRun>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="VendLedgEntry3DocumentNo">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!DocNo_VendLedgEntry3.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                  </Style>
                                </TextRun>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="VendLedgEntry3Description">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!Desc_VendLedgEntry3.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                  </Style>
                                </TextRun>
                    ...
                    <TablixCell>
                      <CellContents>
                        <Textbox Name="VendLedgEntry3EntryNo">
                          <KeepTogether>true</KeepTogether>
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!EntryNo_VendLedgEntry3.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="textbox92">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!PostDate_DtldVendLedEnt.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                    <Format>d</Format>
                                  </Style>
                        ...
                        <Textbox Name="textbox93">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!DocType_DtldVendLedEnt.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="textbox94">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!DocNo_DtldVendLedgEntry.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="textbox95">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!EntryTp_DtldVendLedgEntry.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="textbox96">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!CurrencyCode1.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                  </Style>
                                </TextRun>
                        ...
                        <Textbox Name="textbox151">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!Name1_Vendor.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox154">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!CurrTotalBufferCurrCode.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox155">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!CurrTotalBufferTotalAmt.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                    <Format>=Fields!CurrTotalBufferTotalAmtFormat.Value</Format>
                                  </Style>
                                </TextRun>
                              </TextRuns>
                              <Style />
                        ...
                        <Textbox Name="textbox188">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!CurrTotalBuffer2CurrCode.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                  </Style>
                        ...
                        <Textbox Name="textbox189">
                          ...
                          <Paragraphs>
                            <Paragraph>
                              <TextRuns>
                                <TextRun>
                                  <Value>=Fields!CurrTotalBuffer2TotalAmt.Value</Value>
                                  <Style>
                                    <FontSize>7pt</FontSize>
                                    <FontWeight>Bold</FontWeight>
                                    <Format>=Fields!CurrTotalBuffer2TotalAmtFormat.Value</Format>
                                  </Style>
                                </TextRun>
                              </TextRuns>
                              <Style />
              ...
              <TablixMembers>
                ...
                <TablixMember>
                  ...
                  <TablixMembers>
                    <TablixMember>
                      <Visibility>
                        <Hidden>=iif(Fields!No_Vendor.Value="",true,false)</Hidden>
                      </Visibility>
                      <KeepWithGroup>After</KeepWithGroup>
                      <KeepTogether>true</KeepTogether>
                    </TablixMember>
                    ...
                    <TablixMember>
                      <Group Name="Table1_Group2">
                        <GroupExpressions>
                          <GroupExpression>=Fields!EntryNo_VendLedgEntry3.Value</GroupExpression>
                        </GroupExpressions>
                      </Group>
                      <TablixMembers>
                        <TablixMember>
                          ...
                          <TablixMembers>
                            <TablixMember>
                              <Visibility>
                                <Hidden>=iif(Fields!DocNo_VendLedgEntry3.Value="",true,false) or
 iif(Fields!DocNo_DtldVendLedgEntry.Value&lt;&gt;"",true,false) or
 iif(Fields!No_Vendor.Value="",true,false)</Hidden>
                              </Visibility>
                            </TablixMember>
                            <TablixMember>
                              <Visibility>
 ...
 iif(Fields!No_Vendor.Value="",true,false)</Hidden>
                            ...
                            <TablixMember>
                              <Visibility>
                                <Hidden>=iif(Fields!DtldVendtLedgEntryNum.Value=1,false,true) or
 iif(Fields!No_Vendor.Value="",true,false)</Hidden>
                              </Visibility>
                            </TablixMember>
                            <TablixMember>
                              <Visibility>
                                <Hidden>=iif(Fields!DocNo_DtldVendLedgEntry.Value="",true,false) or
 iif(Fields!No_Vendor.Value="",true,false)</Hidden>
                              </Visibility>
                            </TablixMember>
                            <TablixMember>
                              <Visibility>
                                <Hidden>=iif(Fields!Name1_Vendor.Value="",true,false) or
 iif(Fields!No_Vendor.Value="",true,false)</Hidden>
                              </Visibility>
                            </TablixMember>
                            <TablixMember>
 ...
 iif(Fields!No_Vendor.Value="",true,false)</Hidden>
            ...
            <Height>6.34515cm</Height>
            <Width>17.07909cm</Width>
            <Visibility>
              <Hidden>=iif(First(Fields!PrintOnePrPage.Value,"DataSet_Result")=true,true,false)</Hidden>
            </Visibility>
            <DataElementOutput>Output</DataElementOutput>
            <Style />
          </Tablix>
 ...
 iif(Fields!No_Vendor.Value="",true,false)</Hidden>
            ...
            <ZIndex>1</ZIndex>
            <Visibility>
              <Hidden>=iif(First(Fields!PrintOnePrPage.Value,"DataSet_Result")=false,true,false)</Hidden>
            </Visibility>
      ...
      <Page>
        <PageHeader>
          <Height>3.20988cm</Height>
          <PrintOnFirstPage>true</PrintOnFirstPage>
          <PrintOnLastPage>true</PrintOnLastPage>
          <ReportItems>
            <Textbox Name="AllamountsareinLCYCaption18">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
              ...
              <Width>7.5cm</Width>
              <Visibility>
                <Hidden>=iif(First(Fields!PrintAmountInLCY.Value, "DataSet_Result")=false,true,false)</Hidden>
              </Visibility>
              <DataElementOutput>NoOutput</DataElementOutput>
              <Style>
                <Border />
            ...
            <Textbox Name="VendorTABLECAPTIONVendFilter17">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
                    <TextRun>
                      <Value>=First(Fields!VendorCaption.Value,"DataSet_Result")</Value>
                      <Style>
                        <FontSize>7pt</FontSize>
                      </Style>
                    </TextRun>
              ...
              <ZIndex>1</ZIndex>
              <Visibility>
                <Hidden>=iif(First(Fields!VendFilter.Value,"DataSet_Result")="",true,false) or
 iif(Globals!PageNumber&lt;&gt;1,true,false)</Hidden>
            ...
            <Textbox Name="VendorBalancetoDateCaption15">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
                    <TextRun>
                      <Value>=First(Fields!VendorBalancetoDateCptn.Value, "DataSet_Result")</Value>
                      <Style>
            ...
            <Textbox Name="STRSUBSTNOText000FORMATVendorGETRANGEMAXDateFilter13">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
                    <TextRun>
                      <Value>=First(Fields!StrNoVenGetMaxDtFilter.Value,"DataSet_Result")</Value>
                      <Style>
                        <FontSize>7pt</FontSize>
                      </Style>
                    </TextRun>
            ...
            <Textbox Name="ExecutionTimeTextBox">
              ...
              <Top>0.01389in</Top>
              <Left>14.06825cm</Left>
              <Height>0.423cm</Height>
              <Width>4.18175cm</Width>
              <ZIndex>6</ZIndex>
              <Style>
                <VerticalAlign>Middle</VerticalAlign>
              </Style>
  ...
  <ReportParameters>
    ...
    <ReportParameter Name="DocType_VendLedgEntry3Caption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>DocType_VendLedgEntry3Caption</Value>
        </Values>
      </DefaultValue>
      <Prompt>DocType_VendLedgEntry3Caption</Prompt>
    </ReportParameter>
    <ReportParameter Name="DocNo_VendLedgEntry3Caption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>DocNo_VendLedgEntry3Caption</Value>
        </Values>
      </DefaultValue>
      <Prompt>DocNo_VendLedgEntry3Caption</Prompt>
    </ReportParameter>
    <ReportParameter Name="Desc_VendLedgEntry3Caption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>Desc_VendLedgEntry3Caption</Value>
        </Values>
      </DefaultValue>
      <Prompt>Desc_VendLedgEntry3Caption</Prompt>
    </ReportParameter>
    <ReportParameter Name="EntryNo_VendLedgEntry3Caption">
      <DataType>String</DataType>
      <DefaultValue>
        <Values>
          <Value>EntryNo_VendLedgEntry3Caption</Value>
        </Values>
      </DefaultValue>
      <Prompt>EntryNo_VendLedgEntry3Caption</Prompt>
    </ReportParameter>
  </ReportParameters>
    ...
    <GridLayoutDefinition>
      ...
      <CellDefinitions>
        ...
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>1</RowIndex>
          <ParameterName>DocType_VendLedgEntry3Caption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>2</RowIndex>
          <ParameterName>DocNo_VendLedgEntry3Caption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>3</RowIndex>
          <ParameterName>Desc_VendLedgEntry3Caption</ParameterName>
        </CellDefinition>
        <CellDefinition>
          <ColumnIndex>0</ColumnIndex>
          <RowIndex>4</RowIndex>
          <ParameterName>EntryNo_VendLedgEntry3Caption</ParameterName>
        </CellDefinition>
      </CellDefinitions>
    </GridLayoutDefinition>
  </ReportParametersLayout>
...
End Function
  ...
  <rd:ReportID>3117bd0b-572e-4b35-9be9-76e02b859f5d</rd:ReportID>
</Report>
    END_OF_RDLDATA
  }
}
