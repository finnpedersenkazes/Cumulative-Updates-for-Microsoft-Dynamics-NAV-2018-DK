OBJECT Report 120 Aged Accounts Receivable
{
    ...
    CONTROLS
    {
      ...
      { 11  ;2   ;Field     ;
                  ...
                  CaptionML=[DAN=Udskriv detaljer;
                             ENU=Print Details];
                  ToolTipML=[DAN=Angiver, om rapporten skal vise detaljerede poster, der udgõr den totale saldo for hver debitor.;
      ...
      { 13  ;2   ;Field     ;
                  ...
                  ToolTipML=[DAN=Angiver, om oplysninger om hver enkelt debitor udskrives pÜ en ny side, hvis du har valgt to eller flere debitorer, der skal medtages i rapporten.;
  ...
  CODE
  {
    VAR
      ...
      Text010@1032 : TextConst 'DAN=Datoformlen %1 er ugyldig. Prõv at omformulere den. Skriv f.eks. 1M+LM i stedet for LM+1M.;ENU=The Date Formula %1 cannot be used. Try to restate it. E.g. 1M+CM instead of CM+1M.';
      ...
      AllAmtinLCYCptnLbl@8265 : TextConst 'DAN=Alle belõb i RV;ENU=All Amounts in LCY';
      AgedOverdueAmtCptnLbl@2837 : TextConst 'DAN=Aldersfordelte forfaldne belõb;ENU=Aged Overdue Amounts';
      CLEEndDateAmtLCYCptnLbl@3633 : TextConst 'DAN=Oprindeligt belõb;ENU="Original Amount "';
      ...
      CLEEndDatePstngDateCptnLbl@4115 : TextConst 'DAN=Bogfõringsdato;ENU=Posting Date';
