OBJECT Report 790 Calculate Inventory
{
  ...
  REQUESTPAGE
  {
    ...
    CONTROLS
    {
      ...
      { 11  ;2   ;Field     ;
                  ...
                  CaptionML=[DAN=Varer ikke p† lager.;
                             ENU=Items Not on Inventory.];
                  ToolTipML=[DAN=Angiver, om der skal oprettes kladdelinjer for varer, der ikke findes p† lager, dvs. varer, hvor v‘rdien i feltet Antal (beregnet) er 0.;
      ...
      { 2   ;2   ;Field     ;
                  ...
                  CaptionML=[DAN=Medtag vare uden transaktioner;
                             ENU=Include Item without Transactions];
                  ToolTipML=[DAN=Angiver, om der skal oprettes kladdelinjer for varer, der ikke findes p† lager, og som ikke er brugt i nogen transaktioner.;
  ...
  CODE
  {
    VAR
      ...
      Text002@1002 : TextConst 'DAN=Varerne gennemg†s   #1##########;ENU=Processing items    #1##########';
      Text003@1003 : TextConst 'DAN=Bevar dimensioner;ENU=Retain Dimensions';
      ...
      PosQty@1031 : Decimal;
      NegQty@1032 : Decimal;
      Text004@1025 : TextConst 'DAN=Du kan ikke filtrere dimensioner, hvis du beregner lokationer med %1 er %2.;ENU=You must not filter on dimensions if you calculate locations with %1 is %2.';
      ItemNotOnInventoryErr@1034 : TextConst 'DAN=Varer ikke p† lager.;ENU=Items Not on Inventory.';
