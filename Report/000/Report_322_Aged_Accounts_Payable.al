OBJECT Report 322 Aged Accounts Payable
{
    ...
    CONTROLS
    {
      ...
      { 3   ;2   ;Field     ;
                  CaptionML=[DAN=Aldersfordelt efter;
                             ENU=Aging by];
                  ToolTipML=[DAN=Angiver, om aldersfordelingen skal beregnes ud fra forfaldsdatoen, bogfõringsdatoen eller dokumentdatoen.;
      ...
      { 11  ;2   ;Field     ;
                  CaptionML=[DAN=Udskriv detaljer;
                             ENU=Print Details];
                  ToolTipML=[DAN=Angiver, om rapporten skal vise detaljerede poster, der udgõr den totale saldo for hver kreditor.;
      ...
      { 13  ;2   ;Field     ;
                  ...
                  ToolTipML=[DAN=Angiver, om oplysninger om hver enkelt kreditor udskrives pÜ en ny side, hvis du har valgt to eller flere kreditorer, der skal medtages i rapporten.;
  ...
  CODE
  {
    VAR
      ...
      Text001@1008 : TextConst 'DAN=Fõr;ENU=Before';
      ...
      Text009@1031 : TextConst 'DAN=Forfaldsdato,Bogfõringsdato,Bilagsdato;ENU=Due Date,Posting Date,Document Date';
      Text010@1032 : TextConst 'DAN=Datoformlen %1 er ugyldig. Prõv at omformulere den ved f.eks. at skrive 1M+LM i stedet for LM+1M.;ENU=The Date Formula %1 cannot be used. Try to restate it, for example, by using 1M+CM instead of CM+1M.';
      PageGroupNo@1033 : Integer;
      EnterDateFormulaErr@1026 : TextConst 'DAN=Angiv en datoformel i feltet Periodelëngde.;ENU=Enter a date formula in the Period Length field.';
      Text027@1049 : TextConst '@@@=Negating the period length: %1 is the period length;DAN=-%1;ENU=-%1';
      AgedAcctPayableCaptionLbl@4917 : TextConst 'DAN=Aldersfordelt gëld;ENU=Aged Accounts Payable';
      CurrReportPageNoCaptionLbl@2595 : TextConst 'DAN=Side;ENU=Page';
      AllAmtsinLCYCaptionLbl@4956 : TextConst 'DAN=Alle belõb i RV;ENU=All Amounts in LCY';
      AgedOverdueAmsCaptionLbl@3975 : TextConst 'DAN=Aldersfordelte forfaldne belõb;ENU=Aged Overdue Amounts';
      GrandTotalVLE5RemAmtLCYCaptionLbl@4625 : TextConst 'DAN=Saldo;ENU=Balance';
      AmountLCYCaptionLbl@1831 : TextConst 'DAN=Oprindeligt belõb;ENU=Original Amount';
      ...
      PostingDateCaptionLbl@4591 : TextConst 'DAN=Bogfõringsdato;ENU=Posting Date';
