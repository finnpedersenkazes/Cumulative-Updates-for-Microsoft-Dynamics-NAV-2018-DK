OBJECT Report 98 Date Compress General Ledger
{
  ...
  PROPERTIES
  {
    ...
    CaptionML=[DAN=Datokomprimer finansposter;
               ENU=Date Compress General Ledger];
    ProcessingOnly=Yes;
    OnPreReport=BEGIN
    ...
    CONTROLS
    {
      ...
      { 3   ;2   ;Field     ;
                  CaptionML=[DAN=Periodelëngde;
                             ENU=Period Length];
                  ToolTipML=[DAN=Angiver den periode, der vises data for i rapporten. Angiv f.eks. "1M" for Çn mÜned, "30D" for 30 dage, "3K" for tre kvartaler eller "5è" for fem Ür.;
      ...
      { 4   ;2   ;Field     ;
                  CaptionML=[DAN=Bogfõringsbeskrivelse;
                             ENU=Posting Description];
                  ToolTipML=[DAN=Angiver en beskrivelse af de poster, der oprettes som fõlge af komprimeringen. Standardbeskrivelsen er Datokomprimeret.;
      ...
      { 5   ;3   ;Field     ;
                  CaptionML=[DAN=Bilagstype;
                             ENU=Document Type];
                  ToolTipML=[DAN=Angiver typen af det salgsdokument, der behandles af rapporten eller kõrslen.;
      ...
      { 6   ;3   ;Field     ;
                  CaptionML=[DAN=Bilagsnr.;
                             ENU=Document No.];
                  ToolTipML=[DAN=Angiver nummeret pÜ det salgsdokument, der behandles af rapporten eller kõrslen.;
      ...
      { 7   ;3   ;Field     ;
                  CaptionML=[DAN=Sagsnr.;
                             ENU=Job No.];
                  ToolTipML=[DAN=Angiver sagsnummer.;
      ...
      { 12  ;2   ;Field     ;
                  ...
                  ToolTipML=[DAN=Angiver, hvilke dimensionsoplysninger du vil bevare, nÜr posterne komprimeres. Jo flere dimensionsoplysninger du angiver, desto mere detaljerede er de komprimerede poster.;
      ...
      { 1907155901;2;Group  ;
                  CaptionML=[DAN=Bevar sum;
                             ENU=Retain Totals] }

      { 11  ;3   ;Field     ;
                  CaptionML=[DAN=Antal;
                             ENU=Quantity];
                  ToolTipML=[DAN=Angiver den varemëngde pÜ bogfõringsposterne, der skal datokomprimeres.;
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Under denne kõrsel slettes poster. Derfor er det vigtigt, at der oprettes en sikkerhedskopi af databasen, fõr kõrslen sëttes i gang.\\;ENU=This batch job deletes entries. Therefore, it is important that you make a backup of the database before you run the batch job.\\';
      Text002@1002 : TextConst 'DAN=Skal posterne datokomprimeres?;ENU=Do you want to date compress the entries?';
      Text003@1003 : TextConst 'DAN=%1 skal indtastes.;ENU=%1 must be specified.';
      Text004@1004 : TextConst 'DAN=Finansposter datokomprimeres...\\;ENU=Date compressing G/L entries...\\';
      Text005@1005 : TextConst 'DAN=Finanskontonr.       #1##########\;ENU=G/L Account No.      #1##########\';
      Text006@1006 : TextConst 'DAN=Dato                 #2######\\;ENU=Date                 #2######\\';
      Text007@1007 : TextConst 'DAN=Antal nye poster     #3######\;ENU=No. of new entries   #3######\';
      Text008@1008 : TextConst 'DAN=Antal slet. poster   #4######;ENU=No. of entries del.  #4######';
      Text009@1009 : TextConst 'DAN=Datokomprimeret;ENU=Date Compressed';
      Text010@1010 : TextConst 'DAN=Bevar dimensioner;ENU=Retain Dimensions';
