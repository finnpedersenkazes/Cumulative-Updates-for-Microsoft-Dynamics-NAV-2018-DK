OBJECT Report 88 VAT- VIES Declaration Disk
{
  ...
  CODE
  {
    VAR
      ...
      Text002@1002 : TextConst 'DAN=LISTE;ENU=LIST';
      ...
      Text004@1004 : TextConst 'DAN=Det er ikke muligt at vise %1 i et felt af l‘ngde %2.;ENU=It is not possible to display %1 in a field with a length of %2.';
