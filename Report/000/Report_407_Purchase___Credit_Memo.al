OBJECT Report 407 Purchase - Credit Memo
{
  OBJECT-PROPERTIES
  {
    Date=30-08-18;
  ...
  DATASET
  {
    { 9869;    ;DataItem;                    ;
               ...
               ReqFilterHeadingML=[DAN=Bogf›rt k›bskreditnota;
                                   ENU=Posted Purchase Cr. Memo];
    ...
    { 27  ;3   ;Column  ;PayVendNo_PurchCrMemoHdr;
               SourceExpr="Purch. Cr. Memo Hdr."."Pay-to Vendor No." }

    { 28  ;3   ;Column  ;DocDate_PurchCrMemoHdr;
               SourceExpr=FORMAT("Purch. Cr. Memo Hdr."."Document Date",0,4) }

    { 29  ;3   ;Column  ;VATNoText           ;
               SourceExpr=VATNoText }

    { 30  ;3   ;Column  ;VATRegNo_PurchCrMemoHdr;
    ...
    { 37  ;3   ;Column  ;YourRef_PurchCrMemoHdr;
               SourceExpr="Purch. Cr. Memo Hdr."."Your Reference" }

    { 3   ;3   ;Column  ;VendAddr7           ;
               SourceExpr=VendAddr[7] }

    { 45  ;3   ;Column  ;VendAddr8           ;
    ...
    { 50  ;3   ;Column  ;PostingDt_PurchCrMemoHdr;
               SourceExpr=FORMAT("Purch. Cr. Memo Hdr."."Posting Date") }

    { 118 ;3   ;Column  ;PricIncVAT_PurchCrMemoHdr;
               SourceExpr="Purch. Cr. Memo Hdr."."Prices Including VAT" }

    { 137 ;3   ;Column  ;RetOrderNo_PurchCrMemoHdr;
               SourceExpr="Purch. Cr. Memo Hdr."."Return Order No." }

    { 138 ;3   ;Column  ;ReturnOrderNoText   ;
               SourceExpr=ReturnOrderNoText }

    { 162 ;3   ;Column  ;OutputNo            ;
               SourceExpr=OutputNo }

    { 275 ;3   ;Column  ;FormatPricIncVAT_PurchCrMemoHdr;
               SourceExpr=FORMAT("Purch. Cr. Memo Hdr."."Prices Including VAT") }

    { 13  ;3   ;Column  ;PhoneNoCaption      ;
               SourceExpr=PhoneNoCaptionLbl }

    { 18  ;3   ;Column  ;VATRegNoCptn        ;
               SourceExpr=VATRegNoCptnLbl }
    ...
    { 24  ;3   ;Column  ;AccountNoCaption    ;
               SourceExpr=AccountNoCaptionLbl }

    { 31  ;3   ;Column  ;CreditMemoNoCaption ;
               SourceExpr=CreditMemoNoCaptionLbl }

    { 51  ;3   ;Column  ;PostingDateCaption  ;
               SourceExpr=PostingDateCaptionLbl }

    { 17  ;3   ;Column  ;PayVendNo_PurchCrMemoHdrCaption;
               SourceExpr="Purch. Cr. Memo Hdr.".FIELDCAPTION("Pay-to Vendor No.") }

    { 32  ;3   ;Column  ;PricIncVAT_PurchCrMemoHdrCaption;
               SourceExpr="Purch. Cr. Memo Hdr.".FIELDCAPTION("Prices Including VAT") }
    ...
    { 72  ;4   ;Column  ;DimText_DimensionLoop1;
               SourceExpr=DimText }

    { 73  ;4   ;Column  ;HeaderDimensionsCaption;
    ...
    { 158 ;4   ;Column  ;ShowInternalInfo    ;
               SourceExpr=ShowInternalInfo }

    { 161 ;4   ;Column  ;AllowInvDiscount    ;
               SourceExpr=AllowInvDiscount }

    { 159 ;4   ;Column  ;PricesIncludingVAT  ;
               SourceExpr=PricesIncludingVAT }

    { 164 ;4   ;Column  ;Type_PurchCrMemoLine;
               SourceExpr=FORMAT(Type,0,2) }

    { 165 ;4   ;Column  ;VATBasDisc_PurCrMemHdr;
               SourceExpr="Purch. Cr. Memo Hdr."."VAT Base Discount %" }

    { 166 ;4   ;Column  ;VATAmountText       ;
               SourceExpr=VATAmountText }

    { 53  ;4   ;Column  ;LineAmt_PurchCrMemoLine;
               SourceExpr="Line Amount";
               AutoFormatType=1;
               AutoFormatExpr=GetCurrencyCode }

    { 54  ;4   ;Column  ;Desc__PurchCrMemoLine;
               SourceExpr=Description }

    { 61  ;4   ;Column  ;No_PurchCrMemoLine  ;
               SourceExpr="No." }

    { 63  ;4   ;Column  ;Quantity_PurchCrMemoLine;
               SourceExpr=Quantity }

    { 64  ;4   ;Column  ;UOM_PurchCrMemoLine ;
               SourceExpr="Unit of Measure" }

    { 65  ;4   ;Column  ;DirUntCst_PurchCrMemoLine;
               SourceExpr="Direct Unit Cost";
               AutoFormatType=2;
               AutoFormatExpr=GetCurrencyCode }

    { 66  ;4   ;Column  ;LineDisc_PurchCrMemoLine;
               SourceExpr="Line Discount %" }

    { 90  ;4   ;Column  ;AllInvDisc_PurchCrMemoLine;
               IncludeCaption=No;
               SourceExpr="Allow Invoice Disc." }

    { 91  ;4   ;Column  ;VATIdntfr_PurchCrMemoLine;
               SourceExpr="VAT Identifier" }

    { 78  ;4   ;Column  ;InvDiscAmt_PurchCrMemoLine;
               SourceExpr=-"Inv. Discount Amount";
               AutoFormatType=1;
               AutoFormatExpr=GetCurrencyCode }

    { 119 ;4   ;Column  ;TotalText           ;
               SourceExpr=TotalText }

    { 120 ;4   ;Column  ;Amount_PurchCrMemoLine;
               SourceExpr=Amount;
               AutoFormatType=1;
               AutoFormatExpr=GetCurrencyCode }

    { 130 ;4   ;Column  ;TotalExclVATText    ;
               SourceExpr=TotalExclVATText }

    { 131 ;4   ;Column  ;TotalInclVATText    ;
               SourceExpr=TotalInclVATText }

    { 132 ;4   ;Column  ;AmtIncVAT_PurchCrMemoLine;
               SourceExpr="Amount Including VAT";
               AutoFormatType=1;
               AutoFormatExpr=GetCurrencyCode }

    { 133 ;4   ;Column  ;VATAmount_AmountIncluding;
               SourceExpr="Amount Including VAT" - Amount;
               AutoFormatType=1;
               AutoFormatExpr=GetCurrencyCode }

    { 134 ;4   ;Column  ;VATAmountLineVATAmtText;
               SourceExpr=VATAmountLine.VATAmountText }

    { 182 ;4   ;Column  ;DocNo_PurchCrMemoLine;
               SourceExpr="Document No." }

    { 183 ;4   ;Column  ;LineNo_PurchCrMemoLine;
               SourceExpr="Line No." }

    { 194 ;4   ;Column  ;TotalSubTotal       ;
               SourceExpr=TotalSubTotal;
               AutoFormatType=1;
               AutoFormatExpr="Purch. Cr. Memo Hdr."."Currency Code" }

    { 193 ;4   ;Column  ;TotalInvoiceDiscountAmt;
               SourceExpr=TotalInvoiceDiscountAmount;
               AutoFormatType=1;
               AutoFormatExpr="Purch. Cr. Memo Hdr."."Currency Code" }

    { 192 ;4   ;Column  ;TotalAmount         ;
               SourceExpr=TotalAmount;
               AutoFormatType=1;
               AutoFormatExpr="Purch. Cr. Memo Hdr."."Currency Code" }

    { 191 ;4   ;Column  ;TotalAmountInclVAT  ;
               SourceExpr=TotalAmountInclVAT;
               AutoFormatType=1;
               AutoFormatExpr="Purch. Cr. Memo Hdr."."Currency Code" }

    { 190 ;4   ;Column  ;TotalAmountVAT      ;
               SourceExpr=TotalAmountVAT;
               AutoFormatType=1;
               AutoFormatExpr="Purch. Cr. Memo Hdr."."Currency Code" }

    { 189 ;4   ;Column  ;TotalPaymentDiscountOnVAT;
               SourceExpr=TotalPaymentDiscountOnVAT;
               AutoFormatType=1 }

    { 42  ;4   ;Column  ;DirectUnitCostCaption;
               SourceExpr=DirectUnitCostCaptionLbl }

    { 43  ;4   ;Column  ;DiscountPercentCaption;
               SourceExpr=DiscountPercentCaptionLbl }

    { 44  ;4   ;Column  ;AmountCaption       ;
               SourceExpr=AmountCaptionLbl }

    { 77  ;4   ;Column  ;InvDiscountAmountCaption;
               SourceExpr=InvDiscountAmountCaptionLbl }

    { 79  ;4   ;Column  ;SubtotalCaption     ;
               SourceExpr=SubtotalCaptionLbl }

    { 88  ;4   ;Column  ;PaymentDiscountVATCaption;
               SourceExpr=PaymentDiscountVATCaptionLbl }

    { 52  ;4   ;Column  ;Desc__PurchCrMemoLineCaption;
               SourceExpr=FIELDCAPTION(Description) }

    { 55  ;4   ;Column  ;No_PurchCrMemoLineCaption;
               SourceExpr=FIELDCAPTION("No.") }

    { 56  ;4   ;Column  ;Quantity_PurchCrMemoLineCaption;
               SourceExpr=FIELDCAPTION(Quantity) }

    { 57  ;4   ;Column  ;UOM_PurchCrMemoLineCaption;
               SourceExpr=FIELDCAPTION("Unit of Measure") }

    { 62  ;4   ;Column  ;VATIdntfr_PurchCrMemoLineCaption;
    ...
    { 81  ;5   ;Column  ;DimText_DimensionLoop2;
               SourceExpr=DimText }
    ...
    { 94  ;4   ;Column  ;VATAmountLineVATBase;
               SourceExpr=VATAmountLine."VAT Base";
               AutoFormatType=1;
               AutoFormatExpr="Purch. Cr. Memo Hdr."."Currency Code" }

    { 95  ;4   ;Column  ;VATAmountLineVATAmount;
               SourceExpr=VATAmountLine."VAT Amount";
               AutoFormatType=1;
               AutoFormatExpr="Purch. Cr. Memo Hdr."."Currency Code" }

    { 127 ;4   ;Column  ;VATAmountLineLineAmount;
               SourceExpr=VATAmountLine."Line Amount";
               AutoFormatType=1;
               AutoFormatExpr="Purch. Cr. Memo Hdr."."Currency Code" }

    { 128 ;4   ;Column  ;VATAmtLineInvDiscBaseAmt;
               SourceExpr=VATAmountLine."Inv. Disc. Base Amount";
               AutoFormatType=1;
               AutoFormatExpr="Purch. Cr. Memo Hdr."."Currency Code" }

    { 129 ;4   ;Column  ;VATAmtLineInvDiscountAmt;
               SourceExpr=VATAmountLine."Invoice Discount Amount";
               AutoFormatType=1;
               AutoFormatExpr="Purch. Cr. Memo Hdr."."Currency Code" }

    { 97  ;4   ;Column  ;VATAmountLineVAT_VATCounter;
               DecimalPlaces=0:5;
               SourceExpr=VATAmountLine."VAT %" }

    { 100 ;4   ;Column  ;VATAmtLineVATIdentifier_VATCounter;
               SourceExpr=VATAmountLine."VAT Identifier" }

    { 70  ;4   ;Column  ;VATAmountSpecCaption;
               SourceExpr=VATAmountSpecCaptionLbl }

    { 58  ;4   ;Column  ;LineAmtCaption      ;
               SourceExpr=LineAmtCaptionLbl }

    { 59  ;4   ;Column  ;InvDiscBaseAmtCaption;
               SourceExpr=InvDiscBaseAmtCaptionLbl }

    { 60  ;4   ;Column  ;InvDiscAmtCaption   ;
    ...
    { 141 ;4   ;Column  ;VALExchRate         ;
               SourceExpr=VALExchRate }

    { 143 ;4   ;Column  ;VALSpecLCYHeader    ;
               SourceExpr=VALSpecLCYHeader }

    { 145 ;4   ;Column  ;VALVATAmountLCY     ;
               SourceExpr=VALVATAmountLCY;
               AutoFormatType=1 }

    { 146 ;4   ;Column  ;VALVATBaseLCY       ;
               SourceExpr=VALVATBaseLCY;
               AutoFormatType=1 }

    { 150 ;4   ;Column  ;VATAmountLineVAT_VATCounterLCY;
               DecimalPlaces=0:5;
               SourceExpr=VATAmountLine."VAT %" }

    { 151 ;4   ;Column  ;VATAmtLineVATIdentifier_VATCounterLCY;
               SourceExpr=VATAmountLine."VAT Identifier" }
    ...
    { 110 ;4   ;Column  ;BuyVendNo_PurchCrMemoHdr;
               SourceExpr="Purch. Cr. Memo Hdr."."Buy-from Vendor No." }

    { 67  ;4   ;Column  ;BuyVendNo_PurchCrMemoHdrCaption;
    ...
    { 112 ;4   ;Column  ;ShipToAddr1         ;
               SourceExpr=ShipToAddr[1] }

    { 113 ;4   ;Column  ;ShipToAddr2         ;
               SourceExpr=ShipToAddr[2] }

    { 114 ;4   ;Column  ;ShipToAddr3         ;
               SourceExpr=ShipToAddr[3] }

    { 115 ;4   ;Column  ;ShipToAddr4         ;
               SourceExpr=ShipToAddr[4] }

    { 116 ;4   ;Column  ;ShipToAddr5         ;
               SourceExpr=ShipToAddr[5] }

    { 117 ;4   ;Column  ;ShipToAddr6         ;
    ...
    { 111 ;4   ;Column  ;ShiptoAddressCaption;
  ...
  CODE
  {
    VAR
      ...
      Text005@1005 : TextConst '@@@="%1 = Document No.";DAN=K›b - kreditnota%1;ENU=Purchase - Credit Memo%1';
      ...
      RespCenter@1014 : Record 5714;
      Language@1015 : Record 8;
      CurrExchRate@1046 : Record 330;
      FormatAddr@1017 : Codeunit 365;
      FormatDocument@1006 : Codeunit 368;
      SegManagement@1038 : Codeunit 5051;
      VendAddr@1018 : ARRAY [8] OF Text[50];
      ShipToAddr@1019 : ARRAY [8] OF Text[50];
      CompanyAddr@1020 : ARRAY [8] OF Text[50];
      ReturnOrderNoText@1036 : Text[80];
      PurchaserText@1021 : Text[30];
      VATNoText@1022 : Text[80];
      ReferenceText@1023 : Text[80];
      AppliedToText@1024 : Text;
      TotalText@1025 : Text[50];
      TotalInclVATText@1026 : Text[50];
      TotalExclVATText@1027 : Text[50];
      AllowInvDiscount@1054 : Text[30];
      PricesIncludingVAT@1053 : Text[30];
      VATAmountText@1052 : Text[30];
      MoreLines@1028 : Boolean;
      NoOfCopies@1029 : Integer;
      NoOfLoops@1030 : Integer;
      OutputNo@1049 : Integer;
      CopyText@1031 : Text[30];
      DimText@1032 : Text[120];
      OldDimText@1033 : Text[75];
      ShowInternalInfo@1034 : Boolean;
      Continue@1035 : Boolean;
      ...
      Text008@1045 : TextConst 'DAN="Momsbel›bsspecifikation i ";ENU="VAT Amount Specification in "';
      Text009@1044 : TextConst 'DAN=Lokal valuta;ENU=Local Currency';
      Text010@1043 : TextConst 'DAN=Valutakurs: %1/%2;ENU=Exchange rate: %1/%2';
      CalculatedExchRate@1047 : Decimal;
      Text011@1048 : TextConst 'DAN=K›b - forudbetalingskreditnota %1;ENU=Purchase - Prepmt. Credit Memo %1';
      Text012@1050 : TextConst 'DAN=%1% moms;ENU=%1% VAT';
      Text013@1051 : TextConst 'DAN=Momsbel›b;ENU=VAT Amount';
      LogInteractionEnable@19003940 : Boolean INDATASET;
      TotalSubTotal@1060 : Decimal;
      TotalAmount@1059 : Decimal;
      TotalAmountInclVAT@1058 : Decimal;
      TotalAmountVAT@1057 : Decimal;
      TotalInvoiceDiscountAmount@1056 : Decimal;
      TotalPaymentDiscountOnVAT@1055 : Decimal;
      PhoneNoCaptionLbl@6169 : TextConst 'DAN=Telefon;ENU=Phone No.';
      VATRegNoCptnLbl@1983 : TextConst 'DAN=SE/CVR-nr.;ENU=VAT Registration No.';
      GiroNoCaptionLbl@7839 : TextConst 'DAN=Gironr.;ENU=Giro No.';
      BankNameCaptionLbl@5585 : TextConst 'DAN=Bank;ENU=Bank';
      AccountNoCaptionLbl@6228 : TextConst 'DAN=Kontonr.;ENU=Account No.';
      CreditMemoNoCaptionLbl@7195 : TextConst 'DAN=Kreditnotanr.;ENU=Credit Memo No.';
      ...
      DiscountPercentCaptionLbl@5604 : TextConst 'DAN=Rabatpct.;ENU=Discount %';
      AmountCaptionLbl@7794 : TextConst 'DAN=Bel›b;ENU=Amount';
      InvDiscountAmountCaptionLbl@9792 : TextConst 'DAN=Fakturarabatbel›b;ENU=Invoice Discount Amount';
      SubtotalCaptionLbl@1782 : TextConst 'DAN=Subtotal;ENU=Subtotal';
      PaymentDiscountVATCaptionLbl@8168 : TextConst 'DAN=Moms ved kontantrabat;ENU=Payment Discount on VAT';
      LineDimensionsCaptionLbl@3801 : TextConst 'DAN=Linjedimensioner;ENU=Line Dimensions';
      VATAmountSpecCaptionLbl@5931 : TextConst 'DAN=Momsbel›bspecifikation;ENU=VAT Amount Specification';
      ...
      AllowInvoiceDiscountCaptionLbl@9568 : TextConst 'DAN=Tillad fakturarabat;ENU=Allow Invoice Discount';
    ...
    PROCEDURE InitializeRequest@2(NewNoOfCopies@1002 : Integer;NewShowInternalInfo@1000 : Boolean;NewLogInteraction@1003 : Boolean);
    BEGIN
    ...
    LOCAL PROCEDURE FormatAddressFields@3(VAR PurchCrMemoHdr@1000 : Record 124);
    BEGIN
    ...
    LOCAL PROCEDURE FormatDocumentFields@5(PurchCrMemoHdr@1000 : Record 124);
    BEGIN
...
<Report xmlns="http://schemas.microsoft.com/sqlserver/reporting/2016/01/reportdefinition" xmlns:rd="http://schemas.microsoft.com/SQLServer/reporting/reportdesigner">
  ...
  <DataSources>
    <DataSource Name="DataSource">
      ...
      <rd:DataSourceID>ad70a79f-791b-4ce5-ade4-564cde6f8082</rd:DataSourceID>
    </DataSource>
  </DataSources>
  <DataSets>
        ...
        <ReportItems>
          <Tablix Name="list1">
            <TablixBody>
              <TablixColumns>
                <TablixColumn>
                  <Width>18.17881cm</Width>
                </TablixColumn>
              </TablixColumns>
              <TablixRows>
                <TablixRow>
                  <Height>19.85289cm</Height>
                  <TablixCells>
                    <TablixCell>
                      <CellContents>
                          ...
                          <ReportItems>
                            <Tablix Name="table2">
                              <TablixBody>
                                <TablixColumns>
                                  <TablixColumn>
                                    <Width>0.22332cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>0.27625cm</Width>
                                  </TablixColumn>
                                </TablixColumns>
                                <TablixRows>
                                  <TablixRow>
                                          ...
                                          <Textbox Name="NewPage">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=IIF(Code.IsNewPage(Fields!No_PurchCrMemoHdr.Value,Fields!OutputNo.Value),TRUE,FALSE)</Value>
                                                    <Style>
...
Cstr(Fields!DocumentCaption.Value) + Chr(177) + 
Cstr(Fields!No_PurchCrMemoHdr.Value) + Chr(177) + 
Cstr(Fields!RetOrderNo_PurchCrMemoHdr.Value) + Chr(177) + 
Cstr(Fields!PostingDt_PurchCrMemoHdr.Value) + Chr(177) + 
Cstr(Fields!AppliedToText.Value) + Chr(177) + 
Cstr(Fields!FormatPricIncVAT_PurchCrMemoHdr.Value) + Chr(177) + 
Cstr(Fields!PayVendNo_PurchCrMemoHdr.Value) + Chr(177) + 
Cstr(Fields!VATRegNo_PurchCrMemoHdr.Value) + Chr(177) + 
Cstr(Fields!SalesPurchPersonName.Value) + Chr(177) + 
Cstr(Fields!YourRef_PurchCrMemoHdr.Value) + Chr(177) + 
Cstr(Fields!DocDate_PurchCrMemoHdr.Value) + Chr(177) + 
Cstr(Fields!CompanyInfoEMail.Value) + Chr(177) + 
Cstr(Fields!PricIncVAT_PurchCrMemoHdrCaption.Value) + Chr(177) + 
Cstr(Fields!PostingDateCaption.Value) + Chr(177) + 
Cstr(Fields!CreditMemoNoCaption.Value) + Chr(177) + 
Cstr(Fields!PayVendNo_PurchCrMemoHdrCaption.Value) + Chr(177) + 
Cstr(Fields!AccountNoCaption.Value) + Chr(177) + 
Cstr(Fields!BankNameCaption.Value) + Chr(177) + 
Cstr(Fields!GiroNoCaption.Value) + Chr(177) + 
Cstr(Fields!VATRegNoCptn.Value) + Chr(177) + 
Cstr(Fields!HomePageCaption.Value) + Chr(177) + 
Cstr(Fields!PhoneNoCaption.Value) + Chr(177) + 
Cstr(Fields!ReturnOrderNoText.Value) + Chr(177) + 
...
, 1)</Hidden>
                            ...
                            <Tablix Name="Table1">
                              <TablixBody>
                                <TablixColumns>
                                  <TablixColumn>
                                    <Width>1.70297cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>3.51412cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>1.60332cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>1.64165cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>2.58018cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>1.85626cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>2cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>1.74168cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>1.53863cm</Width>
                                  </TablixColumn>
                                </TablixColumns>
                                <TablixRows>
                                  <TablixRow>
                                    ...
                                    <TablixCells>
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="PurchCrMemoLineNoCaption">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!No_PurchCrMemoLineCaption.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                          ...
                                          <Textbox Name="VALSpecLCYHeader">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!Desc__PurchCrMemoLineCaption.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="QuantityPurchCrMemoLineCaption">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!Quantity_PurchCrMemoLineCaption.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="UOMPurchCrMemoLineCaption">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!UOM_PurchCrMemoLineCaption.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="DirectUnitCostCaption">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!DirectUnitCostCaption.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="PurchCrMemoLineLnDiscCptn">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!DiscountPercentCaption.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="AllInvDiscPurchCrMemoLineCaption">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!AllowInvoiceDiscountCaption.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VATIdntfrPurchCrMemoLineCaption">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!VATIdntfr_PurchCrMemoLineCaption.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox595">
                                            ...
                                            <rd:DefaultName>textbox595</rd:DefaultName>
                                            <ZIndex>85</ZIndex>
                                            <Style>
                                          ...
                                          <Textbox Name="textbox675">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!Desc__PurchCrMemoLine.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                    </Style>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox632">
                                            ...
                                            <rd:DefaultName>textbox632</rd:DefaultName>
                                            <ZIndex>83</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox633">
                                            ...
                                            <rd:DefaultName>textbox633</rd:DefaultName>
                                            <ZIndex>81</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox634">
                                            ...
                                            <rd:DefaultName>textbox634</rd:DefaultName>
                                            <ZIndex>80</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox635">
                                            ...
                                            <rd:DefaultName>textbox635</rd:DefaultName>
                                            <ZIndex>79</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox636">
                                            ...
                                            <rd:DefaultName>textbox636</rd:DefaultName>
                                            <ZIndex>78</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox637">
                                            ...
                                            <rd:DefaultName>textbox637</rd:DefaultName>
                                            <ZIndex>77</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                  ...
                                  <TablixRow>
                                    ...
                                    <TablixCells>
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VATAmountLineVATIdentifierControl151">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=IIF(Fields!Type_PurchCrMemoLine.Value = "1","",Fields!No_PurchCrMemoLine.Value)</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                    </Style>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VATAmountLineVATControl150">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VALVATBaseLCYControl149">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Code.BlankZero(Fields!Quantity_PurchCrMemoLine.Value)</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                    </Style>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VALVATAmountLCYControl148">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!UOM_PurchCrMemoLine.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                    </Style>
                                          ...
                                          <Textbox Name="textbox46">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Code.BlankZero(Fields!DirUntCst_PurchCrMemoLine.Value)</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <Format>=Fields!DirUntCst_PurchCrMemoLineFormat.Value</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                                          ...
                                          <Textbox Name="textbox67">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Code.BlankZero(Fields!LineDisc_PurchCrMemoLine.Value)</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <Format>=Fields!LineDisc_PurchCrMemoLineFormat.Value</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                                          ...
                                          <Textbox Name="textbox73">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!AllowInvDiscount.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                    </Style>
                                            ...
                                            <ZIndex>70</ZIndex>
                                            <Visibility>
                                              <Hidden>=IIF(Fields!Amount_PurchCrMemoLine.Value = 0,True,False)</Hidden>
                                            </Visibility>
                                          ...
                                          <Textbox Name="textbox98">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!VATIdntfr_PurchCrMemoLine.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                    </Style>
                                          ...
                                          <Textbox Name="textbox117">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Code.BlankZero(Fields!LineAmt_PurchCrMemoLine.Value)</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <Format>=Fields!LineAmt_PurchCrMemoLineFormat.Value</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox369">
                                            ...
                                            <rd:DefaultName>textbox369</rd:DefaultName>
                                            <ZIndex>7</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingRight>5pt</PaddingRight>
                                                ...
                                                <TextRuns>
                                                  <TextRun>
                                                    ...
                                                    <Style>
                                                      ...
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                                      <Format>=First(Fields!VALVATAmountLCYFormat.Value)</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                                                ...
                                                <TextRuns>
                                                  <TextRun>
                                                    ...
                                                    <Style>
                                                      ...
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                                      <Format>=First(Fields!LineAmt_PurchCrMemoLineFormat.Value)</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox413">
                                                ...
                                                <TextRuns>
                                                  <TextRun>
                                                    ...
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <Format>=Fields!InvDiscAmt_PurchCrMemoLineFormat.Value</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                                            ...
                                            <rd:DefaultName>textbox413</rd:DefaultName>
                                            <ZIndex>8</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                                ...
                                                <TextRuns>
                                                  <TextRun>
                                                    ...
                                                    <Style>
                                                      ...
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                                      <Format>=Fields!Amount_PurchCrMemoLineFormat.Value</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                                          ...
                                          <Textbox Name="textbox295">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!PaymentDiscountVATCaption.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                    </Style>
                                          ...
                                          <Textbox Name="textbox452">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=SUM(Fields!AmtIncVAT_PurchCrMemoLine.Value - Fields!Amount_PurchCrMemoLine.Value)</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <Format>=Fields!Amount_PurchCrMemoLineFormat.Value</Format>
                                          ...
                                          <Textbox Name="textbox448">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=SUM(Fields!Amount_PurchCrMemoLine.Value)</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <Format>=Fields!Amount_PurchCrMemoLineFormat.Value</Format>
                              ...
                              <TablixRowHierarchy>
                                <TablixMembers>
                                  ...
                                  <TablixMember>
                                    <Group Name="Group1">
                                      <GroupExpressions>
                                        <GroupExpression>=Fields!No_PurchCrMemoHdr.Value</GroupExpression>
                                        <GroupExpression>=Fields!LineNo_PurchCrMemoLine.Value</GroupExpression>
                                        <GroupExpression>=Fields!OutputNo.Value</GroupExpression>
                                      </GroupExpressions>
                                    </Group>
                                    <SortExpressions>
                                      <SortExpression>
                                        <Value>=Fields!No_PurchCrMemoHdr.Value</Value>
                                      </SortExpression>
                                    </SortExpressions>
                                    <TablixMembers>
                                      <TablixMember>
                                        <Visibility>
                                          <Hidden>=IIF(Fields!Type_PurchCrMemoLine.Value = 0, false, true)</Hidden>
                                        </Visibility>
                                        <KeepWithGroup>After</KeepWithGroup>
                                      </TablixMember>
                                      <TablixMember>
                                        <Visibility>
                                          <Hidden>=IIF(Fields!Type_PurchCrMemoLine.Value = 0, true, false)</Hidden>
                                        </Visibility>
                                        <KeepWithGroup>After</KeepWithGroup>
                                      </TablixMember>
                                      <TablixMember>
                                  ...
                                  <TablixMember>
                                    <Visibility>
                                      <Hidden>=IIF(SUM(Fields!InvDiscAmt_PurchCrMemoLine.Value)=0,TRUE,FALSE)</Hidden>
                                    </Visibility>
                                    <KeepTogether>true</KeepTogether>
                                  </TablixMember>
                                  <TablixMember>
                                  ...
                                  <TablixMember>
                                    <Visibility>
                                      <Hidden>=IIF(SUM(Fields!Amount_PurchCrMemoLine.Value)&lt;&gt;SUM(Fields!AmtIncVAT_PurchCrMemoLine.Value),TRUE,FALSE)</Hidden>
                                    </Visibility>
                                  </TablixMember>
                                  <TablixMember>
                                    <Visibility>
                                  ...
                                  <TablixMember>
                                    <Visibility>
                                      <Hidden>=IIF(NOT Fields!PricIncVAT_PurchCrMemoHdr.Value AND (SUM(Fields!Amount_PurchCrMemoLine.Value)&lt;&gt;SUM(Fields!AmtIncVAT_PurchCrMemoLine.Value)),FALSE,TRUE)</Hidden>
                                    </Visibility>
                                  </TablixMember>
                                  <TablixMember>
                                    <Visibility>
                                  ...
                                  <TablixMember>
                                    <Visibility>
                                      <Hidden>=IIF(Fields!PricIncVAT_PurchCrMemoHdr.Value=TRUE AND SUM(Fields!Amount_PurchCrMemoLine.Value)&lt;&gt;SUM(Fields!AmtIncVAT_PurchCrMemoLine.Value) AND (SUM(Fields!VATBasDisc_PurCrMemHdr.Value)&lt;&gt;0),FALSE,TRUE)</Hidden>
                                    </Visibility>
                                    <KeepTogether>true</KeepTogether>
                                  </TablixMember>
                                  <TablixMember>
                                    <Visibility>
                                      <Hidden>=IIF(Fields!PricIncVAT_PurchCrMemoHdr.Value AND (SUM(Fields!Amount_PurchCrMemoLine.Value)&lt;&gt;SUM(Fields!AmtIncVAT_PurchCrMemoLine.Value)),FALSE,TRUE)</Hidden>
                                    </Visibility>
                                  </TablixMember>
                                  <TablixMember>
                                    <Visibility>
                              ...
                              <Filters>
                                <Filter>
                                  <FilterExpression>=Fields!LineNo_PurchCrMemoLine.Value</FilterExpression>
                            ...
                            <Tablix Name="table5">
                              <TablixBody>
                                <TablixColumns>
                                  <TablixColumn>
                                    <Width>7.79742cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>10.34484cm</Width>
                                  </TablixColumn>
                                </TablixColumns>
                                <TablixRows>
                                  <TablixRow>
                                          ...
                                          <Textbox Name="textbox21">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!BuyVendNo_PurchCrMemoHdrCaption.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                    </Style>
                                          ...
                                          <Textbox Name="textbox23">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!BuyVendNo_PurchCrMemoHdr.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                    </Style>
                              ...
                              <Filters>
                                <Filter>
                                  <FilterExpression>=Fields!BuyVendNo_PurchCrMemoHdr.Value</FilterExpression>
                                  <Operator>GreaterThanOrEqual</Operator>
                                  <FilterValues>
                                    <FilterValue>""</FilterValue>
                                  </FilterValues>
                            ...
                            <Tablix Name="table3">
                              <TablixBody>
                                <TablixColumns>
                                  <TablixColumn>
                                    <Width>2.25745cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>2.25745cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>3.20982cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>3.2098cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>3.3277cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>1.94cm</Width>
                                  </TablixColumn>
                                ...
                                <TablixRows>
                                  ...
                                  <TablixRow>
                                    ...
                                    <TablixCells>
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VATAmountSpecCaption">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!VATAmountSpecCaption.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                  ...
                                  <TablixRow>
                                    ...
                                    <TablixCells>
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VATAmtLineVATIdentfrCptn">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VATAmountLineLineAmtCptn">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VATAmtLineInvDiscAmtCptn">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                          ...
                                          <Textbox Name="textbox49">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=Fields!VATAmountLineVAT_VATCounter.Value</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                    </Style>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox638">
                                            ...
                                            <rd:DefaultName>textbox638</rd:DefaultName>
                                            <ZIndex>13</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingRight>5pt</PaddingRight>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox6917">
                                            ...
                                            <rd:DefaultName>textbox691</rd:DefaultName>
                                            <ZIndex>12</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox692">
                                            ...
                                            <rd:DefaultName>textbox692</rd:DefaultName>
                                            <ZIndex>11</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox693">
                                            ...
                                            <rd:DefaultName>textbox693</rd:DefaultName>
                                            <ZIndex>10</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox694">
                                            ...
                                            <rd:DefaultName>textbox694</rd:DefaultName>
                                            <ZIndex>9</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox695">
                                            ...
                                            <rd:DefaultName>textbox695</rd:DefaultName>
                                            <ZIndex>8</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox696">
                                            ...
                                            <rd:DefaultName>textbox696</rd:DefaultName>
                                            <ZIndex>7</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                                ...
                                                <TextRuns>
                                                  <TextRun>
                                                    ...
                                                    <Style>
                                                      ...
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                                      <Format>=First(Fields!VATAmountLineLineAmountFormat.Value)</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                                                ...
                                                <TextRuns>
                                                  <TextRun>
                                                    ...
                                                    <Style>
                                                      ...
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                                      <Format>=First(Fields!VATAmtLineInvDiscBaseAmtFormat.Value)</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                                                ...
                                                <TextRuns>
                                                  <TextRun>
                                                    ...
                                                    <Style>
                                                      ...
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                                      <Format>=First(Fields!VATAmtLineInvDiscountAmtFormat.Value)</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                                                ...
                                                <TextRuns>
                                                  <TextRun>
                                                    ...
                                                    <Style>
                                                      ...
                                                      <FontSize>8pt</FontSize>
                                                      <FontWeight>Bold</FontWeight>
                                                      <Format>=First(Fields!VATAmountLineVATBaseFormat.Value)</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                              ...
                              <ZIndex>4</ZIndex>
                              <Visibility>
                                <Hidden>=IIF(Fields!VATAmtLineVATIdentifier_VATCounter.Value&lt;&gt;"",False,True)</Hidden>
                              </Visibility>
                              <DataElementOutput>NoOutput</DataElementOutput>
                              <Style />
                            </Tablix>
                            <Tablix Name="table8">
                              <TablixBody>
                                <TablixColumns>
                                  <TablixColumn>
                                    <Width>1.36007in</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>5.79693in</Width>
                                  </TablixColumn>
                                </TablixColumns>
                                <TablixRows>
                                  <TablixRow>
                                          ...
                                          <Textbox Name="textbox581">
                                            ...
                                            <Paragraphs>
                                              <Paragraph>
                                                <TextRuns>
                                                  <TextRun>
                                                    <Value>=First(Fields!DimText_DimensionLoop1.Value)</Value>
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                    </Style>
                              ...
                              <ZIndex>5</ZIndex>
                              <Visibility>
                                <Hidden>=IIF(Fields!DimText_DimensionLoop1.Value="",TRUE,FALSE)</Hidden>
                              </Visibility>
                              <DataElementOutput>NoOutput</DataElementOutput>
                              <Style />
                            </Tablix>
                            <Tablix Name="table6">
                              <TablixBody>
                                <TablixColumns>
                                  <TablixColumn>
                                    <Width>4.60926cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>4.60926cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>4.29181cm</Width>
                                  </TablixColumn>
                                  <TablixColumn>
                                    <Width>4.63192cm</Width>
                                  </TablixColumn>
                                </TablixColumns>
                                <TablixRows>
                                  <TablixRow>
                                  ...
                                  <TablixRow>
                                    ...
                                    <TablixCells>
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VALSpecLCYHeaderCaption">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox705">
                                            ...
                                            <rd:DefaultName>textbox705</rd:DefaultName>
                                            <ZIndex>26</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingRight>5pt</PaddingRight>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox707">
                                            ...
                                            <rd:DefaultName>textbox707</rd:DefaultName>
                                            <ZIndex>25</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox7088">
                                            ...
                                            <rd:DefaultName>textbox708</rd:DefaultName>
                                            <ZIndex>24</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                  ...
                                  <TablixRow>
                                    ...
                                    <TablixCells>
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VATAmtLineVATIdentfrCaption">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="VATAmountLineVATCptn">
                                            <CanGrow>true</CanGrow>
                                            <KeepTogether>true</KeepTogether>
                                            <Paragraphs>
                                              <Paragraph>
                                      ...
                                      <TablixCell>
                                        <CellContents>
                                          <Textbox Name="textbox586">
                                            ...
                                            <rd:DefaultName>textbox586</rd:DefaultName>
                                            <ZIndex>1</ZIndex>
                                            <Style>
                                              <VerticalAlign>Top</VerticalAlign>
                                              <PaddingLeft>5pt</PaddingLeft>
                                                ...
                                                <TextRuns>
                                                  <TextRun>
                                                    ...
                                                    <Style>
                                                      <FontFamily>Segoe UI</FontFamily>
                                                      <FontSize>8pt</FontSize>
                                                      <Format>=First(Fields!VALVATBaseLCYFormat.Value)</Format>
                                                    </Style>
                                                  </TextRun>
                                                </TextRuns>
                                                <Style>
                              ...
                              <ZIndex>6</ZIndex>
                              <Visibility>
                                <Hidden>=IIF(Fields!VATAmtLineVATIdentifier_VATCounterLCY.Value&lt;&gt;"",False,True)</Hidden>
                              </Visibility>
                              <DataElementOutput>NoOutput</DataElementOutput>
                              <Style />
                            </Tablix>
            ...
            <Filters>
              <Filter>
                <FilterExpression>=Fields!No_PurchCrMemoHdr.Value</FilterExpression>
                <Operator>GreaterThanOrEqual</Operator>
                <FilterValues>
                  <FilterValue>""</FilterValue>
                </FilterValues>
      ...
      <Page>
        <PageHeader>
          <Height>7.78739cm</Height>
          <PrintOnFirstPage>true</PrintOnFirstPage>
          <PrintOnLastPage>true</PrintOnLastPage>
          <ReportItems>
            <Textbox Name="PurchCrMemoHdrPricesIncludingVATCaption">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
              ...
              <Top>6.34833cm</Top>
              <Height>11pt</Height>
              <Width>3.8186cm</Width>
              <Style>
                <VerticalAlign>Top</VerticalAlign>
              </Style>
            </Textbox>
            <Textbox Name="PurchCrMemoHdrPostingDateCaption">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
            ...
            <Textbox Name="PurchCrMemoHdrNoCaption">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
            ...
            <Textbox Name="PurchCrMemoHdrPaytoVendorNoCaption">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
              ...
              <Top>3.87889cm</Top>
              <Height>11pt</Height>
              <Width>3.81861cm</Width>
              <ZIndex>3</ZIndex>
              <Style>
                <VerticalAlign>Top</VerticalAlign>
              </Style>
            </Textbox>
            <Textbox Name="CompanyInfoBankAccountNoCaption">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
              ...
              <Top>5.64278cm</Top>
              <Left>11.64671cm</Left>
              <Height>11pt</Height>
              <Width>2.88019cm</Width>
              <ZIndex>4</ZIndex>
              <Style>
                <VerticalAlign>Top</VerticalAlign>
              </Style>
            ...
            <Textbox Name="CompanyInfoVATRegistrationNoCaption">
              <CanGrow>true</CanGrow>
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
            ...
            <Textbox Name="ReturnOrderNoText">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
            ...
            <Textbox Name="PurchCrMemoHdrReturnOrderNo">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
              ...
              <Left>3.85389cm</Left>
              <Height>11pt</Height>
              <Width>7.60882cm</Width>
              <ZIndex>11</ZIndex>
              <Style>
                <VerticalAlign>Top</VerticalAlign>
              </Style>
            </Textbox>
            <Textbox Name="PurchCrMemoHdrPricesIncludingVAT">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
              ...
              <Left>3.8186cm</Left>
              <Height>11pt</Height>
              <Width>13.52989cm</Width>
              <ZIndex>12</ZIndex>
              <Style>
                <VerticalAlign>Top</VerticalAlign>
              </Style>
            </Textbox>
            <Textbox Name="PurchCrMemoHdrPostingDate">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
            ...
            <Textbox Name="CompanyAddr61">
              ...
              <Top>3.17333cm</Top>
              <Left>12.74963cm</Left>
              <Height>11pt</Height>
              <Width>5.39261cm</Width>
              <ZIndex>14</ZIndex>
              <Style>
                <VerticalAlign>Top</VerticalAlign>
              </Style>
            ...
            <Textbox Name="PurchCrMemoHdrYourReference">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
            ...
            <Textbox Name="SalesPurchPersonName">
              ...
              <Top>5.99556cm</Top>
              <Left>14.60668cm</Left>
              <Height>11pt</Height>
              <Width>3.53556cm</Width>
              <ZIndex>21</ZIndex>
              <Style>
                <VerticalAlign>Top</VerticalAlign>
              </Style>
            ...
            <Textbox Name="PurchCrMemoHdrVATRegistrationNo">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
            ...
            <Textbox Name="PurchCrMemoHdrPaytoVendorNo">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
            ...
            <Textbox Name="CompanyInfoBankAccountNo">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
            ...
            <Textbox Name="CompanyInfoVATRegistrationNo">
              <KeepTogether>true</KeepTogether>
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
            ...
            <Textbox Name="PageNumberTextBox">
              ...
              <Paragraphs>
                <Paragraph>
                  <TextRuns>
                    <TextRun>
                      <Value>=Code.GetData(47,1) &amp; " " &amp; Code.GetGroupPageNumber(ReportItems!NewPage.Value,Globals!PageNumber)</Value>
                      <Style>
                        <FontFamily>Segoe UI</FontFamily>
                        <FontSize>8pt</FontSize>
                      </Style>
...
End Function
  ...
  <rd:ReportID>dc4519a0-e750-4c3f-8cc4-6147f65816d7</rd:ReportID>
</Report>
    END_OF_RDLDATA
  }
}
