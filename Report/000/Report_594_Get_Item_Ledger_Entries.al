OBJECT Report 594 Get Item Ledger Entries
{
    ...
    CONTROLS
    {
      ...
      { 3   ;2   ;Field     ;
                  CaptionML=[DAN=Reguleringspct. (kostpris);
                             ENU=Cost Regulation %];
                  ToolTipML=[DAN=Angiver reguleringsprocenten til d‘kning af fragt og forsikring. Den statistiske v‘rdi p† hver linje i kladden forh›jes med denne procentsats.;
      ...
      { 4   ;2   ;Field     ;
                  ...
                  CaptionML=[DAN=Spring over genberegning af nul-bel›b;
                             ENU=Skip Recalculation for Zero Amounts];
                  ToolTipML=[DAN=Angiver, at linjer uden antal ikke genberegnes under k›rslen.;
      ...
      { 5   ;2   ;Field     ;
                  Name=SkipZeros;
                  CaptionML=[DAN=Spring over nul-bel›b;
                             ENU=Skip Zero Amounts];
                  ToolTipML=[DAN=Angiver, at vareposter uden antal ikke inkluderes i k›rslen.;
      ...
      { 7   ;2   ;Field     ;
                  ...
                  CaptionML=[DAN=Vis varegebyrposter;
                             ENU=Show Item Charge Entries];
                  ToolTipML=[DAN=Angiver, om du vil have vist direkte omkostninger, som virksomheden har tilknyttet og bogf›rt som varegebyrer.;
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Priser inkl. moms kan ikke beregnes, n†r %1 er %2.;ENU=Prices including VAT cannot be calculated when %1 is %2.';
