OBJECT Report 416 Archived Purchase Order
{
  OBJECT-PROPERTIES
  {
    Date=30-08-18;
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Arkiveret k›bsordre;
               ENU=Archived Purchase Order];
    OnInitReport=BEGIN
                   GLSetup.GET;
                   CompanyInfo.GET;
                 END;
  ...
  DATASET
  {
    { 6075;    ;DataItem;                    ;
               ...
               ReqFilterHeadingML=[DAN=Arkiveret k›bsordre;
                                   ENU=Archived Purchase Order];
    ...
    { 5701;1   ;DataItem;CopyLoop            ;
               ...
               OnAfterGetRecord=VAR
                                  ...
                                  TempPurchHeader@1003 : TEMPORARY Record 38;
    ...
    { 265 ;4   ;Column  ;TotalSubTotal       ;
               SourceExpr=TotalSubTotal;
               AutoFormatType=1;
               AutoFormatExpr="Purchase Header Archive"."Currency Code" }

    { 264 ;4   ;Column  ;TotalInvoiceDiscountAmount;
               SourceExpr=TotalInvoiceDiscountAmount;
               AutoFormatType=1;
               AutoFormatExpr="Purchase Header Archive"."Currency Code" }

    { 263 ;4   ;Column  ;TotalAmount         ;
  ...
  {
    VAR
      Text004@1004 : TextConst '@@@="%1 = Document No.";DAN=K›bsordre arkiveret %1;ENU=Purchase Order Archived %1';
                                    ...
                                    <TablixMembers>
                                      ...
                                      <TablixMember>
                                        ...
                                        <TablixMembers>
                                          <TablixMember>
                                            <Visibility>
                                              <Hidden>=IIF(Fields!ShowInternalInfo.Value=TRUE AND Fields!DimText_Control74.Value&lt;&gt;"",FALSE,TRUE)</Hidden>
                                            </Visibility>
                                          </TablixMember>
                                        </TablixMembers>
