OBJECT Report 1404 Bank Acc. - Detail Trial Bal.
{
  ...
  REQUESTPAGE
  {
    ...
    CONTROLS
    {
      ...
      { 2   ;2   ;Field     ;
                  ...
                  ToolTipML=[DAN=Angiver, om du vil udskrive hver bankkonto pÜ en separat side.;
      ...
      { 3   ;2   ;Field     ;
                  ...
                  ToolTipML=[DAN=Angiver, hvis du ikke õnsker, at rapporten skal omfatte poster for bankkonti, som har en saldo, men som ikke har en bevëgelse i den valgte tidsperiode.;
      ...
      { 1   ;2   ;Field     ;
                  CaptionML=[DAN=Medtag tilbagefõrte poster;
                             ENU=Include Reversed Entries];
                  ToolTipML=[DAN=Angiver, om du vil medtage tilbagefõrte poster i rapporten.;
  ...
  CODE
  {
    VAR
      ...
      RepInclBankAcchavingBalLbl@8592 : TextConst 'DAN=Rapporten indeholder ogsÜ bankkonti, der kun har saldi.;ENU=This report also includes bank accounts that only have balances.';
      BankAccLedgPostingDateCaptionLbl@3690 : TextConst 'DAN=Bogfõringsdato;ENU=Posting Date';
      BankAccBalanceCaptionLbl@5054 : TextConst 'DAN=Saldo;ENU=Balance';
      OpenFormatCaptionLbl@1938 : TextConst 'DAN=èbn;ENU=Open';
