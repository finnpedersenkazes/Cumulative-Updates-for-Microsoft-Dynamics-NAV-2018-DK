OBJECT Report 1095 Update Job Item Cost
{
  ...
  {
    VAR
      Text001@1000 : TextConst '@@@="The Job Ledger Entry item costs have now been updated to equal the related item ledger entry actual costs.\\Number of Job Ledger Entries modified = 2.";DAN="Sagsposternes varepriser er opdateret, s† de stemmer overens med de tilknyttede faktiske omkostninger for vareposterne.\\Antal ‘ndrede sagsposter = %1.";ENU="The job ledger entry item costs have now been updated to equal the related item ledger entry actual costs.\\The number of job ledger entries modified = %1."';
      NoOfJobLedgEntry@1002 : Integer;
      Text003@1001 : TextConst 'DAN=Der var ingen sagsposter, der skulle opdateres.;ENU=There were no job ledger entries that needed to be updated.';
