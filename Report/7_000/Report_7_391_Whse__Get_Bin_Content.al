OBJECT Report 7391 Whse. Get Bin Content
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Lager - hent plac.indh.;
               ENU=Whse. Get Bin Content];
    ProcessingOnly=Yes;
  }
  DATASET
  {
    ...
    CONTROLS
    {
      ...
      { 1   ;2   ;Field     ;
                  ...
                  CaptionML=[DAN=Bogf›ringsdato;
                             ENU=Posting Date];
                  ToolTipML=[DAN=Angiver den bogf›ringsdato, der vises p† de kladdelinjer, der genereres af rapporten.;
                             ENU=Specifies the posting date that will appear on the journal lines generated by the report.];
      ...
      { 3   ;2   ;Field     ;
                  ...
                  CaptionML=[DAN=Bilagsnr.;
                             ENU=Document No.];
                  ToolTipML=[DAN=Angiver det bilagsnummer, der vises p† de kladdelinjer, der genereres af rapporten.;
                             ENU=Specifies the document number that will appear on the journal lines generated by the report.];
                  ApplicationArea=#Warehouse;
                  SourceExpr=DocNo;
  ...
  CODE
  {
    VAR
      ...
      Text001@1003 : TextConst 'DAN=Rapporten skal initialiseres.;ENU=Report must be initialized.';
