OBJECT Page 7395 Posted Invt. Pick List
{
  ...
  {
    Editable=No;
    CaptionML=[DAN=Bogf›rt plukliste (lager);
               ENU=Posted Invt. Pick List];
  ...
  CONTROLS
  {
    ...
    { 6   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver bogf›ringsdatoen fra lagerplukket.;
    ...
    { 2   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver det lagerpluknummer, som plukket er bogf›rt ud fra.;
                           ENU=Specifies the inventory pick number from which the pick was posted.];
                ApplicationArea=#Warehouse;
                SourceExpr="Invt Pick No." }

    { 4   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver koden for den lokation, hvor det bogf›rte lagerpluk forekom.;
