OBJECT Page 7138 Purchase Budget Overview
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Oversigt over kõbsbudget;
  ...
  CONTROLS
  {
    ...
    { 14  ;2   ;Field     ;
                CaptionML=[DAN=Vis vërdi som;
                           ENU=Show Value as];
                ToolTipML=[DAN=Angiver, om du vil have vist varevërdier efter kostbelõb eller efter antal.;
                           ENU=Specifies if you want to view the item values by cost amount or by quantity.];
                OptionCaptionML=[DAN=,Kostbelõb,Antal;
    ...
    { 31  ;2   ;Field     ;
                ...
                CaptionML=[DAN=Kreditorfilter;
                           ENU=Vendor Filter];
                ToolTipML=[DAN=Angiver, at budgettet afgrënses efter de kreditorer, varerne er kõbt hos.;
                           ENU=Specifies that the budget is delimited by the vendors from whom items are purchased.];
                ApplicationArea=#PurchaseBudget;
  ...
  CODE
  {
    VAR
      ...
      CurrentAnalysisArea@1005 : 'Sale,Purchase,Inventory';
