OBJECT Page 7120 Sales Analysis Lines
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Salgsanalyselinjer;
    ...
    ActionList=ACTIONS
    {
      ...
      { 29      ;2   ;Action    ;
                      Ellipsis=Yes;
                      CaptionML=[DAN=Inds‘t de&bitorer;
                                 ENU=Insert &Customers];
                      ToolTipML=[DAN=Inds‘t en eller flere debitorer, som du vil medtage i salgsanalyserapporten.;
      ...
      { 32      ;2   ;Action    ;
                      Ellipsis=Yes;
                      CaptionML=[DAN=Inds‘t debitor&grupper;
                                 ENU=Insert Customer &Groups];
                      ToolTipML=[DAN=Inds‘t en eller flere debitorgrupper, som du vil medtage i salgsanalyserapporten.;
  ...
  CONTROLS
  {
    ...
    { 6   ;2   ;Field     ;
                ...
                OptionCaptionML=[DAN=Artikel,Artikelgruppe,Debitor,Debitorgruppe,,S‘lger/indk›ber,Formel;
