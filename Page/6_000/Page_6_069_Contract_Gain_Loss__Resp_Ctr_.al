OBJECT Page 6069 Contract Gain/Loss (Resp.Ctr)
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Kontraktgevinst/-tab (ansv.cent.);
  ...
  CONTROLS
  {
    ...
    { 8   ;2   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver kontraktgevinst/-tab efter ansvarscenter.;
                           ENU=Specifies the contract gain/loss by responsibility center.];
                ApplicationArea=#Service;
