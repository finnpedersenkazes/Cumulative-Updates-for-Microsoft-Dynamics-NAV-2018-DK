OBJECT Page 6650 Posted Return Shipment
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Bogf›rt returvareleverance;
  ...
  CONTROLS
  {
    ...
    { 63  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver nummeret p† den returvareordre, der bogf›rer en returvareleverance.;
                           ENU=Specifies the number of the return order that will post a return shipment.];
                ApplicationArea=#PurchReturnOrder;
    ...
    { 89  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver nummeret p† kontaktpersonen hos den debitor, fakturaen er sendt fra.;
                           ENU=Specifies the number of the person to contact about an invoice from this customer.];
                ApplicationArea=#PurchReturnOrder;
    ...
    { 28  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver en yderligere del af adressen p† den debitor, som fakturaen blev sendt til.;
                           ENU=Specifies an additional part of the address of the customer that the invoice was shipped to.];
                ApplicationArea=#PurchReturnOrder;
    ...
    { 30  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver byen p† den debitor, som fakturaen er sendt til.;
                           ENU=Specifies the city of the customer that you shipped the invoice to.];
                ApplicationArea=#PurchReturnOrder;
