OBJECT Page 6068 Contract Gain/Loss (Reasons)
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Kontraktgevinst/-tab (Ürsager);
  ...
  CONTROLS
  {
    ...
    { 8   ;2   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver kontraktgevinst/-tab efter Ürsagskode.;
                           ENU=Specifies the contract gain/loss by reason code.];
                ApplicationArea=#Service;
