OBJECT Page 1813 Cust. Approval WF Setup Wizard
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Konfiguration af godkendelsesworkflow for debitor;
  ...
  CONTROLS
  {
    ...
    { 18  ;2   ;Group     ;
                Name=Para1.1;
                CaptionML=[DAN=Velkommen til Konfiguration af godkendelsesworkflow for debitor;
    ...
    { 19  ;3   ;Group     ;
                ...
                CaptionML=[DAN="";
                           ENU=""];
                GroupType=Group;
                InstructionalTextML=[DAN=Du kan oprette godkendelsesworkflows, som automatisk underretter en godkender, n†r en bruger fors›ger at oprette eller ‘ndre et debitorkort.;
    ...
    { 21  ;2   ;Group     ;
                ...
                CaptionML=[DAN=Lad os komme i gang!;
                           ENU=Let's go!];
                GroupType=Group;
                InstructionalTextML=[DAN=V‘lg N‘ste for at angive grundl‘ggende indstillinger for godkendelsesworkflows for ‘ndring af et debitorkort.;
    ...
    { 4   ;3   ;Group     ;
                ...
                CaptionML=[DAN="";
                           ENU=""];
                GroupType=Group;
                InstructionalTextML=[DAN=V‘lg, hvem der er autoriseret til at godkende eller afvise nye eller ‘ndrede debitorkort.;
    ...
    { 3   ;3   ;Group     ;
                Name=Para2.2.1;
                CaptionML=[DAN=V‘lg, om godkendelsesprocessen starter automatisk, eller om brugeren skal starte processen.;
    ...
    { 6   ;2   ;Group     ;
                ...
                CaptionML=[DAN="";
                           ENU=""];
                GroupType=Group;
                InstructionalTextML=[DAN=Oversigt over godkendelsesworkflow for debitor;
  ...
  CODE
  {
    VAR
      ...
      NAVNotSetUpQst@1000 : TextConst 'DAN=Debitorgodkendelse er ikke konfigureret.\\Er du sikker p†, at du vil afslutte guiden?;ENU=Customer Approval has not been set up.\\Are you sure that you want to exit?';
