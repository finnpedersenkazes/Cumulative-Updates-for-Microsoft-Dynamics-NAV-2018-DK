    ...
    ActionList=ACTIONS
    {
      ...
      { 11      ;2   ;Action    ;
                      ...
                      CaptionML=[DAN=Find nye felter;
                                 ENU=Find New Fields];
                      ToolTipML=[DAN=Sõg efter nye felter, og tilfõj dem til dataklassificeringskladden;
      ...
      { 14      ;2   ;Action    ;
                      ...
                      ToolTipML=[DAN=Angiv de valgte felters datafõlsomhed som virksomhedsfortrolige data;
