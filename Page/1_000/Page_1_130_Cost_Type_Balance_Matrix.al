OBJECT Page 1130 Cost Type Balance Matrix
{
  ...
  {
    Editable=No;
    CaptionML=[DAN=Matrix for omkostningstypesaldo;
               ENU=Cost Type Balance Matrix];
    InsertAllowed=No;
    DeleteAllowed=No;
    LinksAllowed=No;
    ...
    ActionList=ACTIONS
    {
      ...
      { 4       ;2   ;Action    ;
                      ...
                      CaptionML=[DAN=P&oster;
                                 ENU=E&ntries];
                      ToolTipML=[DAN=F† vist posterne for omkostningstypesaldoens matrix.;
                                 ENU=View the entries for the cost type balance matrix.];
                      ApplicationArea=#CostAccounting;
                      RunObject=Page 1103;
  ...
  CONTROLS
  {
    ...
    { 8   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver navnet p† omkostningstypesaldoens matrix.;
                           ENU=Specifies the name of the cost type balance matrix.];
                ApplicationArea=#CostAccounting;
                SourceExpr=Name;
                Editable=FALSE;
                Style=Strong;
