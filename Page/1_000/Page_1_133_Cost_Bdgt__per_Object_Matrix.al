OBJECT Page 1133 Cost Bdgt. per Object Matrix
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Matrix for omkostningsbudget pr. objekt;
               ENU=Cost Bdgt. per Object Matrix];
    InsertAllowed=No;
    DeleteAllowed=No;
    LinksAllowed=No;
    ...
    ActionList=ACTIONS
    {
      ...
      { 4       ;2   ;Action    ;
                      ...
                      CaptionML=[DAN=P&oster;
                                 ENU=E&ntries];
                      ToolTipML=[DAN=F† vist posterne for omkostningsemne pr. sted.;
                                 ENU=View the entries for the cost object per center.];
                      ApplicationArea=#CostAccounting;
                      RunObject=Page 1103;
  ...
  CODE
  {
    ...
    [External]
    PROCEDURE Load@2(MatrixColumns1@1000 : ARRAY [12] OF Text[80];VAR CostObjectMatrixRecords1@1001 : ARRAY [12] OF Record 1113;CurrentNoOfMatrixColumns@1002 : Integer;DateFilter1@1003 : Text;BudgetFilter1@1004 : Text;RoundingFactor1@1005 : Option);
    VAR
      i@1006 : Integer;
    BEGIN
