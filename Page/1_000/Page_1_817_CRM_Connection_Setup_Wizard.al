OBJECT Page 1817 CRM Connection Setup Wizard
{
  ...
  CONTROLS
  {
    ...
    { 23  ;3   ;Group     ;
                GroupType=Group;
                InstructionalTextML=[DAN=Du kan konfigurere en Dynamics 365 for Sales-forbindelse for at aktivere problemfri sammenkëdning af data.;
                                     ENU=You can set up a Dynamics 365 for Sales connection to enable seamless coupling of data.] }

    { 21  ;3   ;Group     ;
                GroupType=Group;
                InstructionalTextML=[DAN=Start med at specificere URL-adressen til din Dynamics 365 for Sales-lõsning, f.eks. https://mycrm.crm4.dynamics.com;
    ...
    { 9   ;3   ;Group     ;
                GroupType=Group;
                InstructionalTextML=[DAN=Efter sammenkëdningen kan du arbejde med og synkronisere datatyper, der er fëlles for begge tjenester, f.eks. debitorer, kontakter og salgsoplysninger, og holde dataene opdaterede pÜ begge lokationer.;
    ...
    { 22  ;2   ;Group     ;
                GroupType=Group;
                InstructionalTextML=[DAN=Denne konto skal allerede vëre en gyldig bruger i Dynamics 365 for Sales.;
    ...
    { 32  ;3   ;Field     ;
                ...
                CaptionML=[DAN=ImportÇr Dynamics 365 for Sales-lõsning;
    ...
    { 26  ;3   ;Field     ;
                CaptionML=[DAN=Du skal tildele sikkerhedsrollen Dynamics NAV Product Availability User (Dynamics NAV-produkttilgëngelighedsbruger) til dine salgsmedarbejdere i Dynamics 365 for Sales.;
    ...
    { 13  ;3   ;Field     ;
                ...
                CaptionML=[DAN=AktivÇr integration af salgsordrer;
    ...
    { 10  ;3   ;Field     ;
                ...
                CaptionML=[DAN=AktivÇr Dynamics 365 for Sales-forbindelse;
    ...
    { 20  ;2   ;Group     ;
                GroupType=Group;
                InstructionalTextML=[DAN=Hvis du vil aktivere forbindelsen, skal du vëlge Udfõr. Du bliver bedt om at angive en administratorbrugerkonto i Dynamics 365 for Sales.;
  ...
  CODE
  {
    VAR
      ...
      Password@1008 : Text;
      ConnectionNotSetUpQst@1016 : TextConst '@@@="%1 = CRM product name";DAN=%1-forbindelsen er ikke konfigureret.\\Er du sikker pÜ, at du vil afslutte?;ENU=The %1 connection has not been set up.\\Are you sure you want to exit?';
      MustUpdateClientsQst@1023 : TextConst 'DAN=Hvis du ëndrer adgangsnõglen til webtjenesten, er den nuvërende adgangsnõgle ikke lëngere gyldig. Du skal opdatere alle klienter, der bruger den. Vil du fortsëtte?;ENU=If you change the web service access key, the current access key will no longer be valid. You must update all clients that use it. Do you want to continue?';
      ConfirmCredentialsDomainQst@1024 : TextConst 'DAN=Administratorbrugerkontoen og integrationsbrugerkontoen ser ud til at vëre fra forskellige domëner. Er du sikker pÜ, at legitimationsoplysningerne er korrekte?;ENU=The administrator user account and the integration user account appear to be from different domains. Are you sure that the credentials are correct?';
      CRMURLShouldNotBeEmptyErr@1026 : TextConst '@@@="%1 = CRM product name";DAN=Du skal angive URL-adresse til din %1-lõsning.;ENU=You must specify the URL of your %1 solution.';
      ...
      DoYouWantToMakeSalesPeopleMappingQst@1028 : TextConst '@@@="%1 = CRM product name";DAN=ùnsker du at knytte sëlgere til brugere i %1?;ENU=Do you want to map salespeople to users in %1?';
