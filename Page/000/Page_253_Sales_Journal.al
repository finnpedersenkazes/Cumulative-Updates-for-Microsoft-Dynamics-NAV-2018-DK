OBJECT Page 253 Sales Journal
{
  ...
  CONTROLS
  {
    ...
    { 69  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver linjens avancebel›b, hvis det er en faktura, der registreres i denne kladdelinje.;
    ...
    { 29  ;4   ;Field     ;
                ...
                CaptionML=[DAN=Saldo;
                           ENU=Balance];
                ToolTipML=[DAN=Angiver den saldo, der er akkumuleret i salgskladden p† den linje, hvor mark›ren er placeret.;
    ...
    { 31  ;4   ;Field     ;
                ...
                CaptionML=[DAN=Total balance;
                           ENU=Total Balance];
                ToolTipML=[DAN=Viser den totale saldo i salgskladden.;
  ...
  CODE
  {
    VAR
      ...
      AmountVisible@1014 : Boolean;
      DebitCreditVisible@1015 : Boolean;
