OBJECT Page 613 Handled IC Outbox Transactions
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=H†ndterede IC-udbakketransaktioner;
    ...
    ActionList=ACTIONS
    {
      ...
      { 26      ;2   ;Action    ;
                      ...
                      ToolTipML=[DAN=Gendanner en transaktion i udbakken. Hvis du f.eks. har accepteret en transaktion i udbakken, men efterf›lgende har slettet dokumentet eller kladden i stedet for at bogf›re den/det, kan du gendanne udbakkeposten og acceptere den igen.;
                                 ENU=Re-creates a transaction in the outbox. For example, if you accepted a transaction in your outbox but then deleted the document or journal instead of posting it, you can re-create the outbox entry and accept it again.];
                      ApplicationArea=#Intercompany;
                      Promoted=Yes;
