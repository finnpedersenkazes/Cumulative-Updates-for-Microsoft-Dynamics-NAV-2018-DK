OBJECT Page 423 Customer Bank Account Card
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Debitors bankkontokort;
  ...
  CONTROLS
  {
    ...
    { 6   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver adressen p† den bank, hvor debitoren har bankkontoen.;
    ...
    { 10  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver byen p† den bank, hvor debitoren har bankkontoen.;
    ...
    { 22  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver faxnummeret p† den bank, hvor debitoren har bankkontoen.;
