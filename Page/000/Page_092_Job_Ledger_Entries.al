OBJECT Page 92 Job Ledger Entries
{
  ...
  PROPERTIES
  {
    ...
    ActionList=ACTIONS
    {
      ...
      { 38      ;2   ;Action    ;
                      Ellipsis=Yes;
                      CaptionML=[DAN=Overflyt til planl‘gningslinjer;
                                 ENU=Transfer To Planning Lines];
                      ToolTipML=[DAN=Opret planl‘gningslinjer fra bogf›rte sagsposter. Det er nyttigt, hvis du har glemt at angive de planl‘gningslinjer, der skal oprettes, n†r du bogf›rer sagskladdelinjerne.;
  ...
  CONTROLS
  {
    ...
    { 50  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver det postnummer (Ressource, Vare eller Finanskonto), som sagsposten er tilknyttet.;
