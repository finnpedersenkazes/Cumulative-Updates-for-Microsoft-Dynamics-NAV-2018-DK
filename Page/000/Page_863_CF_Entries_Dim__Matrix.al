OBJECT Page 863 CF Entries Dim. Matrix
{
  ...
  {
    Editable=No;
    CaptionML=[DAN=Pengestr›msprognose, dim.matrix;
               ENU=CF Forcst. Entries Dim. Overv. M.];
    InsertAllowed=No;
    DeleteAllowed=No;
    LinksAllowed=No;
  ...
  CODE
  {
    VAR
      ...
      MATRIX_CellData@1005 : ARRAY [32] OF Text[80];
      MATRIX_ColumnCaptions@1006 : ARRAY [32] OF Text[80];
      MATRIX_PKFirstCaptionInSet@1007 : Text;
