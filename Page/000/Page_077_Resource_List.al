OBJECT Page 77 Resource List
{
  ...
  CONTROLS
  {
    ...
    { 90  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, om adgangen til dataemnet skal begrënses under daglig drift. Dette er eksempelvis nyttigt, nÜr du vil beskytte data mod ëndringer, mens det kontrolleres, om personlige oplysninger i dem er beskyttet.;
