OBJECT Page 510 Blanket Purchase Order Subform
{
    ...
    ActionList=ACTIONS
    {
      ...
      { 1903100004;3 ;Action    ;
                      CaptionML=[DAN=Ordrer;
                                 ENU=Orders];
                      ToolTipML=[DAN=Vis alle relaterede kõbsordrer.;
  ...
  CONTROLS
  {
    ...
    { 6   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver en beskrivelse af rammekõbsordren.;
    ...
    { 8   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver antallet for kõbsordrelinjen.;
    ...
    { 20  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, hvor mange enheder af den pÜgëldende vare der allerede er blevet bogfõrt som modtaget.;
