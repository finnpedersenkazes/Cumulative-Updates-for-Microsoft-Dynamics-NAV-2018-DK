OBJECT Page 171 Standard Sales Code Subform
{
  ...
  CONTROLS
  {
    ...
    { 2   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, om linjen vedr›rer en finanskonto, en vare, en ressource, et anl‘gsaktiv eller et varegebyr.;
    ...
    { 4   ;2   ;Field     ;
                ...
                SourceExpr="No.";
                OnValidate=BEGIN
                             IF NOT ApplicationAreaSetup.IsFoundationEnabled THEN
                               EXIT;
    ...
    { 10  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver nettobel›bet for standardsalgslinjen. Dette felt g‘lder kun for linjer af typen Finanskonto og Gebyr (vare).;
                           ENU=Specifies the net amount for the standard sales line. This field only applies to lines of type G/L Account and Charge (Item).];
                ApplicationArea=#Suite;
