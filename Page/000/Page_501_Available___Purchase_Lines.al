OBJECT Page 501 Available - Purchase Lines
{
  ...
  PROPERTIES
  {
    ...
    Editable=No;
    CaptionML=[DAN=Disponibel - kõbslinjer;
    ...
    ActionList=ACTIONS
    {
      ...
      { 25      ;2   ;Action    ;
                      ...
                      ToolTipML=[DAN=Annuller reservationen, der findes pÜ den bilagslinje, som vinduet blev Übnet for.;
  ...
  CONTROLS
  {
    ...
    { 10  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver det udestÜende antal anfõrt i basisenhederne.;
    ...
    { 19  ;2   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver det antal af varen, som er reserveret fra kõbslinjen til den aktuelle linje eller post.;
