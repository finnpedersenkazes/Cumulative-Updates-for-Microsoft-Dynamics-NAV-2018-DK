OBJECT Page 139 Posted Purch. Invoice Subform
{
  ...
  PROPERTIES
  {
    ...
    ActionList=ACTIONS
    {
      ...
      { 1907075804;2 ;Action    ;
                      ...
                      CaptionML=[DAN=Varemodtagelses&linjer;
                                 ENU=Item Receipt &Lines];
                      ToolTipML=[DAN=Vis de bogf›rte modtagelser for varen.;
                                 ENU=View posted receipts for the item.];
                      ApplicationArea=#Advanced;
                      Image=ReceiptLines;
                      OnAction=BEGIN
  ...
  CONTROLS
  {
    ...
    { 42  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, om fakturalinjen kan have v‘ret med i en beregning af fakturarabat.;
