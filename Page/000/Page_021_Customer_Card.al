OBJECT Page 21 Customer Card
{
  ...
  PROPERTIES
  {
    ...
    PromotedActionCategoriesML=[DAN=Ny,Behandl,RapportÇr,Nyt bilag,Godkend,Anmod om godkendelse,Priser og rabatter,Naviger,Debitor;
    ...
    ActionList=ACTIONS
    {
      ...
      { 79      ;2   ;Action    ;
                      CaptionML=[DAN=Forfaldsoversig&t;
                                 ENU=S&ales];
                      ToolTipML=[DAN=Vis en oversigt over debitorposter. Du kan vëlge tidsintervallet i feltet Vis efter. Kolonnen Periodestart til venstre viser datoer efter det valgte tidsinterval.;
      ...
      { 118     ;2   ;Action    ;
                      ...
                      ToolTipML=[DAN=Opsëtning af tilbagevendende salgslinjer for debitor, f.eks. en mÜnedlig genbestillingsordre, som hurtigt vil kunne indsëttes i et debitorsalgsdokument.;
      ...
      { 85      ;2   ;Action    ;
                      CaptionML=[DAN=Tilbud;
                                 ENU=Quotes];
                      ToolTipML=[DAN=Vis en liste med igangvërende salgstilbud for debitoren.;
      ...
      { 157     ;2   ;Action    ;
                      CaptionML=[DAN=Fakturaer;
                                 ENU=Invoices];
                      ToolTipML=[DAN=Vis en liste med igangvërende salgsfakturaer for debitoren.;
      ...
      { 152     ;3   ;Action    ;
                      ...
                      ToolTipML=[DAN=Se de pÜmindelser, du har sendt til debitoren.;
      ...
      { 147     ;2   ;Action    ;
                      CaptionML=[DAN=S&ager;
                                 ENU=&Jobs];
                      ToolTipML=[DAN=èbn listen over igangvërende sager.;
      ...
      { 1902575205;1 ;Action    ;
                      ...
                      ToolTipML=[DAN=Opret en rammesalgsordre pÜ debitoren.;
      ...
      { 139     ;2   ;Action    ;
                      ...
                      CaptionML=[DAN=Skabeloner;
                                 ENU=Templates];
                      ToolTipML=[DAN=FÜ vist eller rediger debitorskabeloner.;
      ...
      { 132     ;2   ;Action    ;
                      ...
                      ToolTipML=[DAN=Gem debitorkortet som en skabelon, der kan genbruges ved oprettelse af nye debitorkort. Debitorskabeloner indeholder forudindstillede oplysninger som en hjëlp til udfyldelse af debitorkortene.;
      ...
      { 1900839804;1 ;Action    ;
                      Ellipsis=Yes;
                      CaptionML=[DAN=Bogfõr indbetalingskladder;
                                 ENU=Post Cash Receipts];
                      ToolTipML=[DAN=Opret en indbetalingskladdelinje for debitoren, eksempelvis for at bogfõre en betalingskvittering.;
      ...
      { 1907586706;1 ;Action    ;
                      ...
                      CaptionML=[DAN=Debitor - etiketter;
                                 ENU=Customer - Labels];
                      ToolTipML=[DAN=Vis adresseetiketter med navn og adresse pÜ debitorer.;
  ...
  CONTROLS
  {
    ...
    { 2   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver debitorens nummer. Feltet udfyldes enten automatisk fra en defineret nummerserie, eller du kan indtaste nummeret manuelt, fordi du har aktiveret manuel nummerindtastning i opsëtningen af nummerserier.;
    ...
    { 18  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver et alternativt navn, du kan bruge til at sõge efter en debitor.;
    ...
    { 23  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver den foretrukne metode til afsendelse af dokumenter til denne debitor, sÜ du ikke behõver at vëlge en afsendelsesindstilling, hver gang du bogfõrer og sender et dokument til debitoren. Salgsdokumenter til denne debitor skal sendes med den angivne afsendelsesprofil og tilsidesëtter standarddokumentafsendelsesprofilen.;
    ...
    { 73  ;2   ;Field     ;
                ...
                CaptionML=[DAN=Salg i alt;
                           ENU=Total Sales];
                ToolTipML=[DAN=Angiver den samlede salgsomsëtning med debitoren i det aktuelle regnskabsÜr. Den beregnes ud fra belõbene, ekskl. moms, pÜ alle afsluttede og Übne fakturaer og kreditnotaer.;
    ...
    { 72  ;2   ;Field     ;
                CaptionML=[DAN=Kostpriser (RV);
                           ENU=Costs (LCY)];
                ToolTipML=[DAN=Angiver, hvor meget kostpris der er pÜlõbet fra debitoren i det aktuelle regnskabsÜr.;
    ...
    { 71  ;2   ;Field     ;
                CaptionML=[DAN=Avancebelõb (RV);
                           ENU=Profit (LCY)];
                ToolTipML=[DAN=Angiver, hvor meget profit du har fÜet fra debitoren i det aktuelle regnskabsÜr.;
    ...
    { 69  ;2   ;Field     ;
                CaptionML=[DAN=Avancepct.;
                           ENU=Profit %];
                ToolTipML=[DAN=Angiver, hvor meget avance du har skabt pÜ debitoren i det aktuelle regnskabsÜr, udtrykt som en procentdel af debitorens samlede salg.;
    ...
    { 6   ;3   ;Field     ;
                Name=Address;
                ToolTipML=[DAN=Angiver debitorens adresse. Denne adresse vises pÜ alle salgsdokumenter for debitoren.;
    ...
    { 125 ;3   ;Field     ;
                Name=ShowMap;
                ToolTipML=[DAN=Angiver debitorens adresse pÜ dit foretrukne kortwebsted.;
    ...
    { 66  ;3   ;Field     ;
                ToolTipML=[DAN=Angiver det sprog, der skal anvendes pÜ udskrifter til denne debitor.;
    ...
    { 34  ;2   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver en anden debitor, der skal faktureres for produkter, du sëlger til debitoren, i feltet Navn pÜ debitorkortet.;
    ...
    { 29  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver debitorens CVR-nummer for debitorer i EU-lande/-omrÜder.;
    ...
    { 156 ;2   ;Field     ;
                ToolTipML=[DAN=Angiver den debitoradresse, der indsëttes pÜ salgstilbud, du opretter for debitoren.;
    ...
    { 1060003;2;Field     ;
                ToolTipML=[DAN=Angiver, om debitoren krëver en profilkode til elektroniske dokumenter.;
    ...
    { 46  ;3   ;Field     ;
                ToolTipML=[DAN=Angiver, om der beregnes salgslinjerabat, nÜr en sërlig salgspris tilbydes i overensstemmelse med opsëtningen i vinduet Salgspriser.;
    ...
    { 160 ;2   ;Field     ;
                ToolTipML=[DAN=Angiver en forudbetalingsprocent, der gëlder for alle ordrer fra denne debitor, uanset hvilke varer eller tjenester der er angivet pÜ ordrelinjerne.;
    ...
    { 21  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver i forbindelse med Direct Debit-opkrëvninger, om den debitor, som betalingen opkrëves hos, er en person eller en virksomhed.;
    ...
    { 50  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver en kode, der angiver, hvilke betalingsbetingelser du krëver, at debitoren overholder.;
    ...
    { 11  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, hvordan debitoren normalt sender betaling, f.eks. via bankoverfõrsel eller check.;
    ...
    { 3   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver en betalingsbetingelse, der skal bruges til at beregne pengestrõm for debitoren.;
    ...
    { 60  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver nummeret pÜ det sidste kontoudtog, der blev udskrevet for denne debitor.;
    ...
    { 143 ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, at der ikke mÜ ydes betalingstolerance til debitoren.;
    ...
    { 25  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver den debitorbankkonto, der skal bruges som standard, nÜr du behandler refusioner til debitoren og Direct Debit-opkrëvninger.;
    ...
    { 101 ;3   ;Field     ;
                CaptionML=[DAN=Speditõr;
                           ENU=Agent];
                ToolTipML=[DAN=Angiver den speditõr, der skal benyttes ved levering af varer til debitoren.;
    ...
    { 131 ;3   ;Field     ;
                CaptionML=[DAN=Speditõrservice;
                           ENU=Agent Service];
                ToolTipML=[DAN=Angiver koden for den speditõrtjeneste, der skal bruges til debitoren.;
    ...
    { 117 ;3   ;Field     ;
                Name=Balance (LCY)2;
                CaptionML=[DAN=Skyldige belõb - aktuelle;
                           ENU=Money Owed - Current];
                ToolTipML=[DAN=Angiver det betalingsbelõb, som debitoren skylder for afsluttede salg samt salg, der stadig er igangvërende. Vërdien kaldes ogsÜ debitorsaldo.;
                           ENU=Specifies the payment amount that the customer owes for completed sales. This value is also known as the customer's balance.];
                ApplicationArea=#Basic,#Suite;
                SourceExpr="Balance (LCY)";
                OnDrillDown=BEGIN
    ...
    { 116 ;3   ;Field     ;
                CaptionML=[DAN=Skyldige belõb - forventede;
                           ENU=Money Owed - Expected];
                ToolTipML=[DAN=Angiver det betalingsbelõb, som debitoren vil skylde, nÜr lõbende salgsfakturaer og kreditnotaer er afsluttet.;
    ...
    { 115 ;3   ;Field     ;
                Name=TotalMoneyOwed;
                CaptionML=[DAN=Skyldige belõb - i alt;
                           ENU=Money Owed - Total];
                ToolTipML=[DAN=Angiver det betalingsbelõb, som debitoren skylder for afsluttede salg samt salg, der stadig er igangvërende. Vërdien er summen af vërdierne i felterne Skyldige belõb - Skyldige belõb - aktuelle - Forventet.;
    ...
    { 110 ;3   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver, hvor meget af debitorens betalingssaldo der bestÜr af kredit.;
    ...
    { 106 ;3   ;Field     ;
                Name=Balance Due;
                ToolTipML=[DAN=Angiver summen af udestÜende betalinger fra debitoren.;
    ...
    { 105 ;3   ;Field     ;
                CaptionML=[DAN=Betalinger dette Ür;
                           ENU=Payments This Year];
                ToolTipML=[DAN=Angiver summen af betalinger, der er modtaget fra debitoren i det aktuelle regnskabsÜr.;
    ...
    { 103 ;3   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver, hvor lënge debitoren normalt er om at betale fakturaer i det aktuelle regnskabsÜr.;
    ...
    { 100 ;2   ;Group     ;
                CaptionML=[DAN=Omsëtning dette Ür;
                           ENU=Sales This Year];
                GroupType=Group }

    { 98  ;3   ;Field     ;
                ToolTipML=[DAN=Angiver dit salg til debitoren i det nuvërende regnskabsÜr baseret pÜ bogfõrte salgsfakturaer. Tallet i parentes angiver antal bogfõrte salgsfakturaer.;
    ...
    { 97  ;3   ;Field     ;
                ToolTipML=[DAN=Angiver dine forventede refusioner til debitoren i det nuvërende regnskabsÜr baseret pÜ bogfõrte kreditnotaer. Tallet i parentes viser antal bogfõrte kreditnotaer.;
    ...
    { 96  ;3   ;Field     ;
                ToolTipML=[DAN=Angiver dit forventede salg til debitoren i det nuvërende regnskabsÜr baseret pÜ igangvërende salgsfakturaer. Tallet i parentes viser antal igangvërende salgsfakturaer.;
    ...
    { 92  ;3   ;Field     ;
                ToolTipML=[DAN=Angiver dine refusioner til debitoren i det nuvërende regnskabsÜr baseret pÜ igangvërende salgskreditnotaer. Tallet i parentes viser antal igangvërende salgskreditnotaer.;
    ...
    { 88  ;3   ;Field     ;
                CaptionML=[DAN=Fakturarabatter;
                           ENU=Invoice Discounts];
                ToolTipML=[DAN=Angiver totalen for alle fakturarabatter, der er ydet til debitoren i det aktuelle regnskabsÜr.;
  ...
  CODE
  {
    VAR
      ...
      PostedInvoicesMsg@1036 : TextConst '@@@=Invoices (5);DAN=Bogfõrte fakturaer (%1);ENU=Posted Invoices (%1)';
      CreditMemosMsg@1037 : TextConst '@@@=Credit Memos (3);DAN=Bogfõrte kreditnotaer (%1);ENU=Posted Credit Memos (%1)';
      OutstandingInvoicesMsg@1039 : TextConst '@@@=Ongoing Invoices (4);DAN=Igangvërende fakturaer (%1);ENU=Ongoing Invoices (%1)';
      OutstandingCrMemosMsg@1038 : TextConst '@@@=Ongoing Credit Memos (4);DAN=Igangvërende kreditnotaer (%1);ENU=Ongoing Credit Memos (%1)';
      ShowMapLbl@1066 : TextConst 'DAN=Vis pÜ kort;ENU=Show on Map';
