OBJECT Page 637 IC Outbox Sales Lines
{
  OBJECT-PROPERTIES
  {
    Date=21-12-17;
  ...
  CONTROLS
  {
    ...
    { 24  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver den dato, hvor debitoren har ›nsket levering af varerne p† denne ordrelinje.;
                           ENU=Specifies the date that your customer has asked the items on this order line to be delivered.];
                ApplicationArea=#Intercompany;
