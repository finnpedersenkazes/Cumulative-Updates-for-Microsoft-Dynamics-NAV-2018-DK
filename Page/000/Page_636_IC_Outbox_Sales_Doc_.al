OBJECT Page 636 IC Outbox Sales Doc.
{
  OBJECT-PROPERTIES
  {
    Date=21-12-17;
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Salgsbilag for IC-udbakke;
               ENU=IC Outbox Sales Doc.];
    InsertAllowed=No;
    DeleteAllowed=No;
    SourceTable=Table426;
    PageType=Document;
    ActionList=ACTIONS
    {
  ...
  CONTROLS
  {
    ...
    { 48  ;2   ;Field     ;
                ToolTipML=[DAN=Indeholder den dato, hvor debitoren har ›nsket levering af varerne.;
                           ENU=Specifies the date that your customer has asked for the order to be delivered.];
                ApplicationArea=#Intercompany;
