OBJECT Page 9219 Purch. Budget Overview Matrix
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Matrix for oversigt over k›bsbudget;
               ENU=Purch. Budget Overview Matrix];
    InsertAllowed=No;
    DeleteAllowed=No;
    LinksAllowed=No;
  ...
  CONTROLS
  {
    ...
    { 26  ;2   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver det samlede antal k›bsbudgetposter.;
                           ENU=Specifies the total quantity of the purchase budget entries.];
                ApplicationArea=#PurchaseBudget;
                SourceExpr=+Quantity;
                AutoFormatType=10;
    ...
    { 24  ;2   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver den samlede omkostning for k›bsbudgetposterne.;
                           ENU=Specifies the total cost of the purchase budget entries.];
                ApplicationArea=#PurchaseBudget;
                SourceExpr=+Amount;
                AutoFormatType=10;
                AutoFormatExpr=FormatStr;
  ...
  CODE
  {
    VAR
      ...
      MatrixRecords@1004 : ARRAY [32] OF Record 367;
