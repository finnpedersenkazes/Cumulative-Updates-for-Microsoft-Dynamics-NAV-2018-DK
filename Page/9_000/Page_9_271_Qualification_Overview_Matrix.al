OBJECT Page 9271 Qualification Overview Matrix
{
  ...
  {
    Editable=No;
    CaptionML=[DAN=Oversigtsmatrix for kvalifikationer;
               ENU=Qualification Overview Matrix];
    LinksAllowed=No;
  ...
  CONTROLS
  {
    ...
    { 2   ;2   ;Field     ;
                ...
                CaptionML=[DAN=Fulde navn;
                           ENU=Full Name];
                ToolTipML=[DAN="Angiver det fulde navn p† den medarbejder, hvis kvalifikationer vises p† linjen. ";
                           ENU="Specifies the full name of the employee for whom the qualifications are shown on the line. "];
                ApplicationArea=#Advanced;
                SourceExpr=FullName }
