OBJECT Page 9302 Sales Credit Memos
{
  ...
  CONTROLS
  {
    ...
    { 123 ;2   ;Field     ;
                ToolTipML=[DAN=Angiver placeringen, hvor lagervarer til debitoren p† salgsdokumentet skal sendes som standard.;
    ...
    { 5   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver status for en opgavek›post eller opgave, der h†ndterer bogf›ring af salgskreditnotaer.;
  ...
  CODE
  {
    VAR
      ...
      OpenPostedSalesCrMemoQst@1003 : TextConst 'DAN=Kreditnotaen er blevet bogf›rt og arkiveret.\\Vil du †bne den bogf›rte kreditnota fra listen Bogf›rt salgskreditnota?;ENU=The credit memo has been posted and archived.\\Do you want to open the posted credit memo from the Posted Sales Credit Memo list?';
      CanCancelApprovalForRecord@1001 : Boolean;
      CustomerSelected@1002 : Boolean;
      ReadyToPostQst@1006 : TextConst '@@@=%1 - selected count, %2 - total count;DAN=%1 ud af %2 valgte kreditnotaer er klar til bogf›ring. \Vil du forts‘tte og bogf›re dem?;ENU=%1 out of %2 selected credit memos are ready for post. \Do you want to continue and post them?';
