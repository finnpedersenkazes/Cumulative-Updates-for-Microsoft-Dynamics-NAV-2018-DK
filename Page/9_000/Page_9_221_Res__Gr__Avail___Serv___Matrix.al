OBJECT Page 9221 Res. Gr. Avail. (Serv.) Matrix
{
    ...
    ActionList=ACTIONS
    {
      ...
      { 15      ;2   ;Action    ;
                      ...
                      CaptionML=[DAN=&Alloker;
                                 ENU=&Allocate];
                      ToolTipML=[DAN=Angiver de ressourcegrupper, der kan tildeles.;
                                 ENU=Specifies the resource groups available to be allocated.];
  ...
  CONTROLS
  {
    ...
    { 13  ;2   ;Field     ;
                ...
                CaptionML=[DAN=Antal til fordeling;
                           ENU=Qty. To Allocate];
                ToolTipML=[DAN=Angiver den mëngde, der skal fordeles for ressourcegruppen.;
                           ENU=Specifies the quantity to allocate for the resource group.];
                ApplicationArea=#Service;
    ...
    { 30  ;2   ;Field     ;
                ...
                CaptionML=[DAN=Valgt dato;
                           ENU=Selected Day];
                ToolTipML=[DAN=Angiver den nõjagtige dato, du vëlger for ressourcegruppetilgëngeligheden.;
                           ENU=Specifies the exact date you select for the resource group availability.];
                ApplicationArea=#Service;
  ...
  CODE
  {
    ...
    [Internal]
    PROCEDURE SetData@1109(DocumentType@1003 : Integer;DocumentNo@1000 : Code[20];EntryNo@1002 : Integer;NewMatrixColumnCaptions@1004 : ARRAY [32] OF Text[100];VAR NewMatrixDateFilters@1006 : ARRAY [32] OF Record 2000000007;Period@1007 : 'Day,Week,Month,Quarter,Year,Accounting Period');
    BEGIN
