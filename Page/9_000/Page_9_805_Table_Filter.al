OBJECT Page 9805 Table Filter
{
  ...
  CONTROLS
  {
    ...
    { 4   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver id'et for det felt, der er angivet et sikkerhedsfilter p†.;
                           ENU=Specifies the ID of the field on which a security filter is set.];
    ...
    { 5   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver titlen for det felt, der er angivet et sikkerhedsfilter p†.;
                           ENU=Specifies the caption of the field on which a security filter is set.];
                ApplicationArea=#Basic,#Suite;
                SourceExpr="Field Caption";
                Editable=FALSE }

    { 3   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver v‘rdien af feltet for et sikkerhedsfilter.;
                           ENU=Specifies the value of the field for a security filter.];
                ApplicationArea=#Basic,#Suite;
  ...
  {
    VAR
      Text000@1000 : TextConst 'DAN=Filtrene er for omfattende til at blive kopieret til typen ''''TableFilter".;ENU=The filters are too large to be copied to the type "TableFilter".';
