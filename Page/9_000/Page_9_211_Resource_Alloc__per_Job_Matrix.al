OBJECT Page 9211 Resource Alloc. per Job Matrix
{
  OBJECT-PROPERTIES
  {
    Date=21-12-17;
  ...
  {
    Editable=No;
    CaptionML=[DAN=Matrix for ressource allokeret p† sager;
               ENU=Resource Allocated per Job Matrix];
    LinksAllowed=No;
  ...
  CODE
  {
    ...
    [Internal]
    PROCEDURE Load@1(VAR NewVerticalRec@1000 : Record 167;VAR NewHorizontalRec@1001 : Record 1003;NewMatrixColumnCaptions@1002 : ARRAY [32] OF Text[100];VAR NewMatrixDateFilters@1003 : ARRAY [32] OF Record 2000000007;AmountType2@1005 : 'Net Change, Balance at Date');
    BEGIN
      COPY(NewVerticalRec);
    ...
    LOCAL PROCEDURE GetStartDate@6(PeriodStartDate@1000 : Date) : Date;
    BEGIN
      CASE AmountType OF
