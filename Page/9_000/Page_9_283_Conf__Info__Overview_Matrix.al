OBJECT Page 9283 Conf. Info. Overview Matrix
{
  ...
  {
    Editable=No;
    CaptionML=[DAN=Oversigtsmatrix for fortrolige oplysn.;
               ENU=Conf. Info. Overview Matrix];
    LinksAllowed=No;
  ...
  CONTROLS
  {
    ...
    { 2   ;2   ;Field     ;
                CaptionML=[DAN=Fulde navn;
                           ENU=Full Name];
                ToolTipML=[DAN="Angiver det fulde navn p† den medarbejder, hvis fortrolige oplysninger vises p† linjen. ";
                           ENU="Specifies the full name of the employee for whom the confidential information is shown on the line. "];
                ApplicationArea=#Advanced;
                SourceExpr=FullName }
  ...
  CODE
  {
    VAR
      ...
      MATRIX_CaptionSet@1059 : ARRAY [32] OF Text[80];
