OBJECT Page 9311 Purchase Return Order List
{
  ...
  PROPERTIES
  {
    ...
    PromotedActionCategoriesML=[DAN=Ny,Behandl,Rapport,Returvareordre,Anmod om godkendelse,Frigiv;
  ...
  CONTROLS
  {
    ...
    { 24  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver en formel, der beregner betalingens forfaldsdatoen, kontantrabatdato og kontantrabatbelõb.;
    ...
    { 25  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, hvornÜr kõbsfakturaen forfalder til betaling.;
    ...
    { 26  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver den rabatprocent, der tildeles, hvis betaling gennemfõres pÜ eller fõr den dato, der er angivet i feltet Kontantrabatdato.;
    ...
    { 30  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, om alle varer i ordren er leveret, eller - hvis der er tale om indgÜende varer - modtaget helt.;
    ...
    { 32  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver summen af belõb i feltet Linjebelõb pÜ kõbsreturordrelinjerne.;
    ...
    { 34  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver den samlede sum af belõbene, herunder moms, pÜ alle linjerne i bilaget.;
