OBJECT Page 9314 Warehouse Movements
{
  ...
  {
    Editable=No;
    CaptionML=[DAN=Bev‘gelser (logistik);
               ENU=Warehouse Movements];
    ...
    ActionList=ACTIONS
    {
      ...
      { 1102601003;2 ;Action    ;
                      ...
                      ToolTipML=[DAN=Vis de m‘ngder, der allerede er blevet flyttet.;
                                 ENU=View any quantities that have already been moved.];
                      ApplicationArea=#Warehouse;
                      RunObject=Page 5797;
