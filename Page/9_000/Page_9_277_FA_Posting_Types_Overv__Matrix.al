OBJECT Page 9277 FA Posting Types Overv. Matrix
{
  ...
  {
    Editable=No;
    CaptionML=[DAN=Matrix for anl‘gsbogf.typeoversigt;
               ENU=FA Posting Types Overv. Matrix];
    LinksAllowed=No;
    ...
    ActionList=ACTIONS
    {
      ...
      { 9       ;2   ;Action    ;
                      ...
                      ToolTipML=[DAN=Vis de poster, der er blevet bogf›rt, fordi du har brug annulleringsfunktionen til at annullere en post.;
  ...
  CONTROLS
  {
    ...
    { 2   ;2   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver en afskrivningsprofil, der skal tildeles de anl‘g, du har angivet i feltet Anl‘gsnr.;
                           ENU=Specifies a depreciation book to assign to the fixed asset you have entered in the FA No. field.];
                ApplicationArea=#FixedAssets;
                SourceExpr="Depreciation Book Code" }

    { 4   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver v‘rdien i feltet Beskrivelse p† anl‘gskortet.;
  ...
  CODE
  {
    ...
    [External]
    PROCEDURE Load@1093(MatrixColumns1@1005 : ARRAY [32] OF Text[80];VAR MatrixRecords1@1006 : ARRAY [32] OF Record 5647;CurrentNoOfMatrixColumns@1007 : Integer;DateFilterLocal@1003 : Text;RoundingFactorLocal@1001 : 'None,1,1000,1000000');
    VAR
      i@1004 : Integer;
    BEGIN
