OBJECT Page 9217 ResGrp. All. per Serv.  Matrix
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Matrix for ressourcegruppe allokeret p† serviceordre;
               ENU=Resource Group Allocated per Service Order Matrix];
    InsertAllowed=No;
    DeleteAllowed=No;
    LinksAllowed=No;
    ...
    ActionList=ACTIONS
    {
      ...
      { 75      ;1   ;ActionGroup;
                      ...
                      Image=Planning }
      { 79      ;2   ;Action    ;
                      CaptionML=[DAN=Ressourcegrp.&disponering;
                                 ENU=Resource Gr. A&vailability];
                      ToolTipML=[DAN=Vis en oversigt over ressourcegruppekapaciteter, antallet af ressourcetimer, der er allokeret til sager i ordre, det antal, der er allokeret til serviceordrer, den kapacitet, der er tildelt til sager i tilbud, og ressourcetilg‘ngelighed.;
                                 ENU=View a summary of resource group capacities, the quantity of resource hours allocated to jobs on order, the quantity allocated to service orders, the capacity assigned to jobs on quote, and the resource availability.];
                      ApplicationArea=#Service;
                      RunObject=Page 6011;
