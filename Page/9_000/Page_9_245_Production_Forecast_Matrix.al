OBJECT Page 9245 Production Forecast Matrix
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Matrix for produktionsforecast;
               ENU=Production Forecast Matrix];
    InsertAllowed=No;
    DeleteAllowed=No;
    LinksAllowed=No;
    SourceTable=Table27;
  ...
  {
    VAR
      MatrixRecords@1004 : ARRAY [32] OF Record 2000000007;
      ...
      MATRIX_CaptionSet@1096 : ARRAY [32] OF Text[80];
      ProductionForecastName@1002 : Code[10];
      LocationFilter@1001 : Text;
      DateFilter@1000 : Text;
      Text000@1009 : TextConst 'DAN=Feltet Forecasttype skal v‘re Salgsvarer eller Komponent;ENU=The Forecast On field must be Sales Items or Component.';
      Text001@1008 : TextConst '@@@=A forecast was previously made on the 01-10-11. Do you want all forecasts of the period 12/02/2012-12/03/2012 moved to the start of the period?;DAN=Der er tidligere lavet et forecast p† %1. Skal alle forecasts for perioden %2-%3 flyttes til begyndelsen af perioden.;ENU=A forecast was previously made on the %1. Do you want all forecasts of the period %2-%3 moved to the start of the period?';
      Text003@1007 : TextConst 'DAN=Du skal angive et lokationsfilter.;ENU=You must set a location filter.';
      Text004@1006 : TextConst 'DAN=Du skal v‘lge Salgsvarer eller Komponent.;ENU=You must change view to Sales Items or Component.';
