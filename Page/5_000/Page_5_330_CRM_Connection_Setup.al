OBJECT Page 5330 CRM Connection Setup
{
    ...
    ActionList=ACTIONS
    {
      ...
      { 35      ;1   ;Action    ;
                      ...
                      CaptionML=[DAN=Assisteret opsëtning;
                                 ENU=Assisted Setup];
                      ToolTipML=[DAN=Kõrer guiden Opsëtning af Dynamics NAV-forbindelse.;
      ...
      { 5       ;1   ;Action    ;
                      ...
                      CaptionML=[@@@=Test is a verb.;
                                 DAN=Afprõv forbindelse;
                                 ENU=Test Connection];
                      ToolTipML=[DAN=Afprõver forbindelsen til Dynamics 365 for Sales ved hjëlp af de angivne indstillinger.;
      ...
      { 13      ;1   ;Action    ;
                      ...
                      CaptionML=[DAN=Brug standardopsëtning af synkronisering;
                                 ENU=Use Default Synchronization Setup];
                      ToolTipML=[DAN=Nulstiller integrationstabelkoblingerne og synkroniseringsjob til standardvërdierne for en forbindelse med Dynamics 365 for Sales. Alle eksisterende koblinger slettes.;
      ...
      { 10      ;1   ;Action    ;
                      ...
                      CaptionML=[DAN=Kõr fuld synkronisering;
                                 ENU=Run Full Synchronization];
                      ToolTipML=[DAN=Start alle standardintegrationsjobs til synkronisering af Dynamics NAV-recordtyper og Dynamics 365 for Sales-poster som defineret pÜ siden Integrationstabelkoblinger.;
      ...
      { 17      ;1   ;Action    ;
                      ...
                      ToolTipML=[DAN=Fortryd din ëndring, og indtast standard-URL'en i feltet URL til Dynamics NAV-webklient.;
      ...
      { 23      ;1   ;Action    ;
                      Name=SynchronizeNow;
                      CaptionML=[DAN=Synkroniser ëndrede records;
                                 ENU=Synchronize Modified Records];
                      ToolTipML=[DAN=Synkroniser records, der er ëndret siden sidste gang, de blev synkroniseret.;
      ...
      { 9       ;1   ;Action    ;
                      ...
                      CaptionML=[DAN=GenerÇr integrations-id'er;
                                 ENU=Generate Integration IDs];
                      ToolTipML=[DAN=Opret integrations-id'er for nye records, der er blevet tilfõjet, mens forbindelsen var deaktiveret, f.eks. nÜr du har genoprettet en Dynamics 365 for Sales-forbindelse.;
      ...
      { 19      ;1   ;Action    ;
                      ...
                      ToolTipML=[DAN=Vis poster, der knytter integrationstabeller til forretningsdatatabeller i Dynamics NAV. Integrationstabeller er konfigureret til at fungere som grënseflader til synkroniseringsdata mellem en ekstern databasetabel sÜsom Dynamics 365 for Sales og en tilsvarende forretningsdatatabel i Dynamics NAV.;
      ...
      { 12      ;1   ;Action    ;
                      ...
                      CaptionML=[DAN=Poster i synk.jobkõ;
                                 ENU=Synch. Job Queue Entries];
                      ToolTipML=[DAN=Vis opgavekõposter, der administrerer den planlagte synkronisering mellem Dynamics 365 for Sales og Dynamics NAV.;
      ...
      { 6       ;1   ;Action    ;
                      ...
                      ToolTipML=[DAN=AktivÇr eller deaktiver datakryptering. Datakryptering er med til at sikre, at uautoriserede brugere ikke kan lëse virksomhedsdata.;
  ...
  CONTROLS
  {
    ...
    { 2   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver URL-adressen til den Dynamics 365 for Sales-server, der hoster den Dynamics 365 for Sales-lõsning, som du vil oprette forbindelse til.;
    ...
    { 3   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver brugernavnet pÜ en Dynamics 365 for Sales-konto.;
    ...
    { 22  ;2   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver, hvor mange af standardposterne i jobkõer til integrationssynkronisering er klar til automatisk at synkronisere data mellem Dynamics NAV og Dynamics 365 for Sales.;
    ...
    { 16  ;2   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver URL-adressen til Dynamics NAV-webklienten. Fra records i Dynamics 365 for Sales, f.eks. en konto eller et produkt, kan brugere Übne en tilsvarende (sammenkëdet) record i Dynamics NAV, som Übnes i Dynamics NAV-webklienten. Angiv dette felt til URL-adressen til den forekomst af Dynamics NAV-webklienten, der skal bruges.;
    ...
    { 24  ;2   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver URL-adressen til Dynamics NAV OData-webtjenester. Fra salgsordrerecords i Dynamics 365 for Sales kan brugere hente oplysninger om varedisponering for en Dynamics NAV-vare sammenkëdet med -produktet i posten med salgsordrerecords i Dynamics 365 for Sales. Angiv dette felt til URL-adressen til de Dynamics NAV OData-webtjenester, der skal bruges.;
    ...
    { 32  ;2   ;Field     ;
                ...
                CaptionML=[DAN=Adgangsnõgle for Dynamics NAV OData-webtjeneste;
                           ENU=Dynamics NAV OData Webservice Accesskey];
                ToolTipML=[DAN=Angiver adgangsnõglen for at adgang til Dynamics NAV OData-webtjenester.;
    ...
    { 15  ;2   ;Field     ;
                CaptionML=[DAN=Dynamics NAV-integrationslõsning importeret;
                           ENU=Dynamics NAV Integration Solution Imported];
                ToolTipML=[DAN=Angiver, om Dynamics NAV-integrationslõsningen er installeret og konfigureret i Dynamics 365 for Sales. Du kan ikke ëndre denne indstilling.;
    ...
    { 27  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, at Dynamics NAV-brugere skal have en tilsvarende brugerkonto i Dynamics 365 for Sales for at have Dynamics 365 for Sales-integrationsfunktioner i brugergrënsefladen.;
    ...
    { 18  ;2   ;Field     ;
                ...
                ToolTipML=[DAN=Angiver, at den brugerkonto, du har brugt til at logge pÜ med, har en tilsvarende brugerkonto i Dynamics 365 for Sales.;
    ...
    { 39  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver domënenavnet for din Dynamics 365 for Sales-installation.;
  ...
  CODE
  {
    VAR
      ...
      EncryptionIsNotActivatedQst@1016 : TextConst 'DAN=Datakryptering er ikke aktiveret i õjeblikket. Vi anbefaler, at du krypterer data. \Vil du Übne vinduet Administration af datakryptering?;ENU=Data encryption is currently not enabled. We recommend that you encrypt data. \Do you want to open the Data Encryption Management window?';
      WebClientUrlResetMsg@1014 : TextConst '@@@=%1 - product name;DAN=URL-adressen til %1-webklienten er blevet nulstillet til standardvërdien.;ENU=The %1 Web Client URL has been reset to the default value.';
      SyncNowSuccessMsg@1018 : TextConst '@@@="%1 = Page 5338 Caption";DAN=Synkronisering af ëndrede records er fuldfõrt.\Detaljerne kan ses i vinduet %1.;ENU=Synchronize Modified Records completed.\See the %1 window for details.';
      UnfavorableCRMVersionMsg@1033 : TextConst '@@@="%1 - product name, %2 = CRM product name";DAN=Denne version af %2 fungerer muligvis ikke korrekt sammen med %1. Vi anbefaler, at du opgraderer til en understõttet version.;ENU=This version of %2 might not work correctly with %1. We recommend you upgrade to a supported version.';
      FavorableCRMVersionMsg@1034 : TextConst '@@@="%1 = CRM product name";DAN=Denne version af %1 er gyldig.;ENU=The version of %1 is valid.';
      UnfavorableCRMSolutionInstalledMsg@1036 : TextConst '@@@=%1 - product name;DAN=%1-integrationslõsningen blev ikke registreret.;ENU=The %1 Integration Solution was not detected.';
      FavorableCRMSolutionInstalledMsg@1037 : TextConst '@@@="%1 - product name, %2 = CRM product name";DAN=%1-integrationslõsningen er installeret i %2.;ENU=The %1 Integration Solution is installed in %2.';
      SynchronizeModifiedQst@1038 : TextConst 'DAN=Dette synkroniserer alle ëndrede records i alle integrationstabelkoblinger.\\Vil du fortsëtte?;ENU=This will synchronize all modified records in all Integration Table Mappings.\\Do you want to continue?';
      ...
      CurrentuserIsNotMappedToCRMUserMsg@1054 : TextConst '@@@="%1 = Current User ID, %2 - product name, %3 = CRM product name";DAN=Da feltet %2-brugere skal kobles til %3-brugere er markeret, er integration af %3 ikke aktiveret for %1.\\Hvis du vil aktivere %3-integration for %2-brugeren %1, skal godkendelsesmailadressen vëre den samme som en %3-brugers primëre mailadresse.;ENU=Because the %2 Users Must Map to %3 Users field is set, %3 integration is not enabled for %1.\\To enable %3 integration for %2 user %1, the authentication email must match the primary email of a %3 user.';
      EnableServiceQst@1057 : TextConst '@@@="%1 = This Page Caption (Microsoft Dynamics 365 Connection Setup)";DAN=%1 er ikke aktiveret. Er du sikker pÜ, at du vil afslutte?;ENU=The %1 is not enabled. Are you sure you want to exit?';
      PartialScheduledJobsAreRunningMsg@1046 : TextConst '@@@="%1 = Count of scheduled job queue entries in ready or in process state, %2 count of all scheduled jobs";DAN=En aktiv opgavekõ er tilgëngelig, men kun %1 ud af de %2 planlagte synkroniseringsjob er klar eller ved at blive behandlet.;ENU=An active job queue is available but only %1 of the %2 scheduled synchronization jobs are ready or in process.';
      JobQueueIsNotRunningMsg@1048 : TextConst 'DAN=Der er ikke startet en opgavekõ. Behandling af planlagte synkroniseringsopgaver krëver, at der findes en aktiv opgavekõ.\\Kontakt din administrator for at fÜ konfigureret og startet en opgavekõ.;ENU=There is no job queue started. Scheduled synchronization jobs require an active job queue to process jobs.\\Contact your administrator to get a job queue configured and started.';
      AllScheduledJobsAreRunningMsg@1045 : TextConst 'DAN=Der er startet en opgavekõ, og alle planlagte synkroniseringsopgaver er klar eller ved at blive behandlet.;ENU=An job queue is started and all scheduled synchronization jobs are ready or already processing.';
      SetupSuccessfulMsg@1001 : TextConst '@@@="%1 = CRM product name";DAN=Standardopsëtningen af %1-synkronisering er fuldfõrt.;ENU=The default setup for %1 synchronization has completed successfully.';
