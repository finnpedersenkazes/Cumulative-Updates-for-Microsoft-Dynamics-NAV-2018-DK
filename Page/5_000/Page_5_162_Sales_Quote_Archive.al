OBJECT Page 5162 Sales Quote Archive
{
  ...
  {
    Editable=No;
    CaptionML=[DAN=Salgstilbudsarkiv;
  ...
  CONTROLS
  {
    ...
    { 24  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver den kr‘vede leveringsdato for salgstilbuddet.;
                           ENU=Specifies the requested delivery date for the sales quote.];
                ApplicationArea=#Advanced;
                SourceExpr="Requested Delivery Date" }

    { 26  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, hvilken s‘lger der er tilknyttet salgstilbuddet.;
                           ENU=Specifies which salesperson is associated with the sales quote.];
                ApplicationArea=#Advanced;
