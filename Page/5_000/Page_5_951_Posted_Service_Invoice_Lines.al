OBJECT Page 5951 Posted Service Invoice Lines
{
  ...
  {
    Editable=No;
    CaptionML=[DAN=Bogfõrte servicefakturalinjer;
  ...
  CONTROLS
  {
    ...
    { 2   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver nummeret pÜ fakturaen.;
                           ENU=Specifies the number of the invoice.];
                ApplicationArea=#Service;
                SourceExpr="Document No." }

    { 4   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver nummeret pÜ den debitor, som har modtaget servicen, pÜ fakturaen.;
    ...
    { 12  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver navnet pÜ beskrivelsen af en vare, ressource, omkostning, finanskonto eller en vilkÜrlig beskrivende tekst pÜ servicefakturalinjen.;
    ...
    { 22  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver antallet af vareenheder, ressourcetimer, finanskontobetalinger eller omkostninger, der er angivet pÜ fakturalinjen.;
