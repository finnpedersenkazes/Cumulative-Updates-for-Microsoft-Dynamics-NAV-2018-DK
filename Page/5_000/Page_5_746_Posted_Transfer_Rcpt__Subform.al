OBJECT Page 5746 Posted Transfer Rcpt. Subform
{
  ...
  CONTROLS
  {
    ...
    { 2   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver nummeret p† den vare, der overflyttes.;
    ...
    { 10  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver beskrivelsen af den vare, der overflyttes.;
                           ENU=Specifies the description of the item that is transferred.];
                ApplicationArea=#Location;
    ...
    { 4   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver antallet af den vare, der overflyttes.;
                           ENU=Specifies the quantity of the item that is transferred.];
                ApplicationArea=#Location;
                BlankZero=Yes;
                SourceExpr=Quantity }
