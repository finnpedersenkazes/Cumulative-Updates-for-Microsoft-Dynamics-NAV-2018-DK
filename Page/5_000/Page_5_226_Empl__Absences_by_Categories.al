OBJECT Page 5226 Empl. Absences by Categories
{
  ...
  PROPERTIES
  {
    CaptionML=[DAN=Medarbejderfrav‘r pr. kategori;
  ...
  CONTROLS
  {
    ...
    { 9   ;2   ;Field     ;
                CaptionML=[DAN=Frav‘rsbel›bstype;
                           ENU=Absence Amount Type];
                ToolTipML=[DAN=Angiver de frav‘rsbel›b, der skal med i oversigten.;
                           ENU=Specifies the absence amounts that will be included in the overview.];
