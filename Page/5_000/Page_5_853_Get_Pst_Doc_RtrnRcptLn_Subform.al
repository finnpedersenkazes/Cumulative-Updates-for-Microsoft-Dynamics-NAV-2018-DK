OBJECT Page 5853 Get Pst.Doc-RtrnRcptLn Subform
{
  ...
  CONTROLS
  {
    ...
    { 2   ;2   ;Field     ;
                Lookup=No;
                ToolTipML=[DAN=Angiver nummeret pÜ returvaremodtagelsen.;
    ...
    { 12  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver navnet pÜ eller beskrivelsen af varen eller finanskontoen eller varegebyret.;
    ...
    { 18  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, hvilken lokation returvaremodtagelseslinjen er registreret pÜ.;
    ...
    { 36  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver antallet fra den linje, der er bogfõrt som modtaget, men som endnu ikke er bogfõrt som faktureret.;
