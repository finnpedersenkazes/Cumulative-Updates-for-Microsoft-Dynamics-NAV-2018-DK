OBJECT Page 5752 Posted Transfer Shipments
{
  ...
  PROPERTIES
  {
    ...
    PromotedActionCategoriesML=[DAN=Ny,Behandl,Rapport‚r,Leverance;
                                ENU=New,Process,Report,Shipment];
    ActionList=ACTIONS
    {
  ...
  CONTROLS
  {
    ...
    { 8   ;2   ;Field     ;
                ToolTipML=[DAN=Angiver bogf›ringsdatoen for dette bilag.;
                           ENU=Specifies the posting date of this document.];
                ApplicationArea=#Location;
