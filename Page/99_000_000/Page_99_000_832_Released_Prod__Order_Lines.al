OBJECT Page 99000832 Released Prod. Order Lines
{
  ...
  PROPERTIES
  {
    ...
    ActionList=ACTIONS
    {
      ...
      { 1902760704;2 ;Action    ;
                      ...
                      ToolTipML=[DAN=Bogf›r forbrug og afgang for den frigivne produktionsordrelinje.;
                                 ENU=Post consumption and output for the released production order line.];
                      ApplicationArea=#Manufacturing;
                      Image=Journal;
                      OnAction=BEGIN
  ...
  CONTROLS
  {
    ...
    { 50  ;2   ;Field     ;
                ToolTipML=[DAN=Angiver, om der tages h›jde for forsyningen, repr‘senteret af linjen i planl‘gningssystemet, n†r der beregnes aktionsmeddelelser.;
